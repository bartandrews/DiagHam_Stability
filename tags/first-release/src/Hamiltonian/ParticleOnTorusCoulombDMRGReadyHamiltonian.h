...
#ifndef PARTICLEONTORUSCOULOMBDMRGREADYHAMILTONIAN_H
#define PARTICLEONTORUSCOULOMBDMRGREADYHAMILTONIAN_H
...
class ParticleOnTorusCoulombDMRGReadyHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  ParticleOnTorusCoulombDMRGReadyHamiltonian(ParticleOnTorus* particles, int nbrParticles, int maxMomentum, double ratio);

  // destructor
  //
  ~ParticleOnTorusCoulombDMRGReadyHamiltonian();
  ...
  friend ostream& operator << (ostream& Str, ParticleOnTorusCoulombDMRGReadyHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, ParticleOnTorusCoulombDMRGReadyHamiltonian& H);
