...
#ifndef APPROXIMATEFERMIONONTORUSCOULOMBHAMILTONIAN_H
#define APPROXIMATEFERMIONONTORUSCOULOMBHAMILTONIAN_H
...
class ApproximateFermionOnTorusCoulombHamiltonian : public AbstractHamiltonian
{

 protected:
  
  // Hilbert space associated to the system
  FermionOnTorus* Fermions;
  ...
  // maximum momentum value reached by a fermion in the state
  int MaxMomentum;
  ...
  // global factor for interaction term
  double InteractionCoefficient;

  // hamiltonian diagonal terms
  double* DiagonalCoefficients;
 ...
 public:
  ...
  ApproximateFermionOnTorusCoulombHamiltonian(FermionOnTorus* fermions, int nbrFermions, int maxMomentum, double ratio);
  ...
  friend ostream& operator << (ostream& Str, ApproximateFermionOnTorusCoulombHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, ApproximateFermionOnTorusCoulombHamiltonian& H);
