...
#ifndef MULTIPLESPINCHAINHAMILTONIAN_H
#define MULTIPLESPINCHAINHAMILTONIAN_H
...
class MultipleSpinChainHamiltonian : public AbstractHamiltonian
{

 protected:
  
  // hilbert space corresponding to the chains
  AbstractSpinChain* Chains;

  // coupling constant between nearest neighbours in a chain
  double J1;
  // half the value of J1
  double HalfJ1;
  // coupling constant between nearest neighbours in two diffferent succesive chains
  double J2;
  // half the value of J2
  double HalfJ2;
  // first coupling constant between second nearest neighbours in two diffferent succesive chains 
  double J3;
  // half the value of J3
  double HalfJ3;
  // second coupling constant between second nearest neighbours in two diffferent succesive chains
  double J4;
  // half the value of J4
  double HalfJ4;
  ...
  // array containing diagonal terms of the hamiltonian
 ...
 public:
  ...
  MultipleSpinChainHamiltonian(AbstractSpinChain* chains, int nbrSpinPerChain, int nbrChain, double j1, double j2, double j3, double j4);

  // destructor
  //
  ~MultipleSpinChainHamiltonian();
  ...
  MultipleSpinChainHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, MultipleSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, MultipleSpinChainHamiltonian& H);
