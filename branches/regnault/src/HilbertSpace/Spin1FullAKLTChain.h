...
//                                                                            //
//                                                                            //
//        class of spin 1 chain with a 1/2 spin at each end of the chain      //
//                                                                            //
//                        last modification : 17/04/2001                      //
//                                                                            //
//                                                                            //
...
#ifndef SPIN1FULLAKLTCHAIN_H
#define SPIN1FULLAKLTCHAIN_H
...
class Spin1FullAKLTChain : public AbstractSpinChain
{
 ...
 protected:
  ...
  unsigned long RightmostSpinMask;
 ...
 public:
  ...
  Spin1FullAKLTChain (int chainLength, int memorySize);
  ...
  // memorySize = memory size in bytes allowed for look-up table
  Spin1FullAKLTChain (int chainLength, int sz, int memorySize) ;

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  Spin1FullAKLTChain (const Spin1FullAKLTChain& chain);
  ...
  Spin1FullAKLTChain& operator = (const Spin1FullAKLTChain& chain);
 ...
 private:
  ...
  Spin1FullAKLTChain (int hilbertSpaceDimension, unsigned long* chainDescription, int chainLength, 
