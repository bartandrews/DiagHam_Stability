...
void ParticleOnSphereDeltaHamiltonian::ShiftHamiltonian (double shift)
{
}
...
Complex ParticleOnSphereDeltaHamiltonian::MatrixElement (RealVector& V1, RealVector& V2) 
{
  double x = 0.0;
...
Complex ParticleOnSphereDeltaHamiltonian::MatrixElement (ComplexVector& V1, ComplexVector& V2) 
{
  return Complex();
}
...
RealVector& ParticleOnSphereDeltaHamiltonian::LowLevelMultiply(RealVector& vSource, RealVector& vDestination) 
{
...
RealVector& ParticleOnSphereDeltaHamiltonian::LowLevelAddMultiply(RealVector& vSource, RealVector& vDestination)
{
...
ComplexVector& ParticleOnSphereDeltaHamiltonian::LowLevelMultiply(ComplexVector& vSource, ComplexVector& vDestination) 
{
  return vDestination;
}
...
ComplexVector& ParticleOnSphereDeltaHamiltonian::LowLevelAddMultiply(ComplexVector& vSource, ComplexVector& vDestination)
{
  return vDestination;
}
