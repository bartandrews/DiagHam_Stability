...
#ifndef ANISOTROPICSPINCHAINHAMILTONIAN_H
#define ANISOTROPICSPINCHAINHAMILTONIAN_H
...
class AnisotropicSpinChainHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  AnisotropicSpinChainHamiltonian(AbstractSpinChain* chain, int nbrSpin, double* jxx,
				  double* jyy, double* jzz, double* jxy, double* jxz, double* jyz, 
				  double* sxFactor, double* syFactor, double* szFactor);

  // destructor
  //
  ~AnisotropicSpinChainHamiltonian();
  ...
  AnisotropicSpinChainHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, AnisotropicSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, AnisotropicSpinChainHamiltonian& H);
