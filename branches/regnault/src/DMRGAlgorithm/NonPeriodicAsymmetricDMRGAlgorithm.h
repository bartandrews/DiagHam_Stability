...
#ifndef NONPERIODICASYMMETRICDMRGALGORITHM_H
#define NONPERIODICASYMMETRICDMRGALGORITHM_H
...
class NonPeriodicAsymmetricDMRGAlgorithm : AbstractDMRGAlgorithm
{
 ...
 public:
  ...
  NonPeriodicAsymmetricDMRGAlgorithm (AbstractHamiltonian* blockHamiltonian, 
				      AbstractHamiltonian* interactionBlockHamiltonian,
				      AbstractInteraction* leftInteraction,
				      AbstractInteraction* rightInteraction,
				      AbstractInteraction* rightLeftInteraction, 
  ...
  // destructor
  //
  ~NonPeriodicAsymmetricDMRGAlgorithm ();
