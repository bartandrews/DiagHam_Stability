...
#ifndef FULLREORTHOGONALIZEDBANDLANCZOSALGORITHM_H
#define FULLREORTHOGONALIZEDBANDLANCZOSALGORITHM_H
...
class FullReorthogonalizedBandLanczosAlgorithm : public AbstractLanczosAlgorithm
{
 ...
 public:
  ...
  FullReorthogonalizedBandLanczosAlgorithm(AbstractArchitecture* architecture, int nbrEigenvalue, int maxIter = 1000);

  // copy constructor
  //
  // algorithm = algorithm from which new one will be created
  FullReorthogonalizedBandLanczosAlgorithm(const FullReorthogonalizedBandLanczosAlgorithm& algorithm);
