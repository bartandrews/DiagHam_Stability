...
#ifndef PARTICLEONCIRCLECOULOMBHAMILTONIAN_H
#define PARTICLEONCIRCLECOULOMBHAMILTONIAN_H
...
class ParticleOnCircleCoulombHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  ParticleOnCircleCoulombHamiltonian(ParticleOnTorus* particles, int nbrParticles, int maxMomentum);

  // destructor
  //
  ~ParticleOnCircleCoulombHamiltonian();
  ...
  friend ostream& operator << (ostream& Str, ParticleOnCircleCoulombHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, ParticleOnCircleCoulombHamiltonian& H);
