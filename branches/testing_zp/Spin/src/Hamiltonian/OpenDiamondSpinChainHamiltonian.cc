...
//                                                                            //
//                                                                            //
//                 class of open diamond spin chain  hamiltonian              //
//                                                                            //
...
// nbrDiamond = number of complete diamond
// j1 = first diamond edge coupling constant
// j2 = second diamond edge coupling constant
// j3 = dimanond diagonal coupling constant

OpenDiamondSpinChainHamiltonian::OpenDiamondSpinChainHamiltonian(AbstractSpinChain* chain, int nbrDiamond, double j1, double j2, double j3)
{
  this->Chain = chain;
  this->NbrDiamond = nbrDiamond;
  this->NbrSpin = 3 * this->NbrDiamond;
  this->J1 = j1;
...
OpenDiamondSpinChainHamiltonian::~OpenDiamondSpinChainHamiltonian() 
{
...
void OpenDiamondSpinChainHamiltonian::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
  delete[] this->SzSzContributions;
...
AbstractHilbertSpace* OpenDiamondSpinChainHamiltonian::GetHilbertSpace ()
{
  return this->Chain;
}
...
OpenDiamondSpinChainHamiltonian& OpenDiamondSpinChainHamiltonian::SetChain(AbstractSpinChain* chain)
{  
  delete[] this->SzSzContributions;
  this->Chain = chain;
  this->SzSzContributions = new double [this->Chain->GetHilbertSpaceDimension()];
...
int OpenDiamondSpinChainHamiltonian::GetHilbertSpaceDimension ()
{
...
void OpenDiamondSpinChainHamiltonian::ShiftHamiltonian (double shift)
{
...
Complex OpenDiamondSpinChainHamiltonian::MatrixElement (RealVector& V1, RealVector& V2) 
{
  double x = 0.0;
  double coef;
  int SpinPos = 0;
...
Complex OpenDiamondSpinChainHamiltonian::MatrixElement (ComplexVector& V1, ComplexVector& V2) 
{
  return Complex();
}
...
RealVector& OpenDiamondSpinChainHamiltonian::LowLevelMultiply(RealVector& vSource, RealVector& vDestination) 
{
...
RealVector& OpenDiamondSpinChainHamiltonian::LowLevelAddMultiply(RealVector& vSource, RealVector& vDestination)
{
...
ComplexVector& OpenDiamondSpinChainHamiltonian::LowLevelMultiply(ComplexVector& vSource, ComplexVector& vDestination) 
{
  return vDestination;
}
...
ComplexVector& OpenDiamondSpinChainHamiltonian::LowLevelAddMultiply(ComplexVector& vSource, ComplexVector& vDestination)
{
  return vDestination;
}
...
List<Matrix*> OpenDiamondSpinChainHamiltonian::LeftInteractionOperators()
{
  List<Matrix*> TmpList;
  int Dim = this->Chain->GetHilbertSpaceDimension();
...
List<Matrix*> OpenDiamondSpinChainHamiltonian::RightInteractionOperators()
{
  List<Matrix*> TmpList;
  int Dim = this->Chain->GetHilbertSpaceDimension();
  RealSymmetricMatrix* SxUp = new RealSymmetricMatrix (Dim, true);
  RealAntisymmetricMatrix* SyUp = new RealAntisymmetricMatrix (Dim, true);
  RealSymmetricMatrix* SzUp = new RealSymmetricMatrix (Dim, true);
  this->Chain->Sxi(this->NbrSpin + 1, *SxUp);
  this->Chain->Syi(this->NbrSpin + 1, *SyUp);
  this->Chain->Szi(this->NbrSpin + 1, *SzUp);
  TmpList += SxUp;
  TmpList += SyUp;
  TmpList += SzUp;
  RealSymmetricMatrix* SxDown = new RealSymmetricMatrix (Dim, true);
  RealAntisymmetricMatrix* SyDown = new RealAntisymmetricMatrix (Dim, true);
  RealSymmetricMatrix* SzDown = new RealSymmetricMatrix (Dim, true);
  this->Chain->Sxi(this->NbrSpin + 2, *SxDown);
  this->Chain->Syi(this->NbrSpin + 2, *SyDown);
  this->Chain->Szi(this->NbrSpin + 2, *SzDown);
  TmpList += SxDown;
  TmpList += SyDown;
  TmpList += SzDown;
  return TmpList;
...
void OpenDiamondSpinChainHamiltonian::EvaluateDiagonalMatrixElements()
{
  int dim = this->Chain->GetHilbertSpaceDimension();
...
ostream& operator << (ostream& Str, OpenDiamondSpinChainHamiltonian& H) 
{
...
MathematicaOutput& operator << (MathematicaOutput& Str, OpenDiamondSpinChainHamiltonian& H) 
{
  RealVector TmpV2 (H.Chain->GetHilbertSpaceDimension(), true);
  RealVector* TmpV = new RealVector [H.Chain->GetHilbertSpaceDimension()];
  for (int i = 0; i < H.Chain->GetHilbertSpaceDimension(); i++)
