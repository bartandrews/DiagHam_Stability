...
class DoubleTriangleSpinChainHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  friend ostream& operator << (ostream& Str, DoubleTriangleSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, DoubleTriangleSpinChainHamiltonian& H);
