...
#ifndef PERIODICXXZSPINCHAINHAMILTONIAN_H
#define PERIODICXXZSPINCHAINHAMILTONIAN_H
...
class PeriodicXXZSpinChainHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  PeriodicXXZSpinChainHamiltonian(AbstractSpinChain* chain, int nbrSpin, double* jx, double* jz);

  // destructor
  //
  ~PeriodicXXZSpinChainHamiltonian();

  // set chain
  // 
  // chain = pointer on Hilbert space of the associated system
  // return value = reference on current Hamiltonian
  PeriodicXXZSpinChainHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, PeriodicXXZSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, PeriodicXXZSpinChainHamiltonian& H);
