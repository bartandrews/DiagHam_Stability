...
#ifndef XXZSPINCHAINHAMILTONIAN_H
#define XXZSPINCHAINHAMILTONIAN_H
...
class XXZSpinChainHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  XXZSpinChainHamiltonian(AbstractSpinChain* chain, int nbrSpin, double* jx, double* jz);

  // destructor
  //
  ~XXZSpinChainHamiltonian();

  // set chain
  // 
  // chain = pointer on Hilbert space of the associated system
  // return value = reference on current Hamiltonian
  XXZSpinChainHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, XXZSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, XXZSpinChainHamiltonian& H);
