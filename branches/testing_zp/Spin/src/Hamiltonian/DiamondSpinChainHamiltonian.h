...
#ifndef DIAMONDSPINCHAINHAMILTONIAN_H
#define DIAMONDSPINCHAINHAMILTONIAN_H
...
class DiamondSpinChainHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  DiamondSpinChainHamiltonian(AbstractSpinChain* chain, int nbrDiamond, double j1, double j2, double j3);

  // copy constructor (no data duplication)
  //
  // hamiltonian = hamiltonian to copy
  DiamondSpinChainHamiltonian(const DiamondSpinChainHamiltonian& hamiltonian);
  
  // destructor
  //
  ~DiamondSpinChainHamiltonian();
  ...
  DiamondSpinChainHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, DiamondSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, DiamondSpinChainHamiltonian& H);
