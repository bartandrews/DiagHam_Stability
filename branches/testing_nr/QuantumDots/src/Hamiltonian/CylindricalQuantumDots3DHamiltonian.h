...
#ifndef CYLINDRICALQUANTUMDOTS3DHAMILTONIAN_H
#define CYLINDRICALQUANTUMDOTS3DHAMILTONIAN_H
...
class CylindricalQuantumDots3DHamiltonian : public AbstractHamiltonian
{
 ...
 protected:
  ...
  int LowerImpulsionZ;
   ...
   // system dimension in the plane (in Angstrom unit)
  double RSize; 
 ...
 public:
  ...
  CylindricalQuantumDots3DHamiltonian(PlanarRotationSymmetryZPeriodicOneParticle* space, double mur, double muz, double waveVectorZ, ThreeDConstantCylinderPotential* PotentialInput);

  // copy constructor (without duplicating datas)
  //
  // hamiltonian = reference on hamiltonian to copy  
  CylindricalQuantumDots3DHamiltonian(const CylindricalQuantumDots3DHamiltonian& hamiltonian);

  // destructor
  //  
  ~CylindricalQuantumDots3DHamiltonian();
 ...
 private:
  ...
  void EvaluateInteractionFactors(double waveVectorZ, ThreeDConstantCylinderPotential* &potential);
...
inline AbstractHilbertSpace* CylindricalQuantumDots3DHamiltonian::GetHilbertSpace ()
{
  return this->Space;
}
...
inline int CylindricalQuantumDots3DHamiltonian::GetHilbertSpaceDimension ()
{
