...
class ParticleOnTorusDeltaWithMagneticTranslationsHamiltonian : public AbstractQHEOnTorusWithMagneticTranslationsHamiltonian
{
 ...
 public:
  ...
  friend ostream& operator << (ostream& Str, ParticleOnTorusDeltaWithMagneticTranslationsHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, ParticleOnTorusDeltaWithMagneticTranslationsHamiltonian& H);
