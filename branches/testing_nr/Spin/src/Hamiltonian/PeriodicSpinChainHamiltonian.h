...
#ifndef PERIODICSPINCHAINHAMILTONIAN_H
#define PERIODICSPINCHAINHAMILTONIAN_H
...
class PeriodicSpinChainHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  PeriodicSpinChainHamiltonian(AbstractSpinChain* chain, int nbrSpin, double* j);

  // destructor
  //
  ~PeriodicSpinChainHamiltonian();

  // set chain
  // 
  // chain = pointer on Hilbert space of the associated system
  // return value = reference on current Hamiltonian
  PeriodicSpinChainHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, PeriodicSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, PeriodicSpinChainHamiltonian& H);
