...
//                                                                            //
//                                                                            //
//                   class of full interacting DMRG algorithm                 //
//                                                                            //
...
FullInteractingDMRGAlgorithm::FullInteractingDMRGAlgorithm (AbstractHamiltonian* blockHamiltonian, 
...
FullInteractingDMRGAlgorithm::~FullInteractingDMRGAlgorithm () 
{
}
...
void FullInteractingDMRGAlgorithm::Constraint(AbstractQuantumNumber* quantumNumber)
{
...
void FullInteractingDMRGAlgorithm::RunDMRG(int currentBlockIndex) 
{
...
List<Matrix*> FullInteractingDMRGAlgorithm::TransformOperator(List<Matrix*>& observables, bool spaceFlag, 
...
ExplicitHamiltonian* FullInteractingDMRGAlgorithm::ReduceHamiltonian (AbstractHamiltonian* hamiltonian, 
							       int truncatedSize) 
{
