...
#ifndef FULLINTERACTINGDMRGALGORITHM_H
#define FULLINTERACTINGDMRGALGORITHM_H
...
class FullInteractingDMRGAlgorithm : public AbstractDMRGAlgorithm
{
 ...
 public:
  ...
  FullInteractingDMRGAlgorithm (AbstractHamiltonian* blockHamiltonian, 
			 AbstractHamiltonian* interactionBlockHamiltonian,
			 AbstractInteraction* leftInteraction,
			 AbstractInteraction* rightInteraction,
			 AbstractLanczosAlgorithm* lanczosAlgorithm,
