...
#ifndef SPINCHAINAKLTREALHAMILTONIANWITHTRANSLATIONS_H
#define SPINCHAINAKLTREALHAMILTONIANWITHTRANSLATIONS_H
...
class SpinChainAKLTRealHamiltonianWithTranslations : public SpinChainRealHamiltonianWithTranslations 
{
 ...
 public:
  ...
  SpinChainAKLTRealHamiltonianWithTranslations& SetChain(AbstractSpinChainWithTranslations* chain);
