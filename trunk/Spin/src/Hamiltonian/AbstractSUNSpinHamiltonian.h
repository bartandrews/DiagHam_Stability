...
#ifndef ABSTRACTSUNSPINHAMILTONIAN_H
#define ABSTRACTSUNSPINHAMILTONIAN_H
...
class AbstractSUNSpinHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  // destructor
  //
  virtual ~AbstractSUNSpinHamiltonian();
