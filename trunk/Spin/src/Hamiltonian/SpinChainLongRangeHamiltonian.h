...
#ifndef SPINCHAINLONGRANGEHAMILTONIAN_H
#define SPINCHAINLONGRANGEHAMILTONIAN_H
...
class SpinChainLongRangeHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  SpinChainLongRangeHamiltonian(AbstractSpinChain* chain, int nbrSpin, double* j, double* jz, double* hz);

  // destructor
  //
  ~SpinChainLongRangeHamiltonian();
  ...
  SpinChainLongRangeHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, SpinChainLongRangeHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, SpinChainLongRangeHamiltonian& H);
