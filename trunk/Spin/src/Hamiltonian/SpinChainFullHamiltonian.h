...
#ifndef SPINCHAINFULLHAMILTONIAN_H
#define SPINCHAINFULLHAMILTONIAN_H
...
class SpinChainFullHamiltonian : public AbstractHamiltonian
{
 ...
 protected:
  ...
  // amplitude of the Zeeman term along x + y
  Complex* HPlusFactor;
  // amplitude of the Zeeman term along x - y
  Complex* HMinusFactor;
 ...
 public:
  ...
  SpinChainFullHamiltonian(AbstractSpinChain* chain, int nbrSpin, double* jx, double* jy, double* jz, 
			   double* hx, double* hy, double* hz, bool periodicBoundaryConditions = false);

  // destructor
  //
  ~SpinChainFullHamiltonian();
