...
#ifndef SANDGLASSCHAINHAMILTONIAN_H
#define SANDGLASSCHAINHAMILTONIAN_H
...
class SandGlassSpinChainHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  SandGlassSpinChainHamiltonian(AbstractSpinChain* chain, int nbrSandGlass, double jInternal, double jExternal);

  // destructor
  //
  ~SandGlassSpinChainHamiltonian();

  // set chain
  // 
  // chain = pointer on Hilbert space of the associated system
  // return value = reference on current Hamiltonian
  SandGlassSpinChainHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, SandGlassSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, SandGlassSpinChainHamiltonian& H);
