...
#ifndef PAIRHOPPINGP2SPIN1CHAINLONG_H
#define PAIRHOPPINGP2SPIN1CHAINLONG_H
...
class PairHoppingP2AsSpin1ChainLong : public  PairHoppingP1AsSpin1ChainLong
{
...
public:
  ...
  PairHoppingP2AsSpin1ChainLong (int chainLength, bool periodicBoundaryConditions = false, int memorySize = -1, bool useForEntanglementMatrix = false);
  ...
  PairHoppingP2AsSpin1ChainLong (int chainLength, int nbrPlusRight, int nbrMinusLeft, int memorySize = -1);
  
  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  PairHoppingP2AsSpin1ChainLong (const PairHoppingP2AsSpin1ChainLong& chain);

  // destructor
  //
  virtual ~PairHoppingP2AsSpin1ChainLong ();

  // assignement (without duplicating datas)
  //
  // chain = reference on chain to copy
  // return value = reference on current chain
  PairHoppingP2AsSpin1ChainLong& operator = (const PairHoppingP2AsSpin1ChainLong& chain);
