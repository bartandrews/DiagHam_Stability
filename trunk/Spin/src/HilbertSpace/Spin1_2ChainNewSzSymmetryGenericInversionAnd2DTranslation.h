...
#ifndef SPIN1_2CHAINNEWSZSYMMETRYGENERICINVERSIONAND2DTRANSLATION_H
#define SPIN1_2CHAINNEWSZSYMMETRYGENERICINVERSIONAND2DTRANSLATION_H
...
class Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation : public Spin1_2ChainNewGenericInversionAnd2DTranslation
{
 ...
 public:
  ...
  // default constructor
  //
  Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation ();
  ...
  Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation (int nbrSite, int sz, int szSymmetrySector, int inversionSymmetrySector, int* inversionList,
  ...
  // memory = amount of memory granted for precalculations
  Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation (char* fileName, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation (const Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation& chain);
  ...
  Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation& operator = (const Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation& chain);
...
inline unsigned long Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation::FindCanonicalForm(unsigned long stateDescription, int& nbrTranslationX, 
												  int& nbrTranslationY, double& inversionSign)
{
  cout << "Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation::FindCanonicalForm is not working, please fix it"  << endl;
...
inline bool Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation::TestMomentumConstraint(unsigned long stateDescription)
{
  cout << "Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation::TestMomentumConstraint is not working, please fix it"  << endl;
...
inline int Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation::FindOrbitSize(unsigned long stateDescription)
{
  cout << "Spin1_2ChainNewSzSymmetryGenericInversionAnd2DTranslation::FindOrbitSize is not working, please fix it"  << endl;
