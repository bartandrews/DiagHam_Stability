...
#ifndef SPIN1_2CHAINWITHTRANSLATIONSLONG_H
#define SPIN1_2CHAINWITHTRANSLATIONSLONG_H
...
class Spin1_2ChainWithTranslationsLong : public AbstractSpinChainWithTranslations
{
 ...
 public:
  ...
  // default constructor
  //
  Spin1_2ChainWithTranslationsLong ();
  ...
  Spin1_2ChainWithTranslationsLong (int chainLength, int momentum, int translationStep, int memorySize, int memorySlice);
  ...
  // memorySize = memory size in bytes allowed for look-up table
  Spin1_2ChainWithTranslationsLong (int chainLength, int momentum, int translationStep, int sz, int memorySize, int memorySlice);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  Spin1_2ChainWithTranslationsLong (const Spin1_2ChainWithTranslationsLong& chain);
  ...
  Spin1_2ChainWithTranslationsLong& operator = (const Spin1_2ChainWithTranslationsLong& chain);
  ...
  virtual int Parity (ULONGLONG state);
 ...
 protected:
  ...
  virtual ULONGLONG FindCanonicalForm(ULONGLONG state, int& nbrTranslations);
  ...
  // return value = canonical form of the state
  virtual ULONGLONG FindCanonicalForm(ULONGLONG stateDescription, int& nbrTranslation, int& nbrTranslationToIdentity);
  ...
  virtual int FindNumberTranslation(ULONGLONG stateDescription);
  ...
  Spin1_2ChainWithTranslationsLong (int hilbertSpaceDimension, ULONGLONG* chainDescription, int chainLength, 
  ...
  virtual ULONGLONG EncodeSiteState(ULONGLONG physicalState, int sitePosition);
...
inline int Spin1_2ChainWithTranslationsLong::SymmetrizeResult(ULONGLONG& state, int nbrStateInOrbit, double& coefficient, 
							  int& nbrTranslations)
{
...
inline int Spin1_2ChainWithTranslationsLong::FindOrbitSize(ULONGLONG stateDescription)
{
...
inline bool Spin1_2ChainWithTranslationsLong::TestMomentumConstraint(ULONGLONG stateDescription)
{
  ULONGLONG TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);   
...
inline ULONGLONG Spin1_2ChainWithTranslationsLong::FindCanonicalForm(ULONGLONG stateDescription, int& nbrTranslations)
{
  nbrTranslations = 0;
...
inline ULONGLONG Spin1_2ChainWithTranslationsLong::FindCanonicalForm(ULONGLONG stateDescription, int& nbrTranslation, int& nbrTranslationToIdentity)
{
  nbrTranslation = 0;
  nbrTranslationToIdentity = 1;
  ULONGLONG CanonicalState = stateDescription;
  ULONGLONG ReferenceState = stateDescription;
...
inline int Spin1_2ChainWithTranslationsLong::FindNumberTranslation(ULONGLONG stateDescription)
{
  ULONGLONG TmpState = (stateDescription >> this->StateShift) | ((stateDescription & this->StateMask) << this->ComplementaryStateShift);
  int index = 1;  
...
inline void Spin1_2ChainWithTranslationsLong::ApplySingleXTranslation(ULONGLONG& stateDescription)
{
  stateDescription = (stateDescription >> this->StateShift) | ((stateDescription & this->StateMask) << this->ComplementaryStateShift);
}
...
inline int Spin1_2ChainWithTranslationsLong::GetLocalSpin(int site)
{
  return 1;
}
