...
#ifndef PAIRHOPPINGP2SPIN1CHAIN_H
#define PAIRHOPPINGP2SPIN1CHAIN_H
...
class PairHoppingP2AsSpin1Chain : public  PairHoppingP1AsSpin1Chain
{
...
public:
  ...
  PairHoppingP2AsSpin1Chain (const PairHoppingP2AsSpin1Chain& chain);

  // destructor
  //
  virtual ~PairHoppingP2AsSpin1Chain ();

  // assignement (without duplicating datas)
  //
  // chain = reference on chain to copy
  // return value = reference on current chain
  PairHoppingP2AsSpin1Chain& operator = (const PairHoppingP2AsSpin1Chain& chain);
