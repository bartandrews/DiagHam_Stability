...
//        and the inversion and Sz<->-Sz symmetries, with up to 128 sites     //
//                                                                            //
...
Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong () 
{
}
...
Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong (int chainLength, int momentum, int translationStep, int inversionSector, int szSymmetrySector, int memorySize, int memorySlice) 
{
  this->Flag.Initialize();
  this->ChainLength = chainLength;
  this->FixedSpinProjectionFlag = false;
  this->ComplementaryStateShift = this->ChainLength - translationStep;
  this->StateMask = (((ULONGLONG) 0x1ul) << translationStep) - ((ULONGLONG) 0x1ul);
...
Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong (int chainLength, int momentum, int translationStep, int inversionSector, int szSymmetrySector, int sz, int memorySize, int memorySlice) 
{
  this->Flag.Initialize();
  this->ChainLength = chainLength;
  this->Sz = sz;
...
Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong (const Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong& chain) 
{
...
Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong& Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::operator = (const Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong& chain)
{
...
AbstractHilbertSpace* Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::Clone()
{
  return new Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong (*this);
}

// create precalculation tables
//

void Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::CreatePrecalculationTable()
{
