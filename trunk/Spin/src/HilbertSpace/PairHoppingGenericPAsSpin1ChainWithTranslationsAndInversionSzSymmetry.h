...
#ifndef PAIRHOPPINGGENERICPSPIN1CHAINWITHTRANSLATIONSANDINVERSIONSZSYMMETRY_H
#define PAIRHOPPINGGENERICPSPIN1CHAINWITHTRANSLATIONSANDINVERSIONSZSYMMETRY_H
...
class PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry : public PairHoppingGenericPAsSpin1ChainWithTranslations
{
 ...
 public:
  ...
  // default constructor
  //
  PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry ();
  ...
  PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry (int chainLength, int momentum, int inversionSector, int pValue, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry (const PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry& chain);
  ...
  PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry& operator = (const PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry& chain);
...
inline int PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry::SymmetrizeResult(unsigned long& state, int nbrStateInOrbit, double& coefficient, 
												   int& nbrTranslations)
{
  double TmpSign;
...
inline unsigned long PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry::FindCanonicalForm(unsigned long stateDescription, int& nbrTranslations, double& szSymmetrySign)
{
...
inline int PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry::FindOrbitSize(unsigned long stateDescription)
{
  unsigned long TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);      
...
inline bool PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry::TestMomentumConstraint(unsigned long stateDescription)
{
  unsigned long TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);   
...
inline void PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetry::ApplyInversionSymmetry(unsigned long& stateDescription)
{
#ifdef __64_BITS__
