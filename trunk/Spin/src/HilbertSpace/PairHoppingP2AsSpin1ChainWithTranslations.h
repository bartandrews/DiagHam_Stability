...
#ifndef PAIRHOPPINGP2SPIN1CHAINWITHTRANSLATIONS_H
#define PAIRHOPPINGP2SPIN1CHAINWITHTRANSLATIONS_H
...
class PairHoppingP2AsSpin1ChainWithTranslations : public PairHoppingP1AsSpin1ChainWithTranslations
{
 ...
 public:
  ...
  // default constructor
  //
  PairHoppingP2AsSpin1ChainWithTranslations ();
  ...
  PairHoppingP2AsSpin1ChainWithTranslations (int chainLength, int momentum, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  PairHoppingP2AsSpin1ChainWithTranslations (const PairHoppingP2AsSpin1ChainWithTranslations& chain);
  ...
  PairHoppingP2AsSpin1ChainWithTranslations& operator = (const PairHoppingP2AsSpin1ChainWithTranslations& chain);
