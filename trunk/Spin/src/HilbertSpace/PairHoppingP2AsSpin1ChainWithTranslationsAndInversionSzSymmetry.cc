...
PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry::PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry () 
{
...
PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry::PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry (int chainLength, int momentum, int inversionSector, unsigned long memory) 
{
...
PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry::PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry (const PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry& chain) 
{
...
PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry& PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry::operator = (const PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry& chain)
{
...
AbstractHilbertSpace* PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry::Clone()
{
  return new PairHoppingP2AsSpin1ChainWithTranslationsAndInversionSzSymmetry (*this);
}
