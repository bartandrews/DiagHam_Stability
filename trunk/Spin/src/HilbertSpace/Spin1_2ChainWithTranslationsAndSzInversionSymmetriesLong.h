...
#ifndef SPIN1_2CHAINWITHTRANSLATIONSANDSZINVERSIONSYMMETRIESLONG_H
#define SPIN1_2CHAINWITHTRANSLATIONSANDSZINVERSIONSYMMETRIESLONG_H
...
class Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong : public Spin1_2ChainWithTranslationsAndInversionSymmetryLong
{
 ...
 public:
  ...
  // default constructor
  //
  Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong ();
  ...
  Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong (int chainLength, int momentum, int translationStep, int inversionSector, int szSymmetrySector, int memorySize, int memorySlice);
  ...
  // memorySize = memory size in bytes allowed for look-up table
  Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong (int chainLength, int momentum, int translationStep, int inversionSector, int szSymmetrySector, int sz, int memorySize, int memorySlice);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong (const Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong& chain);
  ...
  Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong& operator = (const Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong& chain);
...
inline ULONGLONG Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::FindCanonicalForm(ULONGLONG stateDescription, int& nbrTranslations, double& szSymmetrySign)
{
...
inline int Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::FindOrbitSize(ULONGLONG stateDescription)
{
  ULONGLONG TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);      
...
inline bool Spin1_2ChainWithTranslationsAndSzInversionSymmetriesLong::TestMomentumConstraint(ULONGLONG stateDescription)
{
  ULONGLONG TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);   
