...
Spin1ChainWithSzInversionSymmetries::Spin1ChainWithSzInversionSymmetries () 
{
...
Spin1ChainWithSzInversionSymmetries::Spin1ChainWithSzInversionSymmetries (int chainLength, int inversionSector, int szSymmetrySector, unsigned long memorySize) 
{
...
Spin1ChainWithSzInversionSymmetries::Spin1ChainWithSzInversionSymmetries (int chainLength, int inversionSector, int szSymmetrySector, int sz, unsigned long memorySize) 
{
  this->Flag.Initialize();
  this->ChainLength = chainLength;
  this->Sz = sz;
...
Spin1ChainWithSzInversionSymmetries::Spin1ChainWithSzInversionSymmetries (const Spin1ChainWithSzInversionSymmetries& chain) 
{
...
Spin1ChainWithSzInversionSymmetries& Spin1ChainWithSzInversionSymmetries::operator = (const Spin1ChainWithSzInversionSymmetries& chain)
{
...
AbstractHilbertSpace* Spin1ChainWithSzInversionSymmetries::Clone()
{
  return new Spin1ChainWithSzInversionSymmetries (*this);
}
