...
PairHoppingP2AsSpin1ChainLong::PairHoppingP2AsSpin1ChainLong () 
{
...
PairHoppingP2AsSpin1ChainLong::PairHoppingP2AsSpin1ChainLong (int chainLength, bool periodicBoundaryConditions, int memorySize, bool useForEntanglementMatrix) 
{
...
PairHoppingP2AsSpin1ChainLong::PairHoppingP2AsSpin1ChainLong (int chainLength, int nbrPlusRight, int nbrMinusLeft, int memorySize)
{
  this->Flag.Initialize();
  this->ChainLength = chainLength;
  this->FixedSpinProjectionFlag = false;
...
PairHoppingP2AsSpin1ChainLong::PairHoppingP2AsSpin1ChainLong (const PairHoppingP2AsSpin1ChainLong& chain) 
{
...
PairHoppingP2AsSpin1ChainLong& PairHoppingP2AsSpin1ChainLong::operator = (const PairHoppingP2AsSpin1ChainLong& chain)
{
...
AbstractHilbertSpace* PairHoppingP2AsSpin1ChainLong::Clone()
{
  return new PairHoppingP2AsSpin1ChainLong (*this);
}
...
long PairHoppingP2AsSpin1ChainLong::EvaluateHilbertSpaceDimension(int previousNbrPlus, int sitePosition)
{
...
long PairHoppingP2AsSpin1ChainLong::RawGenerateStates(long statePosition, int previousNbrPlus, int sitePosition) 
{
  if (sitePosition == this->ChainLength)
    {
...
long PairHoppingP2AsSpin1ChainLong::GenerateStates()
{
...
int PairHoppingP2AsSpin1ChainLong::SwapOperator (int unitCellCoordinate, int siteIndex, int state)
{
...
int PairHoppingP2AsSpin1ChainLong::PlusMinusOperator (int leftUnitCellCoordinate, int rightUnitCellCoordinate, int state)
{
  ULONGLONG TmpStateDescription = this->StateDescription[state];
