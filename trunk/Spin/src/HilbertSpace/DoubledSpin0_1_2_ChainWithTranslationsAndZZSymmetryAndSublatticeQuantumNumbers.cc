...
DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers::DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers ()
{
  this->SubLatticeDifferenceKet = 0;
  this->SubLatticeDifferenceBra = 0;
  this->SubLatticeDifferenceProduct = 0;
}
...
DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers::DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers (const DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers & chain) :   DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetry(chain)
{
  this->SubLatticeDifferenceKet = chain.SubLatticeDifferenceKet;
  this->SubLatticeDifferenceBra = chain.SubLatticeDifferenceBra;
  this->SubLatticeDifferenceProduct = chain.SubLatticeDifferenceProduct;  
}
...
DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers & DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers::operator = (const DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers & chain)
{
  DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetry::operator =(chain);
  this->SubLatticeDifferenceKet = chain.SubLatticeDifferenceKet;
  this->SubLatticeDifferenceBra = chain.SubLatticeDifferenceBra;
  this->SubLatticeDifferenceProduct = chain.SubLatticeDifferenceProduct;  
  return *this;
...
AbstractHilbertSpace* DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers::Clone()
{
  return new DoubledSpin0_1_2_ChainWithTranslationsAndZZSymmetryAndSublatticeQuantumNumbers (*this);
}
