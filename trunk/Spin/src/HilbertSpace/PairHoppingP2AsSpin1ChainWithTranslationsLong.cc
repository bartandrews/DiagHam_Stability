...
PairHoppingP2AsSpin1ChainWithTranslationsLong::PairHoppingP2AsSpin1ChainWithTranslationsLong () 
{
}
...
PairHoppingP2AsSpin1ChainWithTranslationsLong::PairHoppingP2AsSpin1ChainWithTranslationsLong (int chainLength, int momentum, unsigned long memory) 
{
...
PairHoppingP2AsSpin1ChainWithTranslationsLong::PairHoppingP2AsSpin1ChainWithTranslationsLong (const PairHoppingP2AsSpin1ChainWithTranslationsLong& chain) 
{
...
PairHoppingP2AsSpin1ChainWithTranslationsLong& PairHoppingP2AsSpin1ChainWithTranslationsLong::operator = (const PairHoppingP2AsSpin1ChainWithTranslationsLong& chain)
{
...
AbstractHilbertSpace* PairHoppingP2AsSpin1ChainWithTranslationsLong::Clone()
{
  return new PairHoppingP2AsSpin1ChainWithTranslationsLong(*this);
}
...
int PairHoppingP2AsSpin1ChainWithTranslationsLong::SwapOperator (int unitCellCoordinate, int siteIndex, int state, double& coefficient, int& nbrTranslation)
{
...
int PairHoppingP2AsSpin1ChainWithTranslationsLong::PlusMinusOperator (int leftUnitCellCoordinate, int rightUnitCellCoordinate, int state, double& coefficient, int& nbrTranslation)
{
  ULONGLONG TmpStateDescription = this->StateDescription[state];
...
long PairHoppingP2AsSpin1ChainWithTranslationsLong::GenerateStates()
{
...
RealMatrix PairHoppingP2AsSpin1ChainWithTranslationsLong::EvaluatePartialEntanglementMatrix (int nbrSites, int szSector, RealVector& groundState, AbstractArchitecture* architecture)
{
  if (nbrSites == 0)
    {
      if (szSector == 0)
  ...
  PairHoppingP2AsSpin1ChainLong TmpDestinationHilbertSpace(nbrSites, TmpNbrPlusRight, TmpNbrMinusLeft, 1000000);
  PairHoppingP2AsSpin1ChainLong TmpHilbertSpace(this->ChainLength - nbrSites, TmpNbrMinusLeft, TmpNbrPlusRight, 1000000);
...
ComplexMatrix PairHoppingP2AsSpin1ChainWithTranslationsLong::EvaluatePartialEntanglementMatrix (int nbrSites, int szSector, ComplexVector& groundState, AbstractArchitecture* architecture)
{
  if (nbrSites == 0)
    {
      if (szSector == 0)
