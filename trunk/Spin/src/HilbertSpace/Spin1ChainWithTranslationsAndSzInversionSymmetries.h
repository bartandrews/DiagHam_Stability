...
#ifndef SPIN1CHAINWITHTRANSLATIONSANDSZINVERSIONSYMMETRIES_H
#define SPIN1CHAINWITHTRANSLATIONSANDSZINVERSIONSYMMETRIES_H
...
class Spin1ChainWithTranslationsAndSzInversionSymmetries : public Spin1ChainWithTranslationsAndInversionSymmetry
{
 ...
 public:
  ...
  // default constructor
  //
  Spin1ChainWithTranslationsAndSzInversionSymmetries ();
  ...
  Spin1ChainWithTranslationsAndSzInversionSymmetries (int chainLength, int momentum, int inversionSector, int szSymmetrySector, unsigned long memory = 10000000);
  ...
  // szSymmetrySector = Sz<->-Sz symmetry sector (can be either +1 or -1)
  // memory = amount of memory granted for precalculations
  Spin1ChainWithTranslationsAndSzInversionSymmetries (int chainLength, int momentum, int inversionSector, int szSymmetrySector, int sz, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  Spin1ChainWithTranslationsAndSzInversionSymmetries (const Spin1ChainWithTranslationsAndSzInversionSymmetries& chain);
  ...
  Spin1ChainWithTranslationsAndSzInversionSymmetries& operator = (const Spin1ChainWithTranslationsAndSzInversionSymmetries& chain);
...
inline unsigned long Spin1ChainWithTranslationsAndSzInversionSymmetries::FindCanonicalForm(unsigned long stateDescription, int& nbrTranslations, double& szSymmetrySign)
{
...
inline int Spin1ChainWithTranslationsAndSzInversionSymmetries::FindOrbitSize(unsigned long stateDescription)
{
  unsigned long TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);      
...
inline bool Spin1ChainWithTranslationsAndSzInversionSymmetries::TestMomentumConstraint(unsigned long stateDescription)
{
  unsigned long TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);   
