...
PairHoppingP1AsSpin1ChainWithTranslationsLong::PairHoppingP1AsSpin1ChainWithTranslationsLong () 
{
}
...
PairHoppingP1AsSpin1ChainWithTranslationsLong::PairHoppingP1AsSpin1ChainWithTranslationsLong (int chainLength, int momentum, unsigned long memory) 
{
...
PairHoppingP1AsSpin1ChainWithTranslationsLong::PairHoppingP1AsSpin1ChainWithTranslationsLong (const PairHoppingP1AsSpin1ChainWithTranslationsLong& chain) 
{
...
PairHoppingP1AsSpin1ChainWithTranslationsLong& PairHoppingP1AsSpin1ChainWithTranslationsLong::operator = (const PairHoppingP1AsSpin1ChainWithTranslationsLong& chain)
{
...
AbstractHilbertSpace* PairHoppingP1AsSpin1ChainWithTranslationsLong::Clone()
{
  return new PairHoppingP1AsSpin1ChainWithTranslationsLong (*this);
}
...
int PairHoppingP1AsSpin1ChainWithTranslationsLong::SwapOperator (int unitCellCoordinate, int siteIndex, int state, double& coefficient, int& nbrTranslation)
{
...
int PairHoppingP1AsSpin1ChainWithTranslationsLong::PlusMinusOperator (int leftUnitCellCoordinate, int rightUnitCellCoordinate, int state, double& coefficient, int& nbrTranslation)
{
...
long PairHoppingP1AsSpin1ChainWithTranslationsLong::EvaluateHilbertSpaceDimension(int previousSpin, int sitePosition)
{
...
long PairHoppingP1AsSpin1ChainWithTranslationsLong::RawGenerateStates(long statePosition, int previousSpin, int sitePosition) 
{
  if (sitePosition == this->ChainLength)
    {
...
long PairHoppingP1AsSpin1ChainWithTranslationsLong::GenerateStates()
{
  ...
  for (long i = 0; i < this->LargeHilbertSpaceDimension; ++i)
    {
      ULONGLONG Tmp = (this->StateDescription[i] & ((ULONGLONG) 0x3ul)) | ((this->StateDescription[i] >> TmpLastUnitCellShift) & ((ULONGLONG) 0xcul));
      if ((Tmp == ((ULONGLONG) 0xful)) || (Tmp == ((ULONGLONG) 0xeul)) || (Tmp == ((ULONGLONG) 0x8ul)) || (Tmp == ((ULONGLONG) 0x0ul)))
	{
...
ComplexMatrix PairHoppingP1AsSpin1ChainWithTranslationsLong::EvaluatePartialEntanglementMatrix (int nbrSites, int szSector, ComplexVector& groundState, AbstractArchitecture* architecture)
{
  if (nbrSites == 0)
    {
  ...
  PairHoppingP1AsSpin1ChainLong TmpDestinationHilbertSpace(nbrSites, false, 1000000);
  PairHoppingP1AsSpin1ChainLong TmpHilbertSpace(this->ChainLength - nbrSites, false, 1000000);
