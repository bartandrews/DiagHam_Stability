...
#ifndef SUNSPINPRECALCULATIONOPERATION_H
#define SUNSPINPRECALCULATIONOPERATION_H
...
class SUNSpinPrecalculationOperation: public AbstractPrecalculationOperation
{
 ...
 public:
  ...
  SUNSpinPrecalculationOperation(AbstractSUNSpinHamiltonian* hamiltonian, bool firstPass = true);

  // copy constructor 
  //
  // operation = reference on operation to copy
  SUNSpinPrecalculationOperation(const SUNSpinPrecalculationOperation& operation);
  
  // destructor
  //
  ~SUNSpinPrecalculationOperation();
