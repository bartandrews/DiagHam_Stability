...
#ifndef SPINWITH2DTRANSLATIONS2OPERATOR_H
#define SPINWITH2DTRANSLATIONS2OPERATOR_H
...
class SpinWith2DTranslationS2Operator : public AbstractOperator
{
 ...
 public:
  ...
  SpinWith2DTranslationS2Operator(AbstractSpinChain* chain, int nbrSpin, int xMomentum, int maxXMomentum, int yMomentum, int maxYMomentum);

  // destructor
  //
  ~SpinWith2DTranslationS2Operator();
  ...
  Complex PartialMatrixElement (RealVector& V1, RealVector& V2, 
