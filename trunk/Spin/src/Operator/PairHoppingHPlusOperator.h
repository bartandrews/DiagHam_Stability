...
#ifndef PAIRHOPPINGHPLUSOPERATOR_H
#define PAIRHOPPINGHPLUSOPERATOR_H
...
class PairHoppingHPlusOperator : public AbstractOperator
{
 ...
 public:
  ...
  PairHoppingHPlusOperator(AbstractSpinChain* chain, int nbrSpin, int pValue, bool periodicBoundaryConditions = false);

  // destructor
  //
  ~PairHoppingHPlusOperator();
