...
ModelList[]={
	...
	"HofPySymmetric","HofSymmetric","HofGeneral","p2x4","AnisoHofstadter"
};
...
nParams["AnisoHofstadter"]=3; 
lattice["AnisoHofstadter"]="Square";
nBands[{"AnisoHofstadter",p_,q_,\[Alpha]_}]:=q;

H[{kx_,ky_},{"AnisoHofstadter",p_,q_Integer,\[Alpha]_}]:=
SparseArray[{
		Band[{1,1}]->Table[
			2*Cos[2Pi*(ky+m*p/q)]/\[Alpha],
			{m,q}
		],
		Band[{2,1}]->\[Alpha]*Exp[2Pi*I*kx],
		Band[{1,2}]->\[Alpha]*Exp[-2Pi*I*kx],
		{q,1}->\[Alpha]*Exp[-2Pi*I*kx],
		{1,q}->\[Alpha]*Exp[2Pi*I*kx]
	},
	{q,q}
];
NdH[{kx_,ky_},{"AnisoHofstadter",p_,q_Integer,\[Alpha]_},derivs:{1..}]:=
With[{n=Length[derivs]},
SparseArray[{
		Band[{2,1}]->\[Alpha]*(2Pi*I)^n*Exp[2Pi*I*kx],
		Band[{1,2}]->\[Alpha]*(-2Pi*I)^n*Exp[-2Pi*I*kx],
		{q,1}->\[Alpha]*(-2Pi*I)^n*Exp[-2Pi*I*kx],
		{1,q}->\[Alpha]*(2Pi*I)^n*Exp[2Pi*I*kx]
	},
	{q,q}
]];

NdH[{kx_,ky_},{"AnisoHofstadter",p_,q_Integer,\[Alpha]_},derivs:{2..}]:=
With[{n=Length[derivs]},
SparseArray[{
		Band[{1,1}]->Table[
			(2Pi*I)^n*Exp[2Pi*I(ky+m*p/q)]/\[Alpha] + 
			(-2Pi*I)^n*Exp[-2Pi*I(ky+m*p/q)]/\[Alpha],
			{m,q}
		]
	},
...
(* All mixed derivatives vanish *)
NdH[{kx_,ky_},{"AnisoHofstadter",p_,q_Integer},derivs_List]:=
SparseArray[{},{q,q}];
