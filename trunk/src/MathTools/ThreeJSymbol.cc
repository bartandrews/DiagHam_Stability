...
ThreeJSymbol::ThreeJSymbol(int j1, int j2)
{
  this->J1 = j1;
  this->J2 = j2;
...
void ThreeJSymbol::EvaluateClebschGordanCoefficients()
{
  int TotalM1 = (this->J1 + 1);
  int TotalM2 = (this->J2 + 1);      
  int SumM;
...
double ThreeJSymbol::CCoefficient (int m1, int m2, int j)
{
...
double ThreeJSymbol::DCoefficient (int m1, int m2, int j)
{
...
void ThreeJSymbol::RecursionAlgorithm (int m1, int m2Min, int m2Max, int j)
{
