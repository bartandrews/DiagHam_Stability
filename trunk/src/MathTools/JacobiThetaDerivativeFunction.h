...
#ifndef JACOBITHETADERIVATIVEFUNCTION_H
#define JACOBITHETADERIVATIVEFUNCTION_H
...
class JacobiThetaDerivativeFunction : JacobiThetaFunction
{
 ...
 public:
  ...
  JacobiThetaDerivativeFunction(double a, double b, Complex tau=Complex(0.0,1.0));
  ...
  // tau = modulus
  // precision = required precision
  JacobiThetaDerivativeFunction(int i, Complex tau=Complex(0.0,1.0));

  // copy constructor (without duplicating datas)
  //
  // coefficients = reference on Clebsch Gordan coefficients to copy
  JacobiThetaDerivativeFunction (const JacobiThetaDerivativeFunction& theta);
