...
#ifndef BASICCOMPLEXARNOLDIALGORITHM_H
#define BASICCOMPLEXARNOLDIALGORITHM_H
...
class BasicComplexArnoldiAlgorithm : public AbstractLanczosAlgorithm
{
 ...
 public:
  ...
  BasicComplexArnoldiAlgorithm(const BasicComplexArnoldiAlgorithm& algorithm);

  // destructor
  //
  ~BasicComplexArnoldiAlgorithm();
