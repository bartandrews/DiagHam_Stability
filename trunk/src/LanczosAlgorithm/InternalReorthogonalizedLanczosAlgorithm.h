...
#ifndef INTERNALREORTHOGONALIZEDLANCZOSALGORITHM_H
#define INTERNALREORTHOGONALIZEDLANCZOSALGORITHM_H
...
class InternalReorthogonalizedLanczosAlgorithm : public AbstractLanczosAlgorithm
{
 ...
 public:
  ...
  InternalReorthogonalizedLanczosAlgorithm(AbstractArchitecture* architecture, int nbrEigenvalue, int maxNbrVectors = 0, int maxIter = 100);

  // copy constructor
  //
  // algorithm = algorithm from which new one will be created
  InternalReorthogonalizedLanczosAlgorithm(const InternalReorthogonalizedLanczosAlgorithm& algorithm);

  // destructor
  //
  ~InternalReorthogonalizedLanczosAlgorithm();
  ...
  void ProjectVector(RealVector &vector);
