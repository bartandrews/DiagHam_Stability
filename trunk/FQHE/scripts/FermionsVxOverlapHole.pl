...
my $Result = GetOptions ("progdiag:s" => \$PathToDiagonalizationProgram, "progoverlap:s" => \$PathToOverlapProgram, 
			 ...
			 "pseudopotentials=s" => \$BasePseudopotentialFilename,
...
if ($GridFile eq "")
  {
	...
	my $Overlap = &EvaluateOverlap($PathToDiagonalizationProgram, $PathToOverlapProgram, $NbrFermions, $LzMax, $ReferenceVector, $DiagOutputFileName, $KeepFlag,
