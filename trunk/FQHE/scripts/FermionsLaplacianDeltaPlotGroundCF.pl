...
if (!(defined($ARGV[4])))
  {
    die "usage: FindGapGeneric StartN StartS NInc SInc Caption [1_N_Factor] [Shift] [PrintFlag]";
  }
my $PrintFlag = 0;
...
sub CreatePostScript
  {
    ...
    my $FileName2 = "fermions_laplaciandelta_ground_".$Caption."_FilledShells.dat";
