...
BosonOnS2xS2Long::BosonOnS2xS2Long ()
{
...
BosonOnS2xS2Long::BosonOnS2xS2Long (int nbrBosons, int nbrFluxQuanta1, int nbrFluxQuanta2, int totalLz1, int totalLz2, unsigned long memory)
{  
...
BosonOnS2xS2Long::BosonOnS2xS2Long(const BosonOnS2xS2Long& bosons)
{
...
BosonOnS2xS2Long & BosonOnS2xS2Long::operator = (const BosonOnS2xS2Long & bosons)
{
  if (bosons.TargetSpace != &bosons)
    this->TargetSpace = bosons.TargetSpace;
  else
...
AbstractHilbertSpace* BosonOnS2xS2Long::Clone()
{
  return new BosonOnS2xS2Long(*this);
}
...
long BosonOnS2xS2Long::GenerateStates(ULONGLONG* stateDescription, int nbrBosons, int currentKx, int currentKy, int currentTotalKx, int currentTotalKy, int currentFermionicPosition, long pos)
{
...
long BosonOnS2xS2Long::EvaluateHilbertSpaceDimension(int nbrBosons, int currentKx, int currentKy, int currentTotalKx, int currentTotalKy)
{
  if (nbrBosons < 0)
    return 0l;
  if (currentKy < 0)
...
RealVector& BosonOnS2xS2Long::ConvertToUnnormalizedMonomial(RealVector& state, long reference, bool symmetryFactor)
{
...
ostream& BosonOnS2xS2Long::PrintStateMonomial (ostream& Str, long state)
{
  int TmpLz;
  int TmpKz;
  unsigned long* TmpMonomial = new unsigned long [this->NbrBosons];
