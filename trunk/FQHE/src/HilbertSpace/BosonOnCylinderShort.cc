...
#include "config.h"
#include "HilbertSpace/BosonOnCylinderShort.h"
...
// kyMax = number of orbitals

BosonOnCylinderShort::BosonOnCylinderShort (int nbrBosons, int totalKy, int kyMax)
{
  this->TargetSpace = this;
  this->NbrBosons = nbrBosons;
  this->IncNbrBosons = this->NbrBosons + 1;
  this->TotalLz = totalKy;
  this->LzMax = kyMax;
  this->ShiftedTotalLz = this->TotalLz;
  this->TotalLz = (2 * this->TotalLz - (this->NbrBosons * kyMax));
...
BosonOnCylinderShort::BosonOnCylinderShort(const BosonOnCylinderShort& bosons)
{
...
BosonOnCylinderShort::~BosonOnCylinderShort ()
{
}
...
BosonOnCylinderShort& BosonOnCylinderShort::operator = (const BosonOnCylinderShort& bosons)
{
