...
//                     involving more than 32 orbitals                        //
//                                                                            //
...
#ifndef FERMIONONTORUSWITHMAGNETICTRANSLATIONSLONG_H
#define FERMIONONTORUSWITHMAGNETICTRANSLATIONSLONG_H
...
class FermionOnTorusWithMagneticTranslationsLong :  public ParticleOnTorusWithMagneticTranslations
{
 ...
 public:
  ...
  // default constructor
  // 
  FermionOnTorusWithMagneticTranslationsLong ();
  ...
  FermionOnTorusWithMagneticTranslationsLong (int nbrFermions, int maxMomentum, int xMomentum, int yMomentum);

  // copy constructor (without duplicating datas)
  //
  // fermions = reference on the hilbert space to copy to copy
  FermionOnTorusWithMagneticTranslationsLong (const FermionOnTorusWithMagneticTranslationsLong& fermions);
  ...
  FermionOnTorusWithMagneticTranslationsLong& operator = (const FermionOnTorusWithMagneticTranslationsLong& fermions);
 ...
 protected:
  ...
  // yMomentum = state momentum value in the y direction
  // return value = canonical form of a state description
  virtual ULONGLONG SafeFindCanonicalForm(ULONGLONG stateDescription, int& maxMomentum, int& nbrTranslation);
  ...
  virtual  ULONGLONG FindCanonicalFormAndTestXMomentumConstraint(ULONGLONG stateDescription, int& maxMomentum, int& nbrTranslation);
  ...
  virtual  int FindNumberXTranslation(ULONGLONG stateDescription);
  ...
  virtual  bool TestXMomentumConstraint(ULONGLONG stateDescription, int maxMomentum);
  ...
  virtual long EvaluateHilbertSpaceDimension(int nbrFermions, int maxMomentum);
  ...
  // return value = hilbert space dimension
  virtual  long GenerateStates(long tmpDimension);
...
inline int FermionOnTorusWithMagneticTranslationsLong::GetParticleStatistic()
{
...
inline int FermionOnTorusWithMagneticTranslationsLong::GetNbrOrbitals()
{
...
inline int FermionOnTorusWithMagneticTranslationsLong::GetNbrParticles()
{
...
inline int FermionOnTorusWithMagneticTranslationsLong::GetKxMomentum()
{
...
inline int FermionOnTorusWithMagneticTranslationsLong::GetKyMomentum()
{
...
inline int FermionOnTorusWithMagneticTranslationsLong::GetMaxXMomentum()
{
...
inline int FermionOnTorusWithMagneticTranslationsLong::GetMaxYMomentum()
{
  return this->MaxMomentum;
}
...
inline ULONGLONG FermionOnTorusWithMagneticTranslationsLong::FindCanonicalForm(ULONGLONG stateDescription, int& maxMomentum, int& nbrTranslation)
{
  nbrTranslation = 0;
...
inline int FermionOnTorusWithMagneticTranslationsLong::FindNumberXTranslation(ULONGLONG stateDescription)
{
...
inline bool FermionOnTorusWithMagneticTranslationsLong::TestXMomentumConstraint(ULONGLONG stateDescription, int maxMomentum)
{
...
inline ULONGLONG FermionOnTorusWithMagneticTranslationsLong::FindCanonicalFormAndTestXMomentumConstraint(ULONGLONG stateDescription, int& maxMomentum, int& nbrTranslation)
{
  nbrTranslation = 0;
  ULONGLONG CanonicalState = stateDescription;
  ULONGLONG stateDescriptionReference = stateDescription;
...
inline int FermionOnTorusWithMagneticTranslationsLong::FindStateIndex(ULONGLONG stateDescription, int maxMomentum)
{
...
inline int FermionOnTorusWithMagneticTranslationsLong::GetC2SymmetricState (int index, int& nbrTranslation)
{
  //  cout << index << " : " << hex << this->StateDescription[index] << " ";
  ULONGLONG InitialState = this->StateDescription[index] << this->InvertShift;
...
inline void FermionOnTorusWithMagneticTranslationsLong::ConvertToMonomial(ULONGLONG initialState, unsigned long*& finalState)
{
  int Index = 0;
  for (long j = this->MaxMomentum; j >= 0l; --j)
    if (((initialState >> j) & ((ULONGLONG) 0x1ul)) != ((ULONGLONG) 0x0ul))
...
inline ULONGLONG FermionOnTorusWithMagneticTranslationsLong::ConvertFromMonomial(unsigned long* initialState)
{
