...
#ifndef BOSONONSPHERESHORTHARDCORE_H
#define BOSONONSPHERESHORTHARDCORE_H
...
class BosonOnSphereShortHardcore :  public FermionOnSphere
{
 ...
 protected:
  ...
  BosonOnSphereShortHardcore* TargetSpace;

 public:

  // default constuctor
  //
  BosonOnSphereShortHardcore();
  ...
  BosonOnSphereShortHardcore (int nbrFermions, int totalLz, int lzMax, unsigned long memory = 10000000);
  ...
  // memory = amount of memory granted for precalculations
  BosonOnSphereShortHardcore (int nbrFermions, int totalLz, int lzMax, unsigned long* stateDescription, long hilbertSpaceDimension, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // fermions = reference on the hilbert space to copy to copy
  BosonOnSphereShortHardcore(const BosonOnSphereShortHardcore& fermions);
  ...
  BosonOnSphereShortHardcore(const BosonOnSphereShortHardcore& fermions, long nbrPreservedStates, bool* preservedStates);

  // destructor
  //
  virtual ~BosonOnSphereShortHardcore ();

  // assignment (without duplicating datas)
  //
  // fermions = reference on the hilbert space to copy to copy
  // return value = reference on current hilbert space
  BosonOnSphereShortHardcore& operator = (const BosonOnSphereShortHardcore& fermions);
...
inline int BosonOnSphereShortHardcore::GetParticleStatistic()
{
