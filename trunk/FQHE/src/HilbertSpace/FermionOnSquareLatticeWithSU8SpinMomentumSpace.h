...
#ifndef FERMIONONSQUARELATTICEWITHSU8SPINMOMENTUMSPACE_H
#define FERMIONONSQUARELATTICEWITHSU8SPINMOMENTUMSPACE_H
...
class FermionOnSquareLatticeWithSU8SpinMomentumSpace : public FermionOnSphereWithSU8Spin
{
 ...
 public:
  ...
  FermionOnSquareLatticeWithSU8SpinMomentumSpace (int nbrFermions, int nbrSiteX, int nbrSiteY, int kxMomentum, int kyMomentum, unsigned long memory = 10000000);
  ...
  // memory = amount of memory granted for precalculations
  FermionOnSquareLatticeWithSU8SpinMomentumSpace (int nbrFermions, int nbrSiteX, int nbrSiteY, int kxMomentum, int kyMomentum,
  ...
  // memory = amount of memory granted for precalculations
  FermionOnSquareLatticeWithSU8SpinMomentumSpace (int nbrFermions, int nbrSiteX, int nbrSiteY,
  ...
  FermionOnSquareLatticeWithSU8SpinMomentumSpace(const FermionOnSquareLatticeWithSU8SpinMomentumSpace& fermions);

  // destructor
  //
  ~FermionOnSquareLatticeWithSU8SpinMomentumSpace ();

  // assignement (without duplicating datas)
  //
  // fermions = reference on the hilbert space to copy to copy
  // return value = reference on current hilbert space
  FermionOnSquareLatticeWithSU8SpinMomentumSpace& operator = (const FermionOnSquareLatticeWithSU8SpinMomentumSpace& fermions);
 ...
 protected:
  ...
  // pos = position in StateDescription array where to store states
  // return value = position from which new states have to be stored
  virtual long GenerateStatesOneBand(unsigned long* stateDescriptions, int nbrFermions, int kxMomentum, int kyMomentum,
