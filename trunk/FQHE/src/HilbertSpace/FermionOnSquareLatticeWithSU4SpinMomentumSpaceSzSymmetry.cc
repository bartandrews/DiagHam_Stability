...
FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry::FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry ()
{
...
FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry::FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry (int nbrFermions, int nbrSiteX, int nbrSiteY, int kxMomentum, int kyMomentum, bool minusSzParity, unsigned long memory)
{  
...
FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry::FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry (int nbrFermions, int nbrSiteX, int nbrSiteY, int kxMomentum, int kyMomentum, int totalSpin, bool minusSzParity, unsigned long memory)
{
  this->NbrFermions = nbrFermions;
  this->IncNbrFermions = this->NbrFermions + 1;
  this->SzFlag = true;
...
FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry::FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry (int nbrFermions, int nbrSiteX, int nbrSiteY, int kxMomentum, int kyMomentum, int totalSpin, int totalIsospin, bool minusSzParity, unsigned long memory)
{  
  this->NbrFermions = nbrFermions;
  this->IncNbrFermions = this->NbrFermions + 1;
  this->SzFlag = true;
...
FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry::FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry (int nbrFermions, int nbrSiteX, int nbrSiteY, int kxMomentum, int kyMomentum, int totalSpin, int totalIsospin,
...
FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry::FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry(const FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry& fermions)
{
...
FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry& FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry::operator = (const FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry& fermions)
{
...
AbstractHilbertSpace* FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry::Clone()
{
  return new FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry(*this);
}
...
long FermionOnSquareLatticeWithSU4SpinMomentumSpaceSzSymmetry::GenerateStatesWithSymmetries()
{
  long TmpDimension = 0l;
  for (long i = 0l; i < this->LargeHilbertSpaceDimension; ++i)
    {
      unsigned long& TmpState = this->StateDescription[i];
      unsigned long TmpState2 = this->ApplySzSymmetry(TmpState);
      if (TmpState >= TmpState2)
	{
	  if (TmpState == TmpState2)
	    {
	      if (this->GetSzSymmetrySign(TmpState) == this->SzParitySign)
		{
		  ++TmpDimension;
		}
	      else
