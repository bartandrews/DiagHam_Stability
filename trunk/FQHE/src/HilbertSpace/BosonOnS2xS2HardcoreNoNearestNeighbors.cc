...
BosonOnS2xS2HardcoreNoNearestNeighbors::BosonOnS2xS2HardcoreNoNearestNeighbors ()
{
}
...
BosonOnS2xS2HardcoreNoNearestNeighbors::BosonOnS2xS2HardcoreNoNearestNeighbors (int nbrBosons, int nbrFluxQuanta1, int nbrFluxQuanta2, int totalLz1, int totalLz2, unsigned long memory)
{  
...
BosonOnS2xS2HardcoreNoNearestNeighbors::BosonOnS2xS2HardcoreNoNearestNeighbors(const BosonOnS2xS2HardcoreNoNearestNeighbors& bosons)
{
...
BosonOnS2xS2HardcoreNoNearestNeighbors & BosonOnS2xS2HardcoreNoNearestNeighbors::operator = (const BosonOnS2xS2HardcoreNoNearestNeighbors & bosons)
{
  if (bosons.TargetSpace != &bosons)
    this->TargetSpace = bosons.TargetSpace;
  else
...
AbstractHilbertSpace* BosonOnS2xS2HardcoreNoNearestNeighbors::Clone()
{
  return new BosonOnS2xS2HardcoreNoNearestNeighbors(*this);
}
...
long BosonOnS2xS2HardcoreNoNearestNeighbors::GenerateStates(int nbrBosons, int currentKx, int currentKy, int currentTotalKx, int currentTotalKy, int currentFermionicPosition, long pos)
{
...
long BosonOnS2xS2HardcoreNoNearestNeighbors::EvaluateHilbertSpaceDimension(int nbrBosons, int currentKx, int currentKy, int currentTotalKx, int currentTotalKy)
{
  if (nbrBosons < 0)
    return 0l;
  if (currentKy < 0)
