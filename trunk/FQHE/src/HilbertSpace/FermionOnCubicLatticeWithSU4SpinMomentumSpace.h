...
#ifndef FERMIONONCUBICLATTICEWITHSU4SPINMOMENTUMSPACE_H
#define FERMIONONCUBICLATTICEWITHSU4SPINMOMENTUMSPACE_H
...
class FermionOnCubicLatticeWithSU4SpinMomentumSpace : public FermionOnSphereWithSU4Spin
{
 ...
 public:
  ...
  FermionOnCubicLatticeWithSU4SpinMomentumSpace (int nbrFermions, int nbrSiteX, int nbrSiteY, int nbrSiteZ, int kxMomentum, int kyMomentum, int kzMomentum, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // fermions = reference on the hilbert space to copy to copy
  FermionOnCubicLatticeWithSU4SpinMomentumSpace(const FermionOnCubicLatticeWithSU4SpinMomentumSpace& fermions);

  // destructor
  //
  ~FermionOnCubicLatticeWithSU4SpinMomentumSpace ();

  // assignement (without duplicating datas)
  //
  // fermions = reference on the hilbert space to copy to copy
  // return value = reference on current hilbert space
  FermionOnCubicLatticeWithSU4SpinMomentumSpace& operator = (const FermionOnCubicLatticeWithSU4SpinMomentumSpace& fermions);
