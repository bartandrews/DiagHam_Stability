...
//            allowing to encode up to 128 orbitals on 64 bits machine        //
//                                                                            //
...
#ifndef BOSONONS2XS2HARDCORENONEARESTNEIGHBORSLONG_H
#define BOSONONS2XS2HARDCORENONEARESTNEIGHBORSLONG_H
...
class BosonOnS2xS2HardcoreNoNearestNeighborsLong : public BosonOnSquareLatticeMomentumSpaceHardcoreLong
{
 ...
 public:
  ...
  // default constructor
  // 
  BosonOnS2xS2HardcoreNoNearestNeighborsLong ();
  ...
  BosonOnS2xS2HardcoreNoNearestNeighborsLong (int nbrBosons, int nbrFluxQuanta1, int nbrFluxQuanta2, int totalLz1, int totalLz2, unsigned long memory = 10000000);

  // copy constructor (without duplicating data)
  //
  // space = reference on the hilbert space to copy
  BosonOnS2xS2HardcoreNoNearestNeighborsLong(const BosonOnS2xS2HardcoreNoNearestNeighborsLong& space);
  ...
  BosonOnS2xS2HardcoreNoNearestNeighborsLong & operator = (const BosonOnS2xS2HardcoreNoNearestNeighborsLong & bosons);
 ...
 protected:
  ...
  // pauliK = number of particles allowed in consecutive orbitals
  // pauliR = number of consecutive orbitals
  virtual ULONGLONG FindCanonical(ULONGLONG state, int xPosition, int yPosition);
...
inline int BosonOnS2xS2HardcoreNoNearestNeighborsLong::GetLinearizedIndex(int lz, int kz)
{
