...
BosonOnCubicLatticeWithSU4SpinMomentumSpace::BosonOnCubicLatticeWithSU4SpinMomentumSpace (int nbrBosons, int nbrSiteX, int nbrSiteY, int nbrSiteZ, int kxMomentum, int kyMomentum, int kzMomentum, unsigned long memory)
{  
...
BosonOnCubicLatticeWithSU4SpinMomentumSpace::BosonOnCubicLatticeWithSU4SpinMomentumSpace(const BosonOnCubicLatticeWithSU4SpinMomentumSpace& bosons)
{
...
BosonOnCubicLatticeWithSU4SpinMomentumSpace::~BosonOnCubicLatticeWithSU4SpinMomentumSpace ()
{
}
...
BosonOnCubicLatticeWithSU4SpinMomentumSpace& BosonOnCubicLatticeWithSU4SpinMomentumSpace::operator = (const BosonOnCubicLatticeWithSU4SpinMomentumSpace& bosons)
{
...
AbstractHilbertSpace* BosonOnCubicLatticeWithSU4SpinMomentumSpace::Clone()
{
  return new BosonOnCubicLatticeWithSU4SpinMomentumSpace(*this);
}
...
ostream& BosonOnCubicLatticeWithSU4SpinMomentumSpace::PrintState (ostream& Str, int state)
{
...
long BosonOnCubicLatticeWithSU4SpinMomentumSpace::GenerateStates(int nbrBosons, int currentKx, int currentKy, int currentKz, 
...
long BosonOnCubicLatticeWithSU4SpinMomentumSpace::EvaluateHilbertSpaceDimension(int nbrBosons, int currentKx, int currentKy, int currentKz,
										int currentTotalKx, int currentTotalKy, int currentTotalKz)
{
  if (currentKz < 0)
    {
