...
#ifndef BOSONONSQUARELATTICEWANNIERSPACE_H
#define BOSONONSQUARELATTICEWANNIERSPACE_H
...
class BosonOnSquareLatticeWannierSpace : public BosonOnSphereShort, public ParticleOnSquareLatticeWannierInterface
{
 ...
 public:
  ...
  // default constructor
  // 
  BosonOnSquareLatticeWannierSpace ();
  ...
  BosonOnSquareLatticeWannierSpace(const BosonOnSquareLatticeWannierSpace& bosons);
  ...
  BosonOnSquareLatticeWannierSpace& operator = (const BosonOnSquareLatticeWannierSpace& bosons);
  ...
  virtual int GetLinearizedMomentum(int index);

  // get total momentum in the linearized momentum index (moduly N_phi)
  // state = index of state to operate on
  virtual int ProjectToTorus(ParticleOnTorus *torusSpace, int state);
  ...
  virtual HermitianMatrix EvaluatePartialDensityMatrixWannierSpace (int subsytemSizeX, int subsytemSizeY, int subsytemStartX, int subsytemStartY, int nbrParticleSector, int kxSector, int kySector, ComplexVector& groundState);
  ...
  virtual long EvaluatePartialDensityMatrixWannierSpaceCore (int minIndex, int nbrIndex, ParticleOnSphere* complementaryHilbertSpace,  ParticleOnSphere* destinationHilbertSpace, ComplexVector& groundState,  HermitianMatrix* densityMatrix);
  ...
  virtual ComplexMatrix EvaluatePartialEntanglementMatrixWannierSpace (int subsytemSizeX, int subsytemSizeY, int nbrParticleSector, int kxSector, int kySector, ComplexVector& groundState);
