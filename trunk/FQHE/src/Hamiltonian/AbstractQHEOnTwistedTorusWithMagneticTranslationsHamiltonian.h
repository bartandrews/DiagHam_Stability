...
#ifndef ABSTRACTQHEONTWISTEDTORUSWITHMAGNETICTRANSLATIONSHAMILTONIAN_H
#define ABSTRACTQHEONTWISTEDTORUSWITHMAGNETICTRANSLATIONSHAMILTONIAN_H
...
class AbstractQHEOnTwistedTorusWithMagneticTranslationsHamiltonian : public AbstractQHEHamiltonian
{
 ...
 protected:
  ...
  // ratio between the lengths of the two fundamental cycles of the torus L1 / L2
  double Ratio;
  // 1 / ratio
  double InvRatio;
  // angle between the two fundamental cycles of the torus, along (L1 sin, L1 cos) and (0, L2)
  double Angle;
 ...
 public:
  ...
  // destructor
  //
  virtual ~AbstractQHEOnTwistedTorusWithMagneticTranslationsHamiltonian() = 0;
