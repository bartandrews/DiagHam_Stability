...
#ifndef ABSTRACTQHEONTORUSWITHSPINANDMAGNETICTRANSLATIONSHAMILTONIANWITHPAIRING_H
#define ABSTRACTQHEONTORUSWITHSPINANDMAGNETICTRANSLATIONSHAMILTONIANWITHPAIRING_H
...
class AbstractQHEOnTorusWithSpinAndMagneticTranslationsHamiltonianWithPairing : public AbstractQHEOnTorusWithSpinAndMagneticTranslationsHamiltonian
{
 ...
 public:
  ...
  // destructor
  //
  virtual ~AbstractQHEOnTorusWithSpinAndMagneticTranslationsHamiltonianWithPairing();
...
inline void AbstractQHEOnTorusWithSpinAndMagneticTranslationsHamiltonianWithPairing::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, ComplexVector& vSource, ComplexVector& vDestination)
{
...
inline void AbstractQHEOnTorusWithSpinAndMagneticTranslationsHamiltonianWithPairing::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, ComplexVector* vSources, 
															   ComplexVector* vDestinations, int nbrVectors, Complex* tmpCoefficients)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void AbstractQHEOnTorusWithSpinAndMagneticTranslationsHamiltonianWithPairing::HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, ComplexVector& vSource, ComplexVector& vDestination)
{
  //int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
  double Coefficient3;
...
inline void AbstractQHEOnTorusWithSpinAndMagneticTranslationsHamiltonianWithPairing::HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, ComplexVector* vSources, 
													       ComplexVector* vDestinations, int nbrVectors, Complex* tmpCoefficients)
{
  //int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void AbstractQHEOnTorusWithSpinAndMagneticTranslationsHamiltonianWithPairing::EvaluateMNTwoBodyFastMultiplicationComponent(ParticleOnSphereWithSpin* particles, int index, 
															 int* indexArray, Complex* coefficientArray, long& position)
{
  int Index;
...
inline void AbstractQHEOnTorusWithSpinAndMagneticTranslationsHamiltonianWithPairing::EvaluateMNTwoBodyFastMultiplicationMemoryComponent(ParticleOnSphereWithSpin* particles, int firstComponent, int lastComponent, long& memory)
{
  int Index;
  double Coefficient = 0.0;
  double Coefficient2 = 0.0;
