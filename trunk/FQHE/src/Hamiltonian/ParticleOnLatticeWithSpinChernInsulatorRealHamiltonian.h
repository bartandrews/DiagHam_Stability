...
#ifndef PARTICLEONLATTICEWITHSPINCHERNINSULATORREALHAMILTONIAN_H
#define PARTICLEONLATTICEWITHSPINCHERNINSULATORREALHAMILTONIAN_H
...
class ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian : public AbstractQHEHamiltonian
{
 ...
 protected:
  ...
  ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian* S2Hamiltonian;
 ...
 public:
  ...
  // default constructor
  //
  ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian();
  ...
  ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian(ParticleOnSphereWithSpin* particles, int nbrParticles, int nbrSiteX, int nbrSiteY, double kineticFactor, double uPotential, double bandParameter, bool flatBandFlag, AbstractArchitecture* architecture, long memory = -1);

  // destructor
  //
  virtual ~ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian();
...
inline void ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, RealVector& vSource, RealVector& vDestination)
{
...
inline void ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, RealVector* vSources, 
												      RealVector* vDestinations, int nbrVectors, double* tmpCoefficients)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian::HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, RealVector& vSource, RealVector& vDestination)
{
  //int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
  double Coefficient3;
...
inline void ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian::HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, RealVector* vSources, 
													       RealVector* vDestinations, int nbrVectors, double* tmpCoefficients)
{
  //int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian::EvaluateMNTwoBodyFastMultiplicationComponent(ParticleOnSphereWithSpin* particles, int index, 
													     int* indexArray, double* coefficientArray, long& position)
{
  int Index;
...
inline void ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian::EvaluateMNOneBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int firstComponent, int lastComponent,
												      int step, RealVector& vSource, RealVector& vDestination)
{
...
inline void ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian::EvaluateMNOneBodyFastMultiplicationComponent(ParticleOnSphereWithSpin* particles, int index, 
													     int* indexArray, double* coefficientArray, long& position)
{
...
inline void ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian::EvaluateMNTwoBodyFastMultiplicationMemoryComponent(ParticleOnSphereWithSpin* particles, int firstComponent, int lastComponent, long& memory)
{
  int Index;
  double Coefficient = 0.0;
  double Coefficient2 = 0.0;
...
inline void ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian::EvaluateMNOneBodyFastMultiplicationMemoryComponent(ParticleOnSphereWithSpin* particles, int firstComponent, int lastComponent, long& memory)
{
  int Index;
  double Coefficient = 0.0;
