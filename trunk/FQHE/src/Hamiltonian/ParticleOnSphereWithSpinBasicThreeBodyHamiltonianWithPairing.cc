...
ParticleOnSphereWithSpinBasicThreeBodyHamiltonianWithPairing::ParticleOnSphereWithSpinBasicThreeBodyHamiltonianWithPairing()
{
}
...
AbstractHamiltonian* ParticleOnSphereWithSpinBasicThreeBodyHamiltonianWithPairing::Clone ()
{
  return 0;
}
...
void ParticleOnSphereWithSpinBasicThreeBodyHamiltonianWithPairing::EvaluatePairingInteractionFactors()
{
...
double* ParticleOnSphereWithSpinBasicThreeBodyHamiltonianWithPairing::ComputeProjectorCoefficients(int relativeMomentum, int degeneracyIndex, int* indices, int nbrIndexSets, int maxJValue, int spinIndex)
{
