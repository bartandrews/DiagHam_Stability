...
#ifndef ABSTRACTQHEONSPHEREFULLHAMILTONIAN_H
#define ABSTRACTQHEONSPHEREFULLHAMILTONIAN_H
...
class AbstractQHEOnSphereFullHamiltonian : public AbstractQHEHamiltonian
{
 ...
 public:
  ...
  // default constructor
  //
  AbstractQHEOnSphereFullHamiltonian();
 ...
 protected:
  ...
  // nbrVectors = number of vectors that have to be evaluated together
  // tmpCoefficients = a temporary array whose size is nbrVectors
  virtual void HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphere* particles, int index, RealVector* vSources, 
							      RealVector* vDestinations, int nbrVectors, double* tmpCoefficients);
...
inline void AbstractQHEOnSphereFullHamiltonian::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphere* particles, int index, RealVector& vSource, RealVector& vDestination)
{
...
inline void AbstractQHEOnSphereFullHamiltonian::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphere* particles, int index, RealVector* vSources, 
													      RealVector* vDestinations, int nbrVectors, double* tmpCoefficients)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void AbstractQHEOnSphereFullHamiltonian::HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphere* particles, int index, RealVector& vSource, RealVector& vDestination)
{
  double Coefficient;
  double Coefficient3;
  double Coefficient4;
...
inline void AbstractQHEOnSphereFullHamiltonian::EvaluateMNTwoBodyFastMultiplicationMemoryComponent(ParticleOnSphere* particles, int firstComponent, int lastComponent, long& memory)
{
  int Index;
  double Coefficient = 0.0;
  double Coefficient2 = 0.0;
