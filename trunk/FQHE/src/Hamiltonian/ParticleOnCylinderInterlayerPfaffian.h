...
#ifndef PARTICLEONCYLINDERINTERLAYERPFAFFIAN_H
#define PARTICLEONCYLINDERINTERLAYERPFAFFIAN_H
...
class ParticleOnCylinderInterlayerPfaffian : public AbstractQHEOnCylinderThreeBodyHamiltonian
{
 ...
 public:
  ...
  ParticleOnCylinderInterlayerPfaffian(ParticleOnSphereWithSpin* particles, int nbrParticles, int maxMomentum, double ratio, AbstractArchitecture* architecture, long memory = -1, char* precalculationFileName = 0);

  // destructor
  //
  ~ParticleOnCylinderInterlayerPfaffian();
