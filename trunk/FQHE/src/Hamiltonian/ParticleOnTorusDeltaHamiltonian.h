...
#ifndef PARTICLEONTORUSDELTAHAMILTONIAN_H
#define PARTICLEONTORUSDELTAHAMILTONIAN_H
...
class ParticleOnTorusDeltaHamiltonian : public ParticleOnTorusGenericHamiltonian
{
 ...
 public:
  // length of system in x and y directions
  int Lx,Ly;
  ...
  ParticleOnTorusDeltaHamiltonian(ParticleOnTorus* particles, int nbrParticles, int maxMomentum, double ratio, double angle, int level,
 ...
 protected:
  ...
  double EvaluateInteractionCoefficientWithMixing(int m1,int m2,int m3, int m4);
