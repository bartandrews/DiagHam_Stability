...
ParticleOnThinAnnulusGenericHamiltonian::ParticleOnThinAnnulusGenericHamiltonian(ParticleOnSphere* particles, int nbrParticles, int lzMax, double* pseudoPotential,
...
ParticleOnThinAnnulusGenericHamiltonian::ParticleOnThinAnnulusGenericHamiltonian(ParticleOnSphere* particles, int nbrParticles, int lzMax, double* pseudoPotential, double* oneBodyPotentials, int mMax, 
								   AbstractArchitecture* architecture, long memory,
								   bool onDiskCacheFlag, char* precalculationFileName)
{
  this->Particles = particles;
...
ParticleOnThinAnnulusGenericHamiltonian::~ParticleOnThinAnnulusGenericHamiltonian() 
{
...
void ParticleOnThinAnnulusGenericHamiltonian::EvaluateInteractionFactors()
{
  int Lim;
  int Min;
  int Pos = 0;
  ...
  ClebschGordanThinAnnulusCoefficients CGCoefficients(this->LzMax);
