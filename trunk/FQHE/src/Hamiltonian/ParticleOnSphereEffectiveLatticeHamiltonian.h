...
#ifndef PARTICLEONSPHEREEFFECTIVELATTICEHAMILTONIAN_H
#define PARTICLEONSPHEREEFFECTIVELATTICEHAMILTONIAN_H
...
class ParticleOnSphereEffectiveLatticeHamiltonian : public AbstractQHEOnSphereQuantumWellHamiltonian
{
 ...
 protected:
  ...
  // flag indicating whether additional pseudopotentials are present
  bool HaveOtherMixed;
 ...
 public:
  ...
  ParticleOnSphereEffectiveLatticeHamiltonian(ParticleOnSphereWithSpin* particles, int nbrParticles, int lzmax, double alpha,
  ...
  // destructor
  //
  ~ParticleOnSphereEffectiveLatticeHamiltonian();
