...
#ifndef PARTICLEONSPHEREWITHSU3SPINL2HAMILTONIAN_H
#define PARTICLEONSPHEREWITHSU3SPINL2HAMILTONIAN_H
...
class ParticleOnSphereWithSU3SpinL2Hamiltonian : public AbstractQHEOnSphereWithSU3SpinHamiltonian
{
 ...
 public:
  ...
  ParticleOnSphereWithSU3SpinL2Hamiltonian(ParticleOnSphereWithSU3Spin* particles, int nbrParticles, int lzmax, int totalLz,
  ...
  // destructor
  //
  ~ParticleOnSphereWithSU3SpinL2Hamiltonian();
