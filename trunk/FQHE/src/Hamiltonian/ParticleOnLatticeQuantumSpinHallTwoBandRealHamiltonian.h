...
#ifndef PARTICLEONLATTICEQUANTUMSPINHALLTWOBANDREALHAMILTONIAN_H
#define PARTICLEONLATTICEQUANTUMSPINHALLTWOBANDREALHAMILTONIAN_H
...
class ParticleOnLatticeQuantumSpinHallTwoBandRealHamiltonian : public ParticleOnLatticeWithSpinChernInsulatorRealHamiltonian
{
 ...
 public:
  ...
  // default constructor
  //
  ParticleOnLatticeQuantumSpinHallTwoBandRealHamiltonian();
  ...
  ParticleOnLatticeQuantumSpinHallTwoBandRealHamiltonian(ParticleOnSphereWithSpin* particles, int nbrParticles, int nbrSiteX, int nbrSiteY, double bandParameter, double szSymmetryBreaking, AbstractArchitecture* architecture, long memory = -1);
 ...
 protected:
  ...
  double ComputeBasisContribution(RealMatrix* basisMatrices, int momentumIndex1, int momentumIndex2, int bandIndex1, int bandIndex2);
...
inline void ParticleOnLatticeQuantumSpinHallTwoBandRealHamiltonian::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, RealVector& vSource, RealVector& vDestination)
{
...
inline void ParticleOnLatticeQuantumSpinHallTwoBandRealHamiltonian::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, RealVector* vSources, 
												      RealVector* vDestinations, int nbrVectors, double* tmpCoefficients)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void ParticleOnLatticeQuantumSpinHallTwoBandRealHamiltonian::HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, RealVector& vSource, RealVector& vDestination)
{
  //int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
  double Coefficient3;
...
inline void ParticleOnLatticeQuantumSpinHallTwoBandRealHamiltonian::HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, RealVector* vSources, 
													       RealVector* vDestinations, int nbrVectors, double* tmpCoefficients)
{
  //int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void ParticleOnLatticeQuantumSpinHallTwoBandRealHamiltonian::EvaluateMNTwoBodyFastMultiplicationComponent(ParticleOnSphereWithSpin* particles, int index, 
													     int* indexArray, double* coefficientArray, long& position)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void ParticleOnLatticeQuantumSpinHallTwoBandRealHamiltonian::EvaluateMNTwoBodyFastMultiplicationMemoryComponent(ParticleOnSphereWithSpin* particles, int firstComponent, int lastComponent, long& memory)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
  double Coefficient3;
