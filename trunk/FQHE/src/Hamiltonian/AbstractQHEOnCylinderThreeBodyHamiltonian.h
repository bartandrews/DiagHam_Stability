...
#ifndef ABSTRACTQHEONCYLINDERTHREEBODYHAMILTONIAN_H
#define ABSTRACTQHEONCYLINDERTHREEBODYHAMILTONIAN_H
...
class AbstractQHEOnCylinderThreeBodyHamiltonian : public AbstractQHEHamiltonian
{
 ...
 public:
  ...
  // default constructor
  //
  AbstractQHEOnCylinderThreeBodyHamiltonian();

  // destructor
  //
  virtual ~AbstractQHEOnCylinderThreeBodyHamiltonian() = 0;
