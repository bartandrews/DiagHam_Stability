...
#ifndef PARTICLEONCYLINDERXCYLINDERDELTAHAMILTONIAN_H
#define PARTICLEONCYLINDERXCYLINDERDELTAHAMILTONIAN_H
...
class ParticleOnCylinderxCylinderDeltaHamiltonian : public ParticleOnS2xS2DeltaHamiltonian
{
 ...
 public:
  ...
  // default constructor
  //
  ParticleOnCylinderxCylinderDeltaHamiltonian();
  ...
  ParticleOnCylinderxCylinderDeltaHamiltonian(ParticleOnSphere* particles, int nbrParticles, int nbrFluxQuanta1, int nbrFluxQuanta2, double ratio1, double ratio2,
