...
//                   to particles on a torus with SU(3) spin                  //
//                                                                            //
...
#ifndef ABSTRACTQHEONTORUSWITHSU3SPINHAMILTONIAN_H
#define ABSTRACTQHEONTORUSWITHSU3SPINHAMILTONIAN_H
...
class AbstractQHEOnTorusWithSU3SpinHamiltonian : public AbstractQHEOnSphereWithSU3SpinHamiltonian
{
 ...
 public:
  ...
  // destructor
  //
  virtual ~AbstractQHEOnTorusWithSU3SpinHamiltonian() = 0;
