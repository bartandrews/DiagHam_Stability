...
#ifndef PARTICLEONSPHEREWITHSPINCREATIONOPERATOR_H
#define PARTICLEONSPHEREWITHSPINCREATIONOPERATOR_H
...
class ParticleOnSphereWithSpinCreationOperator : public AbstractOperator
{
 ...
 protected:
  ...
  // index of the creation operator
  int OperatorIndex;
 ...
 public:
  ...
  ParticleOnSphereWithSpinCreationOperator(ParticleOnSphereWithSpinCreationOperator& oper);

  // destructor
  //
  ~ParticleOnSphereWithSpinCreationOperator();
