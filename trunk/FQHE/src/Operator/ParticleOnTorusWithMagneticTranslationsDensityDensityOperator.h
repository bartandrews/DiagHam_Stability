...
#ifndef PARTICLEONTORUSWITHMAGNETICTRANSLATIONSDENSITYDENSITYOPERATOR_H
#define PARTICLEONTORUSWITHMAGNETICTRANSLATIONSDENSITYDENSITYOPERATOR_H
...
class ParticleOnTorusWithMagneticTranslationsDensityDensityOperator : public  AbstractOperator
{
 ...
 protected:
  ...
  int CreationIndex1;
  // index of the second creation operator
  int CreationIndex2;
  // index of the first annihilation operator
  int AnnihilationIndex1;
  // index of the second annihilation operator
 ...
 public:
  ...
  ParticleOnTorusWithMagneticTranslationsDensityDensityOperator(ParticleOnTorusWithMagneticTranslations* particlee, 
								int m1, int m2, int n1, int n2);
  

  // copy constructor
  //
  ParticleOnTorusWithMagneticTranslationsDensityDensityOperator(ParticleOnTorusWithMagneticTranslationsDensityDensityOperator& oper);

  // destructor
  //
  ~ParticleOnTorusWithMagneticTranslationsDensityDensityOperator();
