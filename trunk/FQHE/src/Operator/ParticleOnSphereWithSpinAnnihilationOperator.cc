...
ParticleOnSphereWithSpinAnnihilationOperator::ParticleOnSphereWithSpinAnnihilationOperator(ParticleOnSphereWithSpinAnnihilationOperator& oper)
{
...
ParticleOnSphereWithSpinAnnihilationOperator::~ParticleOnSphereWithSpinAnnihilationOperator()
{
...
AbstractOperator* ParticleOnSphereWithSpinAnnihilationOperator::Clone ()
{
  return new ParticleOnSphereWithSpinAnnihilationOperator(*this);
}
...
void ParticleOnSphereWithSpinAnnihilationOperator::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
...
AbstractHilbertSpace* ParticleOnSphereWithSpinAnnihilationOperator::GetHilbertSpace ()
{
...
int ParticleOnSphereWithSpinAnnihilationOperator::GetHilbertSpaceDimension ()
{
...
Complex ParticleOnSphereWithSpinAnnihilationOperator::PartialMatrixElement (RealVector& V1, RealVector& V2, long firstComponent, long nbrComponent)
{
  double Element = 0.0;
...
RealVector& ParticleOnSphereWithSpinAnnihilationOperator::LowLevelAddMultiply(RealVector& vSource, RealVector& vDestination, 
...
RealVector* ParticleOnSphereWithSpinAnnihilationOperator::LowLevelMultipleAddMultiply(RealVector* vSources, RealVector* vDestinations, int nbrVectors, 
									      int firstComponent, int nbrComponent)
{
  int Last = firstComponent + nbrComponent;;
  double TmpCoefficient = 0.0;
...
Complex ParticleOnSphereWithSpinAnnihilationOperator::PartialMatrixElement (ComplexVector& V1, ComplexVector& V2, long firstComponent, long nbrComponent)
{
  Complex Element = 0.0;
  int Dim = firstComponent + nbrComponent;
  double TmpCoefficient = 0.0;
...
ComplexVector* ParticleOnSphereWithSpinAnnihilationOperator::LowLevelMultipleAddMultiply(ComplexVector* vSources, ComplexVector* vDestinations, int nbrVectors, 
										 int firstComponent, int nbrComponent)
{
  int Last = firstComponent + nbrComponent;;
  double TmpCoefficient = 0.0;
