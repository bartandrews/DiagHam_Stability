...
ParticleOnSphereWithSpinLMinusOperator::ParticleOnSphereWithSpinLMinusOperator(ParticleOnSphereWithSpin* particle,
...
ParticleOnSphereWithSpinLMinusOperator::ParticleOnSphereWithSpinLMinusOperator(const ParticleOnSphereWithSpinLMinusOperator& oper)
{
...
ParticleOnSphereWithSpinLMinusOperator::~ParticleOnSphereWithSpinLMinusOperator()
{
...
AbstractOperator* ParticleOnSphereWithSpinLMinusOperator::Clone ()
{
  return new ParticleOnSphereWithSpinLMinusOperator(*this);
}
...
void ParticleOnSphereWithSpinLMinusOperator::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
...
AbstractHilbertSpace* ParticleOnSphereWithSpinLMinusOperator::GetHilbertSpace ()
{
...
int ParticleOnSphereWithSpinLMinusOperator::GetHilbertSpaceDimension ()
{
...
RealVector& ParticleOnSphereWithSpinLMinusOperator::LowLevelAddMultiply(RealVector& vSource, RealVector& vDestination, 
