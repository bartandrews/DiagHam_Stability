...
class TightBindingModelHofstadterSquare : public Abstract2DTightBindingModel
{
 ...
 public:
  ...
  TightBindingModelHofstadterSquare(int nbrCellX, int nbrCellY, int unitCellX, int unitCellY, int nbrFlux, char axis,
  									double gammaX, double gammaY, AbstractArchitecture* architecture,
  									bool storeOneBodyMatrices = true, bool useEmbedding = false, double ttwo=0.0,
  									double tthree=0.0, double alpha=1.0);
...
//  TightBindingModelHofstadterSquare(int nbrCellX, int nbrCellY, int unitCellX, int unitCellY, int nbrFlux, double muS,
//  									int fullUnitCellX, double t1, double t2, char axis, double gammaX, double gammaY,
//				    				AbstractArchitecture* architecture, bool storeOneBodyMatrices = true,
//				    				bool useEmbedding = false, int precision = 64);
