...
TightBindingModelDiceLattice::TightBindingModelDiceLattice(int nbrSiteX, int nbrSiteY, double t1, double t2, double lambda1, double lambda2, double mus, 
...
TightBindingModelDiceLattice::TightBindingModelDiceLattice(int nbrSiteX, int nbrSiteY, int nx1, int ny1, int nx2, int ny2, int offset, double t1, double t2, double lambda1, double lambda2, double mus, 
...
TightBindingModelDiceLattice::~TightBindingModelDiceLattice()
{
}
...
void TightBindingModelDiceLattice::CoreComputeBandStructure(long minStateIndex, long nbrStates)
{
...
HermitianMatrix TightBindingModelDiceLattice::ComputeBlochHamiltonian(double kx, double ky)
{
...
int TightBindingModelDiceLattice::GetHighSymmetryPoints(char**& pointNames, double**& pointCoordinates)
{
...
double TightBindingModelDiceLattice::GetDistanceReciprocalSpace(double kx1, double ky1, double& kx2, double& ky2)
{
...
void TightBindingModelDiceLattice::FindConnectedOrbitals()
{
