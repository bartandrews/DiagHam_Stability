...
// class TightBindingInteraction2DShortRange
// {
//  protected:
...
// constructor
TightBindingInteraction2DShortRange::TightBindingInteraction2DShortRange(Abstract2DTightBindingModel *tightBinding, InteractionType interaction, int nbrImages)
{

}
  
// default destructor
TightBindingInteraction2DShortRange::~TightBindingInteraction2DShortRange()
{
}
...
double TightBindingInteraction2DShortRange::SumToConvergence(int s, int dR1, int dR2, int s2, int nbrImages)
{
