...
#ifndef PARTICLEONLATTICEREALSPACEAND1DTRANSLATIONONEBODYOPERATOR_H
#define PARTICLEONLATTICEREALSPACEAND1DTRANSLATIONONEBODYOPERATOR_H
...
class ParticleOnLatticeRealSpaceAnd1DTranslationOneBodyOperator : public AbstractOperator
{

 protected:

  // hilbert space associated to the particles
  FermionOnLatticeRealSpaceAnd1DTranslation * Particle;
 ...
 public:
  ...
  ParticleOnLatticeRealSpaceAnd1DTranslationOneBodyOperator(FermionOnLatticeRealSpaceAnd1DTranslation * particle, int creationIndex=0,int annihilationIndex=0);

  // copy constructor
  //
  // oper = reference on the operator to copy
  ParticleOnLatticeRealSpaceAnd1DTranslationOneBodyOperator(const  ParticleOnLatticeRealSpaceAnd1DTranslationOneBodyOperator & oper);

  // destructor
  //
  ~ParticleOnLatticeRealSpaceAnd1DTranslationOneBodyOperator();
