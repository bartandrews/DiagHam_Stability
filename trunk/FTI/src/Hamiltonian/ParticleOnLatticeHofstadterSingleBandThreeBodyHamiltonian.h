...
#ifndef PARTICLEONLATTICEHOFSTADTERSINGLEBANDNBODYHAMILTONIAN_H
#define PARTICLEONLATTICEHOFSTADTERSINGLEBANDNBODYHAMILTONIAN_H
...
class ParticleOnLatticeHofstadterSingleBandThreeBodyHamiltonian : public ParticleOnLatticeChernInsulatorSingleBandNBodyHamiltonian
{
 ...
 public:
  ...
  ParticleOnLatticeHofstadterSingleBandThreeBodyHamiltonian(ParticleOnSphere* particles, int nbrParticles, int nbrCellsX, int nbrCellsY, int bandIndex,
                                                   double uPotential, double vPotential, double wPotential, double threeBodyPotential,
...
inline Complex ParticleOnLatticeHofstadterSingleBandThreeBodyHamiltonian::ComputeTransfomationBasisContribution(ComplexMatrix* oneBodyBasis,
												       int momentumIndex1, int momentumIndex2, int momentumIndex3, int momentumIndex4, 
												       int energyIndex1, int energyIndex2, int energyIndex3, int energyIndex4,
												       int siteIndex1, int siteIndex2, int siteIndex3, int siteIndex4)
{
...
inline int ParticleOnLatticeHofstadterSingleBandThreeBodyHamiltonian::getXMomentumFromIndex(int index)
{
  
  return (int) index / this->NbrSiteY;
}

inline int ParticleOnLatticeHofstadterSingleBandThreeBodyHamiltonian::getYMomentumFromIndex(int index)
{
