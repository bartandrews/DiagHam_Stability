...
#ifndef PARTICLEONLATTICEWITHSPINKAGOMELATTICETWOBANDHAMILTONIAN_H
#define PARTICLEONLATTICEWITHSPINKAGOMELATTICETWOBANDHAMILTONIAN_H
...
class ParticleOnLatticeKagomeLatticeTwoBandHamiltonian : public ParticleOnLatticeQuantumSpinHallTwoBandHamiltonian
{
 ...
 public:
  ...
  ParticleOnLatticeKagomeLatticeTwoBandHamiltonian(ParticleOnSphereWithSpin* particles, int nbrParticles, int nbrSiteX, int nbrSiteY, double uPotential, double t1, double t2, double lambda1, double lambda2, double mus, double gammaX, double gammaY, bool flatBandFlag, AbstractArchitecture* architecture, long memory = -1);

  // destructor
  //
  ~ParticleOnLatticeKagomeLatticeTwoBandHamiltonian();
