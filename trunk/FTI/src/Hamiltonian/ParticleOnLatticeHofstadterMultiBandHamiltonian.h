...
#ifndef PARTICLEONLATTICEHOFSTADTERMULTIBANDHAMILTONIAN_H
#define PARTICLEONLATTICEHOFSTADTERMULTIANDHAMILTONIAN_H
...
class ParticleOnLatticeHofstadterMultiBandHamiltonian : public ParticleOnLatticeChernInsulatorSingleBandHamiltonian
{
...
inline Complex ParticleOnLatticeHofstadterMultiBandHamiltonian::ComputeTransfomationBasisContribution(ComplexMatrix* oneBodyBasis,
												       int momentumIndex1, int momentumIndex2, int momentumIndex3, int momentumIndex4, 
												       int energyIndex1, int energyIndex2, int energyIndex3, int energyIndex4,
												       int siteIndex1, int siteIndex2, int siteIndex3, int siteIndex4)
{
...
inline int ParticleOnLatticeHofstadterMultiBandHamiltonian::getXMomentumFromIndex(int index)
{
  int tmp = index;
  return (int) tmp / this->NbrSiteY;
}

inline int ParticleOnLatticeHofstadterMultiBandHamiltonian::getYMomentumFromIndex(int index)
{
  int tmp = index;
  return (int) tmp % this->NbrSiteY;
}
