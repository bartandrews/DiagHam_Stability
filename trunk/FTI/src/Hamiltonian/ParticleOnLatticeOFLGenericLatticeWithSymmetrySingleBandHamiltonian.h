...
#ifndef PARTICLEONLATTICEOFLGENERICLATTICEWITHSYMMETRYSINGLEBANDHAMILTONIAN_H
#define PARTICLEONLATTICEOFLGENERICLATTICEWITHSYMMETRYSINGLEBANDHAMILTONIAN_H
...
class ParticleOnLatticeOFLGenericLatticeWithSymmetrySingleBandHamiltonian : public 
...
public:
  ...
  ParticleOnLatticeOFLGenericLatticeWithSymmetrySingleBandHamiltonian(ParticleOnSphere* particles, int nbrParticles, TightBindingModelOFLGenericLatticeWithSymmetry* tightBindingModel, double uPotential, bool flatBandFlag, bool noDispersionFlag, AbstractArchitecture* architecture, long memory = -1);
