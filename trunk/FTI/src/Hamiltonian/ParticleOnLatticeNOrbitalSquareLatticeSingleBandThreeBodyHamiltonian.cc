...
// constructor
//
ParticleOnLatticeNOrbitalSquareLatticeSingleBandThreeBodyHamiltonian::ParticleOnLatticeNOrbitalSquareLatticeSingleBandThreeBodyHamiltonian ()
{
  this->BandIndex = 0;
}
...
ParticleOnLatticeNOrbitalSquareLatticeSingleBandThreeBodyHamiltonian ::ParticleOnLatticeNOrbitalSquareLatticeSingleBandThreeBodyHamiltonian (ParticleOnSphere* particles, int nbrParticles, int nbrCellX, int nbrCellY, 
...
void ParticleOnLatticeNOrbitalSquareLatticeSingleBandThreeBodyHamiltonian ::EvaluateInteractionFactors()
{
