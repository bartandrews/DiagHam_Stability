...
ParticleOnLatticeAlternativeKagomeLatticeLLLInterpolateSingleBandHamiltonian::ParticleOnLatticeAlternativeKagomeLatticeLLLInterpolateSingleBandHamiltonian(ParticleOnSphere* particles, int nbrParticles, int nbrSiteX, int nbrSiteY,
        Abstract2DTightBindingModel* tightBindingModel, double uPotential, double vPotential, int bandIndex, bool flatBandFlag,
...
ParticleOnLatticeAlternativeKagomeLatticeLLLInterpolateSingleBandHamiltonian::~ParticleOnLatticeAlternativeKagomeLatticeLLLInterpolateSingleBandHamiltonian()
{
}
