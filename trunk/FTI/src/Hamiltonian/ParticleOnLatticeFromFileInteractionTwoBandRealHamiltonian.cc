...
ParticleOnLatticeFromFileInteractionTwoBandRealHamiltonian::ParticleOnLatticeFromFileInteractionTwoBandRealHamiltonian()
{
}
...
void ParticleOnLatticeFromFileInteractionTwoBandRealHamiltonian::EvaluateInteractionFactors()
{
