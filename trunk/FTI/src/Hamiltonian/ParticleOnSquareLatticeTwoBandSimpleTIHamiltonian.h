...
class ParticleOnSquareLatticeTwoBandSimpleTIHamiltonian : public ParticleOnLatticeQuantumSpinHallTwoBandHamiltonian
{
 ...
 public:
  ...
  ParticleOnSquareLatticeTwoBandSimpleTIHamiltonian(ParticleOnSphereWithSpin* particles, int nbrParticles, int nbrSiteX, int nbrSiteY, double uPotential, double vPotential, double mass, 
...
inline Complex ParticleOnSquareLatticeTwoBandSimpleTIHamiltonian::ComputeTransfomationBasisContribution(ComplexMatrix* oneBodyBasis,
													int momentumIndex1, int momentumIndex2, int momentumIndex3, int momentumIndex4, 
													int energyIndex1, int energyIndex2, int energyIndex3, int energyIndex4,
													int siteIndex1, int siteIndex2, int siteIndex3, int siteIndex4)
{
