...
#ifndef PARTICLEONLATTICEPYROCHLORESLABLATTICESINGLEBANDFOURBODYHAMILTONIAN_H
#define PARTICLEONLATTICEPYROCHLORESLABLATTICESINGLEBANDFOURBODYHAMILTONIAN_H
...
class ParticleOnLatticePyrochloreSlabLatticeSingleBandFourBodyHamiltonian : public ParticleOnLatticeChernInsulatorSingleBandNBodyHamiltonian
{
 ...
 public:
  ...
  // constructor
  //
  ParticleOnLatticePyrochloreSlabLatticeSingleBandFourBodyHamiltonian();
  ...
  ParticleOnLatticePyrochloreSlabLatticeSingleBandFourBodyHamiltonian(ParticleOnSphere* particles, int nbrParticles, 
