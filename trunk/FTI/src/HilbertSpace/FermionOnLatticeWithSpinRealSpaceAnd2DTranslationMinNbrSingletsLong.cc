...
FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong ()
{
  this->NbrFermions = 0;
...
FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong (int nbrFermions, int minNbrSinglets, 
...
FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong (int nbrFermions, int minNbrSinglets, int totalSpin, 
																  int nbrSite, int xMomentum, int maxXMomentum,
																  int yMomentum, int  maxYMomentum, unsigned long memory)
{  
  this->NbrFermions = nbrFermions;
...
FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong(const FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong & fermions)
{
...
FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong & FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::operator = (const FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong& fermions)
{
...
AbstractHilbertSpace* FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::Clone()
{
  return new FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong(*this);
}
...
long FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::GenerateStates()
{
...
long FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::RawGenerateStates(int nbrFermions, int currentSite, int nbrSinglets, long pos)
{
  if (nbrFermions == 0)
    {
...
long FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::RawGenerateStates(int nbrFermions, int currentSite, int nbrSpinUp, int nbrSinglets, long pos)
{
...
long FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::EvaluateHilbertSpaceDimension(int nbrFermions, int currentSite, int nbrSinglets)
{
  if (nbrFermions == 0)
    {
      if (nbrSinglets >= this->MinNbrSinglets)
...
long FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSingletsLong::EvaluateHilbertSpaceDimension(int nbrFermions, int currentSite, int nbrSpinUp, int nbrSinglets)
{
  if ((nbrFermions == 0) && (nbrSpinUp == 0))
    {
      if (nbrSinglets >= this->MinNbrSinglets)
