...
#ifndef SPIN3_2CHAINSZSYMMETRYAND2DTRANSLATION_H
#define SPIN3_2CHAINSZSYMMETRYAND2DTRANSLATION_H
...
class Spin3_2ChainSzSymmetryAnd2DTranslation : public Spin3_2ChainAnd2DTranslation
{
 ...
 public:
  ...
  // default constructor
  //
  Spin3_2ChainSzSymmetryAnd2DTranslation ();
  ...
  Spin3_2ChainSzSymmetryAnd2DTranslation (int nbrSite, int sz, int szSymmetrySector, int xMomentum, int maxXMomentum, int yMomentum, int maxYMomentum, unsigned long memory = 10000000);
  
  // constructor from a binary file that describes the Hilbert space
  //
  // fileName = name of the binary file
  // memory = amount of memory granted for precalculations
  Spin3_2ChainSzSymmetryAnd2DTranslation (char* fileName, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  Spin3_2ChainSzSymmetryAnd2DTranslation (const Spin3_2ChainSzSymmetryAnd2DTranslation& chain);
  ...
  Spin3_2ChainSzSymmetryAnd2DTranslation& operator = (const Spin3_2ChainSzSymmetryAnd2DTranslation& chain);
...
inline int Spin3_2ChainSzSymmetryAnd2DTranslation::SymmetrizeResult(unsigned long& state, int nbrStateInOrbit, double& coefficient, 
...
inline unsigned long Spin3_2ChainSzSymmetryAnd2DTranslation::FindCanonicalForm(unsigned long stateDescription, int& nbrTranslationX, int& nbrTranslationY, double& inversionSign)
{
...
inline bool Spin3_2ChainSzSymmetryAnd2DTranslation::TestMomentumConstraint(unsigned long stateDescription)
{
...
inline int Spin3_2ChainSzSymmetryAnd2DTranslation::FindOrbitSize(unsigned long stateDescription)
{
  unsigned long TmpStateDescription = stateDescription;
  unsigned long TmpStateDescription2 = stateDescription;
  int XSize = 1;
...
inline void Spin3_2ChainSzSymmetryAnd2DTranslation::ApplySzSymmetry(unsigned long& stateDescription)
{
  stateDescription = (~stateDescription) & (this->SzSymmetryMask);
}


inline int Spin3_2ChainSzSymmetryAnd2DTranslation::GetNbrStateinOrbit (int i)
{
