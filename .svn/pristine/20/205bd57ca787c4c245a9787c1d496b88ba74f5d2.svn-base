...
ParticleOnSphereWithSpinLPlusUpOperator::ParticleOnSphereWithSpinLPlusUpOperator(ParticleOnSphereWithSpin* particle,
...
ParticleOnSphereWithSpinLPlusUpOperator::ParticleOnSphereWithSpinLPlusUpOperator(const ParticleOnSphereWithSpinLPlusUpOperator& oper)
{
...
ParticleOnSphereWithSpinLPlusUpOperator::~ParticleOnSphereWithSpinLPlusUpOperator()
{
...
AbstractOperator* ParticleOnSphereWithSpinLPlusUpOperator::Clone ()
{
  return new ParticleOnSphereWithSpinLPlusUpOperator(*this);
}
...
void ParticleOnSphereWithSpinLPlusUpOperator::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
...
AbstractHilbertSpace* ParticleOnSphereWithSpinLPlusUpOperator::GetHilbertSpace ()
{
...
int ParticleOnSphereWithSpinLPlusUpOperator::GetHilbertSpaceDimension ()
{
...
Complex ParticleOnSphereWithSpinLPlusUpOperator::PartialMatrixElement (RealVector& V1, RealVector& V2, long firstComponent, long nbrComponent)
{
