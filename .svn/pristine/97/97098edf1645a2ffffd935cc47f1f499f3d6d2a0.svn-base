...
#ifndef SPINWITH2DTRANSLATIONBONDBONDCORRELATIONOPERATOR_H
#define SPINWITH2DTRANSLATIONBONDBONDCORRELATIONOPERATOR_H
...
class SpinWith2DTranslationBondBondCorrelationOperator : public AbstractOperator
{
 ...
 public:
  ...
  SpinWith2DTranslationBondBondCorrelationOperator(AbstractSpinChain* chain, int xMomentum, int nbrSpinX, int yMomentum, int nbrSpinY, int siteIndex1, int siteIndex2, int siteIndex3, int siteIndex4);

  // destructor
  //
  ~SpinWith2DTranslationBondBondCorrelationOperator();
