...
#ifndef PARTICLEONLATTICEHALDANEMODELSINGLEBANDTHREEBODYHAMILTONIANWANNIER_H
#define PARTICLEONLATTICEHALDANEMODELSINGLEBANDTHREEBODYHAMILTONIANWANNIER_H
...
class ParticleOnLatticeHaldaneModelSingleBandThreeBodyHamiltonianWannier : public ParticleOnLatticeChernInsulatorSingleBandNBodyHamiltonian
{
 ...
 public:
  ...
  // default constructor
  //
  ParticleOnLatticeHaldaneModelSingleBandThreeBodyHamiltonianWannier();
