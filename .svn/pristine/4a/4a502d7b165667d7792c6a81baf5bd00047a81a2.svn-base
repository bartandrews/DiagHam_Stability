...
#ifndef OPENDIAMONDSPINCHAINHAMILTONIAN_H
#define OPENDIAMONDSPINCHAINHAMILTONIAN_H
...
class OpenDiamondSpinChainHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  OpenDiamondSpinChainHamiltonian(AbstractSpinChain* chain, int nbrDiamond, double j1, double j2, double j3);

  // destructor
  //
  ~OpenDiamondSpinChainHamiltonian();

  // set chain
  // 
  // chain = pointer on Hilbert space of the associated system
  // return value = reference on current Hamiltonian
  OpenDiamondSpinChainHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, OpenDiamondSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, OpenDiamondSpinChainHamiltonian& H);
