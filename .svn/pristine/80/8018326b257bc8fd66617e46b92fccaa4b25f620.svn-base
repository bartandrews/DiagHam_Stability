...
#ifndef SPIN1_2CHAINLONG_H
#define SPIN1_2CHAINLONG_H
...
class Spin1_2ChainLong : public AbstractSpinChain
{

  friend class Spin1_2ChainWithTranslationsAndSzSymmetryLong;
  friend class Spin1_2ChainWithTranslationsAndInversionSymmetryLong;
  friend class Spin1_2ChainWithTranslationsLong;
 ...
 public:
  ...
  Spin1_2ChainLong (int chainLength, int sz, int memorySize);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  Spin1_2ChainLong (const Spin1_2ChainLong& chain);
  ...
  Spin1_2ChainLong& operator = (const Spin1_2ChainLong& chain);
...
#ifdef __64_BITS__
  virtual void GenerateLookUpTable(unsigned long memory, ULONGLONG stateMask = 0xfffffffffffffffful);
#else
  virtual void GenerateLookUpTable(unsigned long memory, ULONGLONG stateMask = 0xfffffffful);
#endif
...
inline int Spin1_2ChainLong::GetLocalSpin(int site)
{
  return 1;
}
