...
int main(int argc, char** argv)
{
  ...
  OptionManager Manager ("FQHECylinderFermionsHaldaneRezayi" , "0.01");
  ...
  (*SystemGroup) += new  SingleStringOption ('\n', "interaction-name", "interaction name (as it should appear in output files)", "hr");
  ...
  for (; Ky <= Max; Ky+=2 )
...
#endif
		  {
		    Space = new FermionOnSphereWithSpin(NbrParticles, Ky, MaxMomentum, SzTotal, Memory);
		  }
	...
	Memory = Architecture.GetArchitecture()->GetLocalMemory();
      ...
      AbstractQHEHamiltonian* Hamiltonian = new ParticleOnCylinderHaldaneRezayi (Space, NbrParticles, MaxMomentum, XRatio, Architecture.GetArchitecture(), Memory);
