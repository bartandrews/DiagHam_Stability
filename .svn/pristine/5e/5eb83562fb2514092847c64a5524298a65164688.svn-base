...
#ifndef REALLOWERTRIANGULARMATRIX_H
#define REALLOWERTRIANGULARMATRIX_H
...
class RealLowerTriangularMatrix : public Matrix
{
 ...
 public:
  ...
  RealLowerTriangularMatrix(int dimension, bool zero = false);
  ...
  // dimension = matrix dimension
  RealLowerTriangularMatrix(double* diagonal, double* offDiagonal, int dimension);

  // copy constructor (without duplicating datas)
  //
  // M = matrix to copy
  RealLowerTriangularMatrix(const RealLowerTriangularMatrix& M);

  // copy constructor from a real tridiagonal symmetric matrix (without duplicating diagonal elements)
  //
  // M = matrix to copy
  RealLowerTriangularMatrix(const RealTriDiagonalSymmetricMatrix& M);
  ...
  RealLowerTriangularMatrix& operator = (const RealLowerTriangularMatrix& M);

  // assignement from  a real tridiagonal symmetric matrix (without duplicating datas)
  //
  // M = matrix to copy
  // return value = reference on modified matrix  
  RealLowerTriangularMatrix& operator = (const RealTriDiagonalSymmetricMatrix& M);
  ...
  friend RealLowerTriangularMatrix operator + (const RealLowerTriangularMatrix& M1, 
  ...
  friend RealMatrix operator * (RealMatrix& m1, const RealLowerTriangularMatrix& m2);
  ...
  // return value = product result
  friend RealLowerTriangularMatrix operator * (const RealLowerTriangularMatrix& M, double x);
  ...
  // x = real number to use
  // return value = product result
  friend RealLowerTriangularMatrix operator * (double x, const RealLowerTriangularMatrix& M);
  ...
  // x = real number to use
  // return value = reference on current matrix
  RealLowerTriangularMatrix& operator *= (double x);
...
//  friend ofstream& operator << (ofstream& file, const RealLowerTriangularMatrix& matrix);
  ...
  // return value = reference on output file stream
  friend ifstream& operator >> (ifstream& file, RealLowerTriangularMatrix& matrix);
...
inline double& RealLowerTriangularMatrix::operator [] (int i)
{
