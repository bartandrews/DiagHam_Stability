...
#ifndef PARTICLEONTORUSTWOLANDAULEVELSHAMILTONIAN_H
#define PARTICLEONTORUSTWOLANDAULEVELSHAMILTONIAN_H
...
class ParticleOnTorusTwoLandauLevelsHamiltonian : public ParticleOnLatticeQuantumSpinHallTwoBandHamiltonian
{
 ...
 public:
  ...
  ParticleOnTorusTwoLandauLevelsHamiltonian(ParticleOnSphereWithSpin* particles, int nbrParticles, int maxMomentum, double cyclotronenergy, double ratio, bool haveDelta,
						   AbstractArchitecture* architecture, long memory = -1, char* precalculationFileName = 0);

  // destructor
  //
  ~ParticleOnTorusTwoLandauLevelsHamiltonian();
