...
#ifndef FERMIONONSPHEREWITHSU8SPINLONG_H
#define FERMIONONSPHEREWITHSU8SPINLONG_H
...
class FermionOnSphereWithSU8SpinLong :  public ParticleOnSphereWithSU8Spin
{
 ...
 public:
  ...
  // default constructor
  //
  FermionOnSphereWithSU8SpinLong();
  ...
  FermionOnSphereWithSU8SpinLong (int nbrFermions, int totalLz, int lzMax, int* nbrParticleSigma, unsigned long memory = 10000000);

   // copy constructor (without duplicating datas)
  //
  // fermions = reference on the hilbert space to copy to copy
  FermionOnSphereWithSU8SpinLong(const FermionOnSphereWithSU8SpinLong& fermions);
  ...
  FermionOnSphereWithSU8SpinLong& operator = (const FermionOnSphereWithSU8SpinLong& fermions);
...
inline int FermionOnSphereWithSU8SpinLong::GetParticleStatistic()
{
...
inline int FermionOnSphereWithSU8SpinLong::GenericAdA(int index, int m, int n, double& coefficient)
{
...
inline double FermionOnSphereWithSU8SpinLong::AsigmaAsigma (int index, int n1, int n2, int sigma1, int sigma2)
{
...
inline int FermionOnSphereWithSU8SpinLong::AdsigmaAdsigma (int m1, int m2, int sigma1, int sigma2, double& coefficient)
{
