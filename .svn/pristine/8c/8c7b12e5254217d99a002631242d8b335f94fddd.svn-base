...
#ifndef FERMIONPARITYOPERATOR_H
#define FERMIONPARITYOPERATOR_H
...
class FermionParityOperator : public AbstractOperator
{
 ...
 public:
  ...
  FermionParityOperator(Spin1_2Chain* chain, int nbrSpin);

  // destructor
  //
  ~FermionParityOperator();
