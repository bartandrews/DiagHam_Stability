...
#ifndef FERMIONONTORUSWITHSPINANDMAGNETICTRANSLATIONSLONG_H
#define FERMIONONTORUSWITHSPINANDMAGNETICTRANSLATIONSLONG_H
...
#define FERMION_TORUS_SU2_SZ_MASK_LONG ((((ULONGLONG) 0x5555555555555555ul) << 64) | ((ULONGLONG) 0x5555555555555555ul))
#else
#define FERMION_TORUS_SU2_SZ_MASK_LONG ((((ULONGLONG) 0x55555555ul) << 32) | ((ULONGLONG) 0x55555555ul))
#endif

class FermionOnTorusWithSpinAndMagneticTranslationsLong :  public ParticleOnTorusWithSpinAndMagneticTranslations
{
...
//  unsigned long* TranslationSign;
 ...
 public:
  ...
  // default constructor
  // 
  FermionOnTorusWithSpinAndMagneticTranslationsLong ();  
  ...
  FermionOnTorusWithSpinAndMagneticTranslationsLong (int nbrFermions, int totalSpin, int maxMomentum, int xMomentum, int yMomentum);
  ...
  // xMomentum = momentum in the x direction (modulo GCD of nbrFermions and maxMomentum)
  // yMomentum = momentum in the y direction (modulo GCD of nbrFermions and maxMomentum)  
  FermionOnTorusWithSpinAndMagneticTranslationsLong (int nbrFermions, int maxMomentum, int xMomentum, int yMomentum);

  // copy constructor (without duplicating datas)
  //
  // fermions = reference on the hilbert space to copy to copy
  FermionOnTorusWithSpinAndMagneticTranslationsLong(const FermionOnTorusWithSpinAndMagneticTranslationsLong& fermions);
  ...
  FermionOnTorusWithSpinAndMagneticTranslationsLong& operator = (const FermionOnTorusWithSpinAndMagneticTranslationsLong& fermions);
  ...
  virtual ComplexVector ConvertFromNbodyBasis(ComplexVector& state, FermionOnTorusWithSpinAndMagneticTranslationsLong& basis);
 ...
 protected:
  ...
  virtual ULONGLONG FindCanonicalForm(ULONGLONG stateDescription, int& stateHighestBit, int& nbrTranslation);
 ...
 // find how many translations on the x direction are needed to obtain the same state
  ...
  virtual unsigned long GetStateSingletParity(ULONGLONG state);
  ...
  virtual ULONGLONG ApplySpinFlipSymmetry(ULONGLONG stateDescription);
...
inline int FermionOnTorusWithSpinAndMagneticTranslationsLong::GetParticleStatistic()
{
...
inline unsigned long FermionOnTorusWithSpinAndMagneticTranslationsLong::GetStateSingletParity(ULONGLONG state)
{
  state &= (state >> 1);
  state &= FERMION_TORUS_SU2_SZ_MASK_LONG;
#ifdef __128_BIT_LONGLONG__
  state ^= (state >> 64);
#endif
  state ^= (state >> 32);
...
inline ULONGLONG FermionOnTorusWithSpinAndMagneticTranslationsLong::ApplySpinFlipSymmetry(ULONGLONG stateDescription)
{
  ULONGLONG TmpState = ((stateDescription >> 1) ^ stateDescription) & FERMION_TORUS_SU2_SZ_MASK_LONG;
  TmpState |= TmpState << 1;
...
inline int FermionOnTorusWithSpinAndMagneticTranslationsLong::GetNbrOrbitals()
{
...
inline int FermionOnTorusWithSpinAndMagneticTranslationsLong::GetNbrParticles()
{
...
inline int FermionOnTorusWithSpinAndMagneticTranslationsLong::GetTotalSpin()
{
...
inline int FermionOnTorusWithSpinAndMagneticTranslationsLong::GetKxMomentum()
{
...
inline int FermionOnTorusWithSpinAndMagneticTranslationsLong::GetKyMomentum()
{
...
inline int FermionOnTorusWithSpinAndMagneticTranslationsLong::GetMaxXMomentum()
{
...
inline int FermionOnTorusWithSpinAndMagneticTranslationsLong::GetMaxYMomentum()
{
  return this->MaxMomentum;
}
