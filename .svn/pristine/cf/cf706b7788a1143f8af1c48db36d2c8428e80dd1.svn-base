...
#ifndef COMPLEXBASICBLOCKLANCZOSALGORITHM_H
#define COMPLEXBASICBLOCKLANCZOSALGORITHM_H
...
class ComplexBasicBlockLanczosAlgorithm : public AbstractLanczosAlgorithm
{
...
//  RealSymmetricMatrix TemporaryReducedMatrix;
 ...
 public:
  ...
  ComplexBasicBlockLanczosAlgorithm(AbstractArchitecture* architecture, int nbrEigenvalue, int blockSize = 2, int maxIter = 1000,
			     bool diskFlag  = false, bool resumeDiskFlag = false, bool strongConvergence = false, bool lapackFlag = false);

  // copy constructor
  //
  // algorithm = algorithm from which new one will be created
  ComplexBasicBlockLanczosAlgorithm(const ComplexBasicBlockLanczosAlgorithm& algorithm);

  // destructor
  //
  ~ComplexBasicBlockLanczosAlgorithm();
...
//  void ReorthogonalizeVectors (ComplexVector* vectors, int nbrVectors, RealSymmetricMatrix& matrix,
//			       int rowShift, int columnShift);

  void TestOrthogonality (ComplexVector* vectors, int nbrVectors, ComplexVector* otherVectors=NULL, int nbrOtherVectors=0);
