...
#ifndef PARTICLEONSPHEREWITHSPINALLSZDENSITYDENSITYODDCHANNEL_H
#define PARTICLEONSPHEREWITHSPINALLSZDENSITYDENSITYODDCHANNEL_H
...
class ParticleOnSphereWithSpinAllSzDensityDensityOddChannel : public AbstractOperator
{
...
// momentum index of the rightmost creation operator
 ...
 public:
  ...
  ParticleOnSphereWithSpinAllSzDensityDensityOddChannel(FermionOnSphereWithSpinAllSz* particle,  int creationMomentumIndex1,  int creationMomentumIndex2, int annihilationMomentumIndex1, int annihilationMomentumIndex2);

  // destructor
  //
  ~ParticleOnSphereWithSpinAllSzDensityDensityOddChannel();
