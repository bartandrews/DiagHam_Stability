...
#ifndef PARTICLEONSPHEREDELTAMODIFIEDHAMILTONIAN_H
#define PARTICLEONSPHEREDELTAMODIFIEDHAMILTONIAN_H
...
class ParticleOnSphereDeltaModifiedHamiltonian : public AbstractQHEOnSphereHamiltonian
{
 ...
 public:
  ...
  ParticleOnSphereDeltaModifiedHamiltonian(ParticleOnSphere* particles, int nbrParticles, int lzmax, double shift, int memory = -1);

  // destructor
  //
  ~ParticleOnSphereDeltaModifiedHamiltonian();
  ...
  friend ostream& operator << (ostream& Str, ParticleOnSphereDeltaModifiedHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, ParticleOnSphereDeltaModifiedHamiltonian& H);
