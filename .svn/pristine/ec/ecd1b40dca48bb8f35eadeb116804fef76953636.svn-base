...
TightBindingModelChern2TwoOrbitalSquareLattice::TightBindingModelChern2TwoOrbitalSquareLattice(int nbrSiteX, int nbrSiteY, int t1, int t2, int t3, double mus, double gammaX, double gammaY,
...
TightBindingModelChern2TwoOrbitalSquareLattice::~TightBindingModelChern2TwoOrbitalSquareLattice()
{
}
...
void TightBindingModelChern2TwoOrbitalSquareLattice::CoreComputeBandStructure(long minStateIndex, long nbrStates)
{
    if (nbrStates == 0l)
