...
FermionOnLatticeWithSpinRealSpaceAnd1DTranslation::FermionOnLatticeWithSpinRealSpaceAnd1DTranslation ()
{
  this->NbrFermions = 0;
...
FermionOnLatticeWithSpinRealSpaceAnd1DTranslation::FermionOnLatticeWithSpinRealSpaceAnd1DTranslation (int nbrFermions, int nbrSite, int momentum, int periodicity, unsigned long memory)
{  
...
FermionOnLatticeWithSpinRealSpaceAnd1DTranslation::FermionOnLatticeWithSpinRealSpaceAnd1DTranslation(const FermionOnLatticeWithSpinRealSpaceAnd1DTranslation& fermions)
{
...
FermionOnLatticeWithSpinRealSpaceAnd1DTranslation& FermionOnLatticeWithSpinRealSpaceAnd1DTranslation::operator = (const FermionOnLatticeWithSpinRealSpaceAnd1DTranslation& fermions)
{
  if ((this->HilbertSpaceDimension != 0) && (this->Flag.Shared() == false) && (this->Flag.Used() == true))
    {
      delete[] this->StateDescription;
...
AbstractHilbertSpace* FermionOnLatticeWithSpinRealSpaceAnd1DTranslation::Clone()
{
  return new FermionOnLatticeWithSpinRealSpaceAnd1DTranslation(*this);
}
...
ostream& FermionOnLatticeWithSpinRealSpaceAnd1DTranslation::PrintState (ostream& Str, int state)
{
...
long FermionOnLatticeWithSpinRealSpaceAnd1DTranslation::RawGenerateStates(int nbrFermions, int currentSite, long pos)
{
  if (nbrFermions == 0)
    {
...
long FermionOnLatticeWithSpinRealSpaceAnd1DTranslation::EvaluateHilbertSpaceDimension(int nbrFermions)
{
...
int FermionOnLatticeWithSpinRealSpaceAnd1DTranslation::FindStateIndex(char* stateDescription)
{
  char** TmpDescription;
