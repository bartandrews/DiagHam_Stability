...
#ifndef SPIN1_2CHAINWITHTRANSLATIONSANDSZINVERSIONSYMMETRIES_H
#define SPIN1_2CHAINWITHTRANSLATIONSANDSZINVERSIONSYMMETRIES_H
...
class Spin1_2ChainWithTranslationsAndSzInversionSymmetries : public Spin1_2ChainWithTranslationsAndInversionSymmetry
{
 ...
 public:
  ...
  // default constructor
  //
  Spin1_2ChainWithTranslationsAndSzInversionSymmetries ();
  ...
  Spin1_2ChainWithTranslationsAndSzInversionSymmetries (int chainLength, int momentum, int translationStep, int inversionSector, int szSymmetrySector, int memorySize, int memorySlice);
  ...
  // memorySize = memory size in bytes allowed for look-up table
  Spin1_2ChainWithTranslationsAndSzInversionSymmetries (int chainLength, int momentum, int translationStep, int inversionSector, int szSymmetrySector, int sz, int memorySize, int memorySlice);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  Spin1_2ChainWithTranslationsAndSzInversionSymmetries (const Spin1_2ChainWithTranslationsAndSzInversionSymmetries& chain);
  ...
  Spin1_2ChainWithTranslationsAndSzInversionSymmetries& operator = (const Spin1_2ChainWithTranslationsAndSzInversionSymmetries& chain);
...
inline unsigned long Spin1_2ChainWithTranslationsAndSzInversionSymmetries::FindCanonicalForm(unsigned long stateDescription, int& nbrTranslations, double& szSymmetrySign)
{
...
inline int Spin1_2ChainWithTranslationsAndSzInversionSymmetries::FindOrbitSize(unsigned long stateDescription)
{
  unsigned long TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);      
...
inline bool Spin1_2ChainWithTranslationsAndSzInversionSymmetries::TestMomentumConstraint(unsigned long stateDescription)
{
  unsigned long TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);   
