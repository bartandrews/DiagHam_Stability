...
int main(int argc, char** argv)
{
  ...
  OptionManager Manager ("FQHESphereFermionsProjectorHamiltonian" , "0.01");
  ...
  if (Manager.ProceedOptions(argv, argc, cout) == false)
    {
      cout << "see man page for option syntax or type FQHESphereFermionsProjectorHamiltonian -h" << endl;
      return -1;
    }
  ...
  FermionOnSphere** ProjectorSpaces;  
  ...
  if (Manager.GetString("projector-state") != 0)
      ...
      if (FQHEOnSphereFindSystemInfoFromVectorFileName(Manager.GetString("projector-state"), ProjectorNbrParticles, ProjectorLzMax, ProjectorTotalLz, ProjectorFermionFlag) == false)
	{
      ...
      ProjectorSpaces = new FermionOnSphere*[NbrProjectors];
      ProjectorStates = new RealVector[NbrProjectors];
      ProjectorSpaces[0] = new FermionOnSphere(ProjectorNbrParticles, ProjectorTotalLz, ProjectorLzMax);
      ...
      for (int i = 1; i < NbrProjectors; ++i)
	{
	  ...
	  ProjectorSpaces[i] = new FermionOnSphere(ProjectorNbrParticles, TmpProjectorTotalLz, ProjectorLzMax);
