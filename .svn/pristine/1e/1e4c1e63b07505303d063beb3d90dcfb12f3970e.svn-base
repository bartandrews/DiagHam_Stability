...
//                 and the Sz<->-Sz symmetry with up to 128 sites             //
//                                                                            //
...
#ifndef SPIN1_2CHAINWITHTRANSLATIONSANDSZSYMMETRYLONG_H
#define SPIN1_2CHAINWITHTRANSLATIONSANDSZSYMMETRYLONG_H
...
class Spin1_2ChainWithTranslationsAndSzSymmetryLong : public Spin1_2ChainWithTranslationsLong
{
 ...
 public:
  ...
  // default constructor
  //
  Spin1_2ChainWithTranslationsAndSzSymmetryLong ();
  ...
  Spin1_2ChainWithTranslationsAndSzSymmetryLong (int chainLength, int momentum, int translationStep, int szSymmetrySector, int memorySize, int memorySlice);
  ...
  // szSymmetrySector = Sz<->-Sz symmetry sector (can be either +1 or -1)
  // memorySize = memory size in bytes allowed for look-up table
  Spin1_2ChainWithTranslationsAndSzSymmetryLong (int chainLength, int momentum, int translationStep, int szSymmetrySector, int sz, int memorySize, int memorySlice);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  Spin1_2ChainWithTranslationsAndSzSymmetryLong (const Spin1_2ChainWithTranslationsAndSzSymmetryLong& chain);
  ...
  Spin1_2ChainWithTranslationsAndSzSymmetryLong& operator = (const Spin1_2ChainWithTranslationsAndSzSymmetryLong& chain);
...
inline int Spin1_2ChainWithTranslationsAndSzSymmetryLong::SymmetrizeResult(ULONGLONG& state, int nbrStateInOrbit, double& coefficient, 
								       int& nbrTranslations)
{
  double TmpSign;
...
inline ULONGLONG Spin1_2ChainWithTranslationsAndSzSymmetryLong::FindCanonicalForm(ULONGLONG stateDescription, int& nbrTranslations, double& szSymmetrySign)
{
...
inline int Spin1_2ChainWithTranslationsAndSzSymmetryLong::FindOrbitSize(ULONGLONG stateDescription)
{
  ULONGLONG TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);      
...
inline bool Spin1_2ChainWithTranslationsAndSzSymmetryLong::TestMomentumConstraint(ULONGLONG stateDescription)
{
  ULONGLONG TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);   
...
inline void Spin1_2ChainWithTranslationsAndSzSymmetryLong::ApplySzSymmetry(ULONGLONG& stateDescription)
{
