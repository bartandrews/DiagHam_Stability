...
#ifndef TWODIMENSIONALHEISENBERGHAMILTONIAN_H
#define TWODIMENSIONALHEISENBERGHAMILTONIAN_H
...
class TwoDimensionalHeisenbergHamiltonian : public AbstractHamiltonian
{
 ...
 public:
   ...
   // default constructor
  //
  TwoDimensionalHeisenbergHamiltonian();
...
inline int TwoDimensionalHeisenbergHamiltonian::GetLinearizedIndex(int xPosition, int yPosition)
{
...
inline int TwoDimensionalHeisenbergHamiltonian::GetSafeLinearizedIndex(int xPosition, int yPosition)
{
