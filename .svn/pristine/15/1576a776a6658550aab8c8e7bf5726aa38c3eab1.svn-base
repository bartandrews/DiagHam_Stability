...
PairHoppingGenericPAsSpin1ChainWithTranslationsLong::PairHoppingGenericPAsSpin1ChainWithTranslationsLong () 
{
  this->UnitCellSize = 3;
...
PairHoppingGenericPAsSpin1ChainWithTranslationsLong::PairHoppingGenericPAsSpin1ChainWithTranslationsLong (int chainLength, int momentum, int pValue, unsigned long memory) 
{
...
PairHoppingGenericPAsSpin1ChainWithTranslationsLong::PairHoppingGenericPAsSpin1ChainWithTranslationsLong (const PairHoppingGenericPAsSpin1ChainWithTranslationsLong& chain) 
{
...
PairHoppingGenericPAsSpin1ChainWithTranslationsLong& PairHoppingGenericPAsSpin1ChainWithTranslationsLong::operator = (const PairHoppingGenericPAsSpin1ChainWithTranslationsLong& chain)
{
...
AbstractHilbertSpace* PairHoppingGenericPAsSpin1ChainWithTranslationsLong::Clone()
{
  return new PairHoppingGenericPAsSpin1ChainWithTranslationsLong(*this);
}
...
int PairHoppingGenericPAsSpin1ChainWithTranslationsLong::SwapOperator (int unitCellCoordinate, int siteIndex, int state, double& coefficient, int& nbrTranslation)
{
...
int PairHoppingGenericPAsSpin1ChainWithTranslationsLong::PlusMinusOperator (int leftUnitCellCoordinate, int rightUnitCellCoordinate, int state, double& coefficient, int& nbrTranslation)
{
  ULONGLONG TmpStateDescription = this->StateDescription[state];
...
long PairHoppingGenericPAsSpin1ChainWithTranslationsLong::EvaluateHilbertSpaceDimension(int previousNbrPlus, int initialNbrMinus, int sitePosition)
{
...
long PairHoppingGenericPAsSpin1ChainWithTranslationsLong::RawGenerateStates(long statePosition, int previousNbrPlus, int initialNbrMinus, int sitePosition) 
{
  if (sitePosition == this->ChainLength)
    {
      if (previousNbrPlus == initialNbrMinus)
...
long PairHoppingGenericPAsSpin1ChainWithTranslationsLong::GenerateStates()
{
  ...
  if (TmpLargeHilbertSpaceDimension > 0l)
      ...
      for  (long i = 0; i < this->LargeHilbertSpaceDimension; ++i)
	{
      ...
      SortArrayDownOrdering<ULONGLONG>(TmpStateDescription, TmpLargeHilbertSpaceDimension);     
      delete[] this->StateDescription;
...
RealMatrix PairHoppingGenericPAsSpin1ChainWithTranslationsLong::EvaluatePartialEntanglementMatrix (int nbrSites, int szSector, RealVector& groundState, AbstractArchitecture* architecture)
{
  if (nbrSites == 0)
    {
      if (szSector == 0)
  ...
  PairHoppingGenericPAsSpin1ChainLong TmpDestinationHilbertSpace(nbrSites, TmpNbrPlusRight, this->UnitCellSize, TmpNbrMinusLeft, 1000000);
  PairHoppingGenericPAsSpin1ChainLong TmpHilbertSpace(this->ChainLength - nbrSites, this->UnitCellSize, TmpNbrMinusLeft, TmpNbrPlusRight, 1000000);
...
#endif
    {
      Mask2 = (((ULONGLONG) 0x1ul) << (2 * this->ChainLength)) - ((ULONGLONG) 0x1ul);      
    }
  else
    {
      Mask2 = ~((ULONGLONG) 0x0ul);
    }
...
ComplexMatrix PairHoppingGenericPAsSpin1ChainWithTranslationsLong::EvaluatePartialEntanglementMatrix (int nbrSites, int szSector, ComplexVector& groundState, AbstractArchitecture* architecture)
{
  if (nbrSites == 0)
    {
      if (szSector == 0)
  ...
  int TmpNbrMinusLeft = szSector / (this->UnitCellSize + 1);
  int TmpNbrPlusRight = szSector % (this->UnitCellSize + 1);
  PairHoppingGenericPAsSpin1ChainLong TmpDestinationHilbertSpace(nbrSites, this->UnitCellSize, TmpNbrPlusRight, TmpNbrMinusLeft, 1000000);
  PairHoppingGenericPAsSpin1ChainLong TmpHilbertSpace(this->ChainLength - nbrSites, this->UnitCellSize, TmpNbrMinusLeft, TmpNbrPlusRight, 1000000);
...
void PairHoppingGenericPAsSpin1ChainWithTranslationsLong::GenerateAllPossibleUnitCells()
{
