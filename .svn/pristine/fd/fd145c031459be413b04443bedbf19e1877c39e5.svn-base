...
int main(int argc, char** argv)
{
  ...
  OptionManager Manager ("FQHETorusBosonsWithTranslationsGenericThreeBody" , "0.01");
  ...
  if (Manager.ProceedOptions(argv, argc, cout) == false)
    {
      cout << "see man page for option syntax or type FQHETorusBosonsWithTranslationsGenericThreeBody -h" << endl;
      return -1;
    }
  ...
  sprintf (OutputName, "bosons_torus_%s_n_%d_2s_%d_ratio_%f.dat", Manager.GetString("interaction-name"),
  ...
  for (int Pos = 0;Pos < NbrMomenta; ++Pos)
	...
	Memory = Architecture.GetArchitecture()->GetLocalMemory();
      ...
      Hamiltonian = new ParticleOnTorusThreeBodyHardcoreWithMagneticTranslationsHamiltonian(Space, NbrParticles, MaxMomentum, XMomentum, XRatio, 
