...
#ifndef PARTICLEONSPHERESZPARITYOPERATOR_H
#define PARTICLEONSPHERESZPARITYOPERATOR_H
...
class ParticleOnSphereWithSpinSzParityOperator : public AbstractOperator
{
 ...
 public:
  ...
  ParticleOnSphereWithSpinSzParityOperator(ParticleOnSphereWithSpin* particle);

  // destructor
  //
  ~ParticleOnSphereWithSpinSzParityOperator();
