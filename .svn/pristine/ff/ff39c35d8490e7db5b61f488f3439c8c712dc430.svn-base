...
ParticleOnDiskGenericThreeBodyHamiltonian::ParticleOnDiskGenericThreeBodyHamiltonian()
{
}
...
ParticleOnDiskGenericThreeBodyHamiltonian::ParticleOnDiskGenericThreeBodyHamiltonian(ParticleOnSphere* particles, int nbrParticles, int lzmax, 
...
AbstractHamiltonian* ParticleOnDiskGenericThreeBodyHamiltonian::Clone ()
{
  return 0;
}
...
void ParticleOnDiskGenericThreeBodyHamiltonian::EvaluateInteractionFactors()
{
...
double* ParticleOnDiskGenericThreeBodyHamiltonian::ComputeProjectorCoefficients(int relativeMomentum, int degeneracyIndex, int* indices, int nbrIndexSets)
{
