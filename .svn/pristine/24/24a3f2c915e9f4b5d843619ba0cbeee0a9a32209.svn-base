...
{
  OptionManager Manager ("FQHETorusBosonsEntanglementEntropy" , "0.01");
  ...
  if (Manager.ProceedOptions(argv, argc, cout) == false)
    {
      cout << "see man page for option syntax or type FQHETorusBosonsEntanglementEntropy -h" << endl;
      return -1;
    }
  ...
  Spaces = new BosonOnTorusShort* [KyMax];
  ...
  for (int i = 0; i < NbrSpaces; ++i)
	...
	{
	  Spaces[TotalKy[i]] = new BosonOnTorusShort (NbrParticles, KyMax, TotalKy[i]);
