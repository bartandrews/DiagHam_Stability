...
//                and 2d translations plus any generic inversion symmetry     //
//                                                                            //
...
Spin1_2ChainNewGenericInversionAnd2DTranslation::Spin1_2ChainNewGenericInversionAnd2DTranslation ()
{
  this->InversionSymmetrySector = 1.0;
  this->InversionSymmetryTable = 0;
}

// constructor for the complete Hilbert space
//
...
Spin1_2ChainNewGenericInversionAnd2DTranslation::Spin1_2ChainNewGenericInversionAnd2DTranslation (int nbrSite, int sz, 
...
Spin1_2ChainNewGenericInversionAnd2DTranslation::Spin1_2ChainNewGenericInversionAnd2DTranslation (char* fileName, unsigned long memory)
{
  ifstream File;
...
Spin1_2ChainNewGenericInversionAnd2DTranslation::Spin1_2ChainNewGenericInversionAnd2DTranslation (const Spin1_2ChainNewGenericInversionAnd2DTranslation& chain)
{
...
Spin1_2ChainNewGenericInversionAnd2DTranslation::~Spin1_2ChainNewGenericInversionAnd2DTranslation () 
{
  if (this->InversionSymmetryTable != 0)
    {
      delete[] this->InversionSymmetryTable;
    }
}
...
Spin1_2ChainNewGenericInversionAnd2DTranslation& Spin1_2ChainNewGenericInversionAnd2DTranslation::operator = (const Spin1_2ChainNewGenericInversionAnd2DTranslation& chain)
{
...
AbstractHilbertSpace* Spin1_2ChainNewGenericInversionAnd2DTranslation::Clone()
{
  return new Spin1_2ChainNewGenericInversionAnd2DTranslation (*this);
}
...
bool Spin1_2ChainNewGenericInversionAnd2DTranslation::WriteHilbertSpace (char* fileName)
{
  ofstream File;
  ...
  WriteLittleEndian(File, this->InversionSymmetrySector);
  this->InversionSymmetryTable = new int[this->NbrSite];
  for (int i = 0; i < this->NbrSite; ++i)
    WriteLittleEndian(File, this->InversionSymmetryTable[i]);
...
void Spin1_2ChainNewGenericInversionAnd2DTranslation::ComputeRescalingFactors()
{
  int Tmp = 4 * this->NbrSite;
