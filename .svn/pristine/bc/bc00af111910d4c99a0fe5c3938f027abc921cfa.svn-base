...
// constructor
//
ParticleOnLatticePyrochloreSlabLatticeSingleBandHamiltonian::ParticleOnLatticePyrochloreSlabLatticeSingleBandHamiltonian()
{
  this->BandIndex = 0;
}
...
void ParticleOnLatticePyrochloreSlabLatticeSingleBandHamiltonian::EvaluateInteractionFactors()
{
...
Complex ParticleOnLatticePyrochloreSlabLatticeSingleBandHamiltonian::ComputeTwoBodyMatrixElementOnSiteAA()
{
  return 1.0;
}
...
Complex ParticleOnLatticePyrochloreSlabLatticeSingleBandHamiltonian::ComputeTwoBodyMatrixElementOnSiteBB(int kx1, int ky1, int kx2, int ky2, int kx3, int ky3, int kx4, int ky4)
{
...
Complex ParticleOnLatticePyrochloreSlabLatticeSingleBandHamiltonian::ComputeTwoBodyMatrixElementOnSiteCC(int kx1, int ky1, int kx2, int ky2, int kx3, int ky3, int kx4, int ky4)
{
