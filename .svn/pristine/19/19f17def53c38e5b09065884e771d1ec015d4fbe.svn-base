...
// constructor
//
ParticleOnLatticeEffectiveBilayerHaldaneLatticeSingleBandHamiltonian::ParticleOnLatticeEffectiveBilayerHaldaneLatticeSingleBandHamiltonian()
{
  this->BandIndex = 0;
}
...
ParticleOnLatticeEffectiveBilayerHaldaneLatticeSingleBandHamiltonian::ParticleOnLatticeEffectiveBilayerHaldaneLatticeSingleBandHamiltonian(ParticleOnSphere* particles, int nbrParticles, int nbrCellX, int nbrCellY, 
...
void ParticleOnLatticeEffectiveBilayerHaldaneLatticeSingleBandHamiltonian::EvaluateInteractionFactors()
{
		  ...
		  if(this->VPotential != 0.0)
		    {
		      ...
		      Tmp2 = (Conj(OneBodyBasis[Index1][BandIndex][0]) * OneBodyBasis[Index3][BandIndex][0] * Conj(OneBodyBasis[Index2][BandIndex][1]) * OneBodyBasis[Index4][BandIndex][1]) * this->ComputeTwoBodyMatrixElementAB(kx2, ky2, kx4, ky4);
		      Tmp2 += (Conj(OneBodyBasis[Index2][BandIndex][0]) * OneBodyBasis[Index3][BandIndex][0] * Conj(OneBodyBasis[Index1][BandIndex][1]) * OneBodyBasis[Index4][BandIndex][1]) * this->ComputeTwoBodyMatrixElementAB(kx1, ky1, kx4, ky4);
		      Tmp2 += (Conj(OneBodyBasis[Index1][BandIndex][0]) * OneBodyBasis[Index4][BandIndex][0] * Conj(OneBodyBasis[Index2][BandIndex][1]) * OneBodyBasis[Index3][BandIndex][1]) * this->ComputeTwoBodyMatrixElementAB(kx2, ky2, kx3, ky3);
		      Tmp2 += (Conj(OneBodyBasis[Index2][BandIndex][0]) * OneBodyBasis[Index4][BandIndex][0] * Conj(OneBodyBasis[Index1][BandIndex][1]) * OneBodyBasis[Index3][BandIndex][1]) * this->ComputeTwoBodyMatrixElementAB(kx1, ky1, kx3, ky3);
		      Tmp2 *= FactorV;
...
Complex ParticleOnLatticeEffectiveBilayerHaldaneLatticeSingleBandHamiltonian::ComputeTwoBodyMatrixElementAB(int k1a, int k1b, int k2a, int k2b)
{
  Complex Tmp = 1.0 + Phase(this->KxFactor * ((double) (k2a - k1a))) + Phase(this->KyFactor * ((double) (k1b - k2b)));
  return Tmp;
}
