...
#ifndef PAIRHOPPINGP1SPIN1CHAINLONG_H
#define PAIRHOPPINGP1SPIN1CHAINLONG_H
...
class PairHoppingP1AsSpin1ChainLong : public Spin1ChainLong
{
...
public:
  ...
  PairHoppingP1AsSpin1ChainLong (int chainLength, bool periodicBoundaryConditions = false, int memorySize = -1, bool useForEntanglementMatrix = false);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  PairHoppingP1AsSpin1ChainLong (const PairHoppingP1AsSpin1ChainLong& chain);

  // destructor
  //
  virtual ~PairHoppingP1AsSpin1ChainLong ();

  // assignement (without duplicating datas)
  //
  // chain = reference on chain to copy
  // return value = reference on current chain
  PairHoppingP1AsSpin1ChainLong& operator = (const PairHoppingP1AsSpin1ChainLong& chain);
