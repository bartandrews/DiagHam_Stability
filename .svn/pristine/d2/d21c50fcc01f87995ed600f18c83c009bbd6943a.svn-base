...
#ifndef NONPERIODICDMRGALGORITHM_H
#define NONPERIODICDMRGALGORITHM_H
...
class NonPeriodicDMRGAlgorithm : public AbstractDMRGAlgorithm
{
 ...
 public:
  ...
  NonPeriodicDMRGAlgorithm (AbstractHamiltonian* blockHamiltonian, 
			    AbstractHamiltonian* interactionBlockHamiltonian,
			    AbstractInteraction* leftInteraction,
			    AbstractInteraction* rightLeftInteraction, 
			    AbstractLanczosAlgorithm* lanczosAlgorithm,
 ...
 private:
  ...
  Matrix* TransformOperator(Matrix* observable, bool spaceFlag, 
			    BlockDiagonalMatrix& transformationMatrix, int nbrSubspace,
			    int* keptSubspace, 
