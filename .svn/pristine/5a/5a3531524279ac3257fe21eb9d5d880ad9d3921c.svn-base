...
#ifndef PARTICLEONSPHEREWITHSPINLPLUSUPOPERATOR_H
#define PARTICLEONSPHEREWITHSPINLPLUSUPOPERATOR_H
...
class ParticleOnSphereWithSpinLPlusUpOperator : public AbstractOperator
{
 ...
 public:
  ...
  ParticleOnSphereWithSpinLPlusUpOperator(ParticleOnSphereWithSpin* particle, int totalLz, int lzMax);

  // copy constructor
  //
  // oper = reference on the operator to copy
  ParticleOnSphereWithSpinLPlusUpOperator(const ParticleOnSphereWithSpinLPlusUpOperator& oper);

  // destructor
  //
  ~ParticleOnSphereWithSpinLPlusUpOperator();
