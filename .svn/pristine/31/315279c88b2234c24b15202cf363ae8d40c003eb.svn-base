...
#ifndef TIGHTBINDINGMODELTIMEREVERSALBHZLATTICE_H
#define TIGHTBINDINGMODELTIMEREVERSALBHZLATTICE_H
...
class TightBindingModelTimeReversalBHZLattice : public Abstract2DTightBindingModel
{
 ...
 public:
  ...
  TightBindingModelTimeReversalBHZLattice(int nbrSiteX, int nbrSiteY, double a, double b, double c, double d, double m, double delta,
				 double gammaX, double gammaY, 
				 AbstractArchitecture* architecture, bool storeOneBodyMatrices = true);

  // destructor
  //
  ~TightBindingModelTimeReversalBHZLattice();
