...
#ifndef PARTICLEONSPHEREWITHSPINLMINUSOPERATOR_H
#define PARTICLEONSPHEREWITHSPINLMINUSOPERATOR_H
...
class ParticleOnSphereWithSpinLMinusOperator : public AbstractOperator
{
 ...
 public:
  ...
  ParticleOnSphereWithSpinLMinusOperator(ParticleOnSphereWithSpin* particle, int totalLz, int lzMax);

  // copy constructor
  //
  // oper = reference on the operator to copy
  ParticleOnSphereWithSpinLMinusOperator(const ParticleOnSphereWithSpinLMinusOperator& oper);

  // destructor
  //
  ~ParticleOnSphereWithSpinLMinusOperator();
