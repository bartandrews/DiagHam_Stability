...
#ifndef ABSTRACTQHEONCYLINDERHAMILTONIAN_H
#define ABSTRACTQHEONCYLINDERHAMILTONIAN_H
...
class AbstractQHEOnCylinderHamiltonian : public AbstractQHEHamiltonian
{
