...
FermionOnLatticeRealSpaceAnd1DTranslation::FermionOnLatticeRealSpaceAnd1DTranslation ()
{
  this->NbrFermions = 0;
...
FermionOnLatticeRealSpaceAnd1DTranslation::FermionOnLatticeRealSpaceAnd1DTranslation(const FermionOnLatticeRealSpaceAnd1DTranslation& fermions)
{
...
FermionOnLatticeRealSpaceAnd1DTranslation& FermionOnLatticeRealSpaceAnd1DTranslation::operator = (const FermionOnLatticeRealSpaceAnd1DTranslation& fermions)
{
...
AbstractHilbertSpace* FermionOnLatticeRealSpaceAnd1DTranslation::Clone()
{
  return new FermionOnLatticeRealSpaceAnd1DTranslation(*this);
}
...
void FermionOnLatticeRealSpaceAnd1DTranslation::GenerateLookUpTable(unsigned long memory)
{
...
long FermionOnLatticeRealSpaceAnd1DTranslation::GenerateStates()
{
  ...
  for (long i = 0; i < this->LargeHilbertSpaceDimension; ++i)
    {
      //     cout << "i = " <<i <<" "<< this->StateDescription[i]<< " " <<  (bitset<6>) this->StateDescription[i]<<endl;
      //     cout <<dec<<this->FindCanonicalForm(this->StateDescription[i], NbrTranslationX)<<" " << (bitset<6>) this->FindCanonicalForm(this->StateDescription[i], NbrTranslationX)<<endl;
...
long FermionOnLatticeRealSpaceAnd1DTranslation::RawGenerateStates(int nbrFermions, int currentSite, long pos)
{
  if (nbrFermions == 0)
    {
...
long FermionOnLatticeRealSpaceAnd1DTranslation::EvaluateHilbertSpaceDimension(int nbrFermions)
{
...
int FermionOnLatticeRealSpaceAnd1DTranslation::FindStateIndex(char* stateDescription)
{
  char** TmpDescription;
...
int FermionOnLatticeRealSpaceAnd1DTranslation::FindStateIndex(unsigned long stateDescription, int maxMomentum)
{
...
int FermionOnLatticeRealSpaceAnd1DTranslation::AdA (int index, int m, int n, double& coefficient, int& nbrTranslationX)
{
...
int FermionOnLatticeRealSpaceAnd1DTranslation::AdAd (int m1, int m2, double& coefficient, int& nbrTranslationX)
{
...
int FermionOnLatticeRealSpaceAnd1DTranslation::Ad (int m, double& coefficient, int& nbrTranslationX)
{
  unsigned long TmpState = this->ProdATemporaryState;
...
HermitianMatrix FermionOnLatticeRealSpaceAnd1DTranslation::EvaluatePartialDensityMatrixParticlePartition (int nbrParticleSector, int kxSector, int kySector, ComplexVector& groundState, AbstractArchitecture* architecture)
{
