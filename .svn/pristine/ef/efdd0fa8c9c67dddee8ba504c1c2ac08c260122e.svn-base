...
int main(int argc, char** argv)
{
  ...
  OptionManager Manager ("FQHESphereBosonsFiveBodyGeneric" , "0.01");
  ...
  if (Manager.ProceedOptions(argv, argc, cout) == false)
    {
      cout << "see man page for option syntax or type FQHESphereBosonsFiveBodyGeneric -h" << endl;
      return -1;
    }
  ...
  double* FiveBodyPotentials = 0;
  int TmpNbrFiveBodyPseudoPotentials = 0;
  ...
  if (((SingleStringOption*) Manager["interaction-file"])->GetString() == 0)
      ...
      if (InteractionDefinition.Parse(((SingleStringOption*) Manager["interaction-file"])->GetString()) == false)
	{
      ...
      if (InteractionDefinition.GetAsDoubleArray("FivebodyPseudopotentials", ' ', FiveBodyPotentials, TmpNbrFiveBodyPseudoPotentials) == false)
	{
	  cout << "FivebodyPseudopotentials are not defined or has a wrong value in " << ((SingleStringOption*) Manager["interaction-file"])->GetString() << endl;
	  return -1;
	}
      ...
      if (InteractionDefinition.GetAsDoubleArray("Pseudopotentials", ' ', PseudoPotentials, TmpNbrPseudoPotentials) == true)
	{
      ...
      InteractionDefinition.GetAsDoubleArray("FourbodyPseudopotentials", ' ', FourBodyPotentials, TmpNbrFourBodyPseudoPotentials);
   }
  ...
  for (; L <= Max; L += 2)
	...
	{
	  if (FourBodyPotentials == 0)
	    Hamiltonian = new ParticleOnSphereGenericFiveBodyHamiltonian(Space, NbrParticles, LzMax, FiveBodyPotentials, TmpNbrFiveBodyPseudoPotentials - 1,
	    ...
	    {
	      Hamiltonian = new ParticleOnSphereGenericFiveBodyHamiltonian(Space, NbrParticles, LzMax, FiveBodyPotentials, TmpNbrFiveBodyPseudoPotentials - 1,
									   FourBodyPotentials, TmpNbrFourBodyPseudoPotentials - 1,
									   ((SingleDoubleOption*) Manager["l2-factor"])->GetDouble(),
									   Architecture.GetArchitecture(), 
									   Memory, DiskCacheFlag,
									   LoadPrecalculationFileName);
