...
#ifndef PARTICLEONLATTICENORBITALSQUARELATTICESINGLEBANDTHREEBODYHAMILTONIAN_H
#define PARTICLEONLATTICENORBITALSQUARELATTICESINGLEBANDTHREEBODYHAMILTONIAN_H
...
class ParticleOnLatticeNOrbitalSquareLatticeSingleBandThreeBodyHamiltonian : public ParticleOnLatticeChernInsulatorSingleBandNBodyHamiltonian
{
 ...
 public:
  ...
  // constructor
  //
  ParticleOnLatticeNOrbitalSquareLatticeSingleBandThreeBodyHamiltonian();
  ...
  ParticleOnLatticeNOrbitalSquareLatticeSingleBandThreeBodyHamiltonian(ParticleOnSphere* particles, int nbrParticles, 
