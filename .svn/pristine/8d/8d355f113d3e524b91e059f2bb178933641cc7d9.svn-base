...
//                                                                            //
//                                                                            //
//                     class of real lower triangular matrix                  //
//                                                                            //
...
RealLowerTriangularMatrix::RealLowerTriangularMatrix() 
{
...
RealLowerTriangularMatrix::RealLowerTriangularMatrix(int dimension, bool zero) 
{
...
RealLowerTriangularMatrix::RealLowerTriangularMatrix(double* diagonal, double* offDiagonal, int dimension) 
{
...
RealLowerTriangularMatrix::RealLowerTriangularMatrix(const RealLowerTriangularMatrix& M) 
{
...
RealLowerTriangularMatrix& RealLowerTriangularMatrix::operator = (const RealLowerTriangularMatrix& M) 
{
  if (this->OffDiagonalGarbageFlag != 0)
    {
      if ((*(this->OffDiagonalGarbageFlag)) == 1)
...
Matrix* RealLowerTriangularMatrix::Clone ()
{
  return ((Matrix*) new RealLowerTriangularMatrix (*this));
}
...
void RealLowerTriangularMatrix::SetMatrixElement(int i, int j, double x)
{
...
// j = column position
// x = new value for matrix element
void RealLowerTriangularMatrix::SetMatrixElement(int i, int j, const Complex& x)
{
  return;
}
...
void RealLowerTriangularMatrix::AddToMatrixElement(int i, int j, double x)
{
  if ((i >= this->NbrRow) || (j >= this->NbrColumn))
    return;
  if (i == j)
...
// j = column position
// x = value to add to matrix element
void RealLowerTriangularMatrix::AddToMatrixElement(int i, int j, const Complex& x)
{
  return;
}
...
double& RealLowerTriangularMatrix::operator () (int i, int j)
{
  if (i == j)
    {
...
void RealLowerTriangularMatrix::Resize (int nbrRow, int nbrColumn)
{
  if (nbrRow != nbrColumn)
    return;
...
void RealLowerTriangularMatrix::ResizeAndClean (int nbrRow, int nbrColumn)
{
  if (nbrRow != nbrColumn)
    return;
  if (nbrRow <= this->TrueNbrRow)
...
RealLowerTriangularMatrix operator + (const RealLowerTriangularMatrix& M1, const RealLowerTriangularMatrix& M2)
{
  if (M1.NbrRow != M2.NbrRow)
    return RealLowerTriangularMatrix();
  ...
  return RealLowerTriangularMatrix(Diagonal, OffDiagonal, M1.NbrRow);
}
...
RealMatrix operator * (RealMatrix& m1, const RealLowerTriangularMatrix& m2)
{
...
RealLowerTriangularMatrix operator * (const RealLowerTriangularMatrix& M, double x) 
{
  ...
  return RealLowerTriangularMatrix(Diagonal, OffDiagonal, M.NbrRow);
}
...
RealLowerTriangularMatrix operator * (double x, const RealLowerTriangularMatrix& M) 
{
  double* Diagonal = new double [M.NbrRow];
  int ReducedNbr = M.NbrRow - 1;
  double* OffDiagonal = new double [(M.NbrRow * ReducedNbr) / 2];
...
RealLowerTriangularMatrix& RealLowerTriangularMatrix::operator *= (double x) 
{
  if (this->NbrRow == 0)
    return *this;
...
double RealLowerTriangularMatrix::MatrixElement (RealVector& V1, RealVector& V2)
{
  double x = 0.0;
...
double RealLowerTriangularMatrix::Tr () 
{
  if (this->NbrRow == 0)
    return 0.0;
...
double RealLowerTriangularMatrix::Det () 
{
  if (this->NbrRow == 0)
    return 0.0;
  double x = this->DiagonalElements[0];
...
ostream& operator << (ostream& Str, const RealLowerTriangularMatrix& P)
{
...
MathematicaOutput& operator << (MathematicaOutput& Str, const RealLowerTriangularMatrix& P)
{
  Str << "{";
  for (int i = 0; i < P.NbrRow; i++)
    {
...
/*ofstream& operator << (ofstream& file, const RealLowerTriangularMatrix& matrix)
{
...
ifstream& operator >> (ifstream& file, RealLowerTriangularMatrix& matrix)
{
  return file;
}
