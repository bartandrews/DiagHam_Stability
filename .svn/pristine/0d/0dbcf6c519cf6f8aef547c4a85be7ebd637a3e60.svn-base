...
//                                                                            //
//                                                                            //
//                          class of bosons on the 4D sphere                  //
...
BosonOn4DSphereLong::BosonOn4DSphereLong ()
{
}
...
// nbrFluxQuanta = number of flux quanta (=p; determines an irreducible representation of SO(5), along with q=0 (LLL))
// totalJz = total value of jz
// totalKz = total value of kz
// memory = amount of memory granted for precalculations

BosonOn4DSphereLong::BosonOn4DSphereLong (int nbrBosons, int nbrFluxQuanta, int totalJz, int totalKz, unsigned long memory)
{  
...
BosonOn4DSphereLong::BosonOn4DSphereLong(const BosonOn4DSphereLong& bosons)
{
...
BosonOn4DSphereLong& BosonOn4DSphereLong::operator = (const BosonOn4DSphereLong& bosons)
{
  if (bosons.TargetSpace != &bosons)
    this->TargetSpace = bosons.TargetSpace;
  else
...
AbstractHilbertSpace* BosonOn4DSphereLong::Clone()
{
  return new BosonOn4DSphereLong(*this);
}
...
bool BosonOn4DSphereLong::WriteHilbertSpace (char* fileName)
{
  ofstream File;
...
long BosonOn4DSphereLong::GenerateStates(ULONGLONG* stateDescription, int nbrBosons, int currentJ, int currentJz, int currentKz, int currentTotalJz, int currentTotalKz, int currentFermionicPosition, long pos)
{
...
long BosonOn4DSphereLong::EvaluateHilbertSpaceDimension(int nbrBosons, int currentJ, int currentJz, int currentKz, int currentTotalJz, int currentTotalKz)
{
  if (nbrBosons < 0)
    return 0l;
   if (currentTotalKz > this->ShiftedTotalKz)
