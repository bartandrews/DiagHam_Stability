...
ParticleOnS2xS2DeltaHamiltonian::ParticleOnS2xS2DeltaHamiltonian()
{
}
...
ParticleOnS2xS2DeltaHamiltonian::ParticleOnS2xS2DeltaHamiltonian(ParticleOnSphere* particles, int nbrParticles, int nbrFluxQuanta1, int nbrFluxQuanta2, 
...
void ParticleOnS2xS2DeltaHamiltonian::EvaluateInteractionFactors()
{
  ...
  if (this->Particles->GetParticleStatistic() == ParticleOnSphere::FermionicStatistic)
    {
      cout << "ParticleOnS2xS2DeltaHamiltonian is not implemented for fermions" << endl;
    } 
  else 
    {
	...
	for (int lz2 = 0; lz2 <= this->NbrFluxQuanta1; ++lz2)
	  ...
	  if (this->NbrSectorIndicesPerSum[i] > 0)
	      ...
	      for (int j1 = 0; j1 < this->NbrSectorIndicesPerSum[i]; ++j1)
		{
		  ...
		  double TmpFactorAnnihilation = (Clebsch1.GetCoefficient((2 * lz1) - this->NbrFluxQuanta1, (2 * lz2) - this->NbrFluxQuanta1, AngularMaxMomentum1) 
						  * Clebsch2.GetCoefficient((2 * kz1) - this->NbrFluxQuanta2, (2 * kz2) - this->NbrFluxQuanta2, AngularMaxMomentum2));
		  double TmpFactorAnnihilationPerm = (Clebsch1.GetCoefficient((2 * lz2) - this->NbrFluxQuanta1, (2 * lz1) - this->NbrFluxQuanta1, AngularMaxMomentum1) 
						      * Clebsch2.GetCoefficient((2 * kz2) - this->NbrFluxQuanta2, (2 * kz1) - this->NbrFluxQuanta2, AngularMaxMomentum2));
		  for (int j2 = 0; j2 < this->NbrSectorIndicesPerSum[i]; ++j2)
		    {
		      ...
		      double TmpFactorCreation = (Clebsch1.GetCoefficient((2 * lz3) - this->NbrFluxQuanta1, (2 * lz4) - this->NbrFluxQuanta1, AngularMaxMomentum1) 
						  * Clebsch2.GetCoefficient((2 * kz3) - this->NbrFluxQuanta2, (2 * kz4) - this->NbrFluxQuanta2, AngularMaxMomentum2));
		      double TmpFactorCreationPerm = (Clebsch1.GetCoefficient((2 * lz4) - this->NbrFluxQuanta1, (2 * lz3) - this->NbrFluxQuanta1, AngularMaxMomentum1) 
						      * Clebsch2.GetCoefficient((2 * kz4) - this->NbrFluxQuanta2, (2 * kz3) - this->NbrFluxQuanta2, AngularMaxMomentum2));
