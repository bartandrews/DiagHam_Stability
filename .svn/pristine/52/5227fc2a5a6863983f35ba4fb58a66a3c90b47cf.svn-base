...
class QHEParticlePrecalculationOperation: public AbstractArchitectureOperation
{
 ...
 public:
  ...
  QHEParticlePrecalculationOperation(AbstractQHEOnSphereHamiltonian* hamiltonian, bool firstPass = true);
