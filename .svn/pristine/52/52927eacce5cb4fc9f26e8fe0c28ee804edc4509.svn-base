...
#ifndef PARTICLEONSPHEREWITHSPINS2HAMILTONIAN_H
#define PARTICLEONSPHEREWITHSPINS2HAMILTONIAN_H
...
class ParticleOnSphereWithSpinS2Hamiltonian : public AbstractQHEOnSphereWithSpinHamiltonian
{
 ...
 protected:
  ...
  int TotalLz;
  // twice the projected spin total value
  int TotalSz;
 ...
 public:
  ...
  // lsFactor = multiplicative factor in front of the L^2 operator in the Hamiltonian
  ...
  // destructor
  //
  ~ParticleOnSphereWithSpinS2Hamiltonian();
