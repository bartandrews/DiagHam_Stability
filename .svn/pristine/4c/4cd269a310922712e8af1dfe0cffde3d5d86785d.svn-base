...
#ifndef PARTICLEONLATTICEWITHSPINKITAEVHEISENBERGAND2DTRANSLATIONHAMILTONIAN_H
#define PARTICLEONLATTICEWITHSPINKITAEVHEISENBERGAND2DTRANSLATIONHAMILTONIAN_H
...
class ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian : public ParticleOnLatticeWithSpinKitaevHeisenbergHamiltonian
{
 ...
 public:
  ...
  ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian(ParticleOnSphereWithSpin* particles, int nbrParticles, int nbrSite, 
  ...
  // destructor
  //
  virtual ~ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian();
...
inline void ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, ComplexVector& vSource, ComplexVector& vDestination)
{
...
inline void ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian::EvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, ComplexVector* vSources, 
												      ComplexVector* vDestinations, int nbrVectors, Complex* tmpCoefficients)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian::HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, ComplexVector& vSource, ComplexVector& vDestination)
{
  //int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
  double Coefficient3;
...
inline void ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian::HermitianEvaluateMNTwoBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int index, ComplexVector* vSources, 
																 ComplexVector* vDestinations, int nbrVectors, Complex* tmpCoefficients)
{
  //int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian::EvaluateMNTwoBodyFastMultiplicationComponent(ParticleOnSphereWithSpin* particles, int index, 
															       int* indexArray, Complex* coefficientArray, long& position)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
...
inline void ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian::EvaluateMNTwoBodyFastMultiplicationMemoryComponent(ParticleOnSphereWithSpin* particles, int firstComponent, int lastComponent, long& memory)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
  double Coefficient3;
...
inline void ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian::EvaluateMNOneBodyAddMultiplyComponent(ParticleOnSphereWithSpin* particles, int firstComponent, int lastComponent,
															int step, ComplexVector& vSource, ComplexVector& vDestination)
{
  int Index;
  double Coefficient;
			...
			if (j2 < this->NbrSite)
			  {
			    ...
			    if (Index < particles->GetHilbertSpaceDimension())
			      vDestination[Index] += Coefficient * this->OneBodyGenericInteractionFactorsupup[j][k] * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * vSource[i];
			    
			    Index = particles->AddAd(i , j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
			    if (Index < particles->GetHilbertSpaceDimension())
			      vDestination[Index] += Coefficient * this->OneBodyGenericInteractionFactorsdowndown[j][k] * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * vSource[i];		  
			  }
		      }
		  }
	      }
			...
			if (j2 < this->NbrSite)
			  {
				...
				if (Index < i)
				  {
				    vDestination[i] += Coefficient * Conj(this->OneBodyGenericInteractionFactorsupup[j][k] * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY]) * vSource[Index];
				  }
			      }
				...
				if (Index < i)
				  {
				    vDestination[i] += Coefficient * Conj(this->OneBodyGenericInteractionFactorsdowndown[j][k] * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY]) * vSource[Index];		  
				  }
		      ...
		      for (int j = 0; j < this->NbrSite; ++j) 
			{
			  for (int k = 0; k < 3; ++k)
			      ...
			      if (j2 < this->NbrSite)
				{
				  Index = particles->AduAu(i, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
				  if (Index < Dim)
				    TmpDestinationVector[Index] += Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsupup[j][k] * TmpSourceVector[i];
				  
				  Index = particles->AddAd(i, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
				  if (Index < Dim)
				    TmpDestinationVector[Index] += Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsdowndown[j][k] * TmpSourceVector[i];
				}
			    }
			}
		    }
		  ...
		  for (int k = 0; k < 3; ++k)
		      ...
		      if (j2 < this->NbrSite)
			{
			  ...
			  if (Index < Dim)
			    {
			      for (int p = 0; p < nbrVectors; ++p)
				vDestinations[p][Index] += Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsupdown[j][k] * vSources[p][i];
			    }
			}
		    }
		}
				  ...
				  if (Index <= i)
				    {
				      ...
				      if (Index < i)
					{
					  TmpDestinationVector[i] += Coefficient * Conj(this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsupup[j][k]) * TmpSourceVector[Index];
					}
				    }
				  Index = particles->AddAd(i, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
				  if (Index <= i)
				    {
				      ...
				      if (Index < i)
					{
					  TmpDestinationVector[i] += Coefficient * Conj(this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsdowndown[j][k]) * TmpSourceVector[Index];
					}
				    }
				}
			    }
				  ...
				  if (Index <= i)
				    {
				      ...
				      if (Index < i)
					{
					  TmpDestinationVector[i] += Coefficient * (this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsdowndown[j][k]) * TmpSourceVector[Index];
					}
				    }
				}
			    }
			  ...
			  if (Index <= i)
			      ...
			      if (Index < i)
				{
				  for (int p = 0; p < nbrVectors; ++p)
				    {
				      vDestinations[p][Index] += Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * Conj(this->OneBodyGenericInteractionFactorsupdown[j][k]) * vSources[p][i];
				      vDestinations[p][i] += Coefficient * Conj(this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY]) * this->OneBodyGenericInteractionFactorsupdown[j][k] * vSources[p][Index];
				    }
				}
			      else
				{
...
inline void ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian::EvaluateMNOneBodyFastMultiplicationComponent(ParticleOnSphereWithSpin* particles, int index, 
															       int* indexArray, Complex* coefficientArray, long& position)
{
  int Dim = particles->GetHilbertSpaceDimension();
  double Coefficient;
      ...
      if ((this->OneBodyGenericInteractionFactorsdowndown != 0) && (this->OneBodyGenericInteractionFactorsupup != 0))
	{
	  for (int j = 0; j < this->NbrSite; ++j)
	      ...
	      for (int k = 0; k < 3; ++k)
		{
		  ...
		  if (j2 < this->NbrSite)
		    {
		      Index = particles->AduAu(index + this->PrecalculationShift, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
		      if (Index < Dim)
			{
			  indexArray[position] = Index;
			  coefficientArray[position] = Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsupup[j][k];
			  ++position;
			}
		      Index = particles->AddAd(index + this->PrecalculationShift, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
		      if (Index < Dim)
			{
			  indexArray[position] = Index;
			  coefficientArray[position] = Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsdowndown[j][k];
			  ++position;
			}
		    }
		}
      ...
      if (this->OneBodyGenericInteractionFactorsupdown != 0)
	{
	  for (int j = 0; j < this->NbrSite; ++j)
	      ...
	      for (int k = 0; k < 3; ++k)
		{
		  ...
		  if (j2 < this->NbrSite)
		    {
		      Index = particles->AddAu(index + this->PrecalculationShift, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
		      if (Index < Dim)
			{
			  indexArray[position] = Index;
			  coefficientArray[position] = Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * Conj(this->OneBodyGenericInteractionFactorsupdown[j][k]);
			  ++position;
			}
		      Index = particles->AduAd(index + this->PrecalculationShift, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
		      if (Index < Dim)
			{
			  indexArray[position] = Index;
			  coefficientArray[position] = Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsupdown[j][k];
			  ++position;
			}
		    }
		}
      ...
      if ((this->OneBodyGenericInteractionFactorsdowndown != 0) && (this->OneBodyGenericInteractionFactorsupup != 0))
	{
	  for (int j = 0; j < this->NbrSite; ++j)
	      ...
	      for (int k = 0; k < 3; ++k)
		{
		  ...
		  if (j2 < this->NbrSite)
		    {
		      Index = particles->AduAu(index, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
		      if (Index <= index)
			{
			  indexArray[position] = Index;
			  if (Index == index)
			    {
			      coefficientArray[position] = 0.5 * Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsupup[j][k];
			    }
			  else
			    {
			      coefficientArray[position] = Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsupup[j][k];
		      ...
		      Index = particles->AddAd(index, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
		      if (Index <= index)
			{
			  indexArray[position] = Index;
			  if (Index == index)
			    {
			      coefficientArray[position] = 0.5 * Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsdowndown[j][k];
			    }
			  else
			    {
			      coefficientArray[position] = Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsdowndown[j][k];
      ...
      if (this->OneBodyGenericInteractionFactorsupdown != 0)
	{
	  for (int j = 0; j < this->NbrSite; ++j)
	      ...
	      for (int k = 0; k < 3; ++k)
		{
		  ...
		  if (j2 < this->NbrSite)
		    {
		      Index = particles->AddAu(index, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
		      if (Index <= index)
			{
			  indexArray[position] = Index;
			  if (Index == index)
			    {
			      coefficientArray[position] = 0.5 * Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * Conj(this->OneBodyGenericInteractionFactorsupdown[j][k]);
			    }
			  else
			    {
			      coefficientArray[position] = Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * Conj(this->OneBodyGenericInteractionFactorsupdown[j][k]);
		      ...
		      Index = particles->AduAd(index, j, j2, Coefficient, NbrTranslationsX, NbrTranslationsY);
		      if (Index <= index)
			{
			  indexArray[position] = Index;
			  if (Index == index)
			    {
			      coefficientArray[position] = 0.5 * Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsupdown[j][k];
			    }
			  else
			    {
			      coefficientArray[position] = Coefficient * this->ExponentialFactors[NbrTranslationsX][NbrTranslationsY] * this->OneBodyGenericInteractionFactorsupdown[j][k];
...
inline void ParticleOnLatticeWithSpinKitaevHeisenbergAnd2DTranslationHamiltonian::EvaluateMNOneBodyFastMultiplicationMemoryComponent(ParticleOnSphereWithSpin* particles, int firstComponent, int lastComponent, long& memory)
{
  int Index;
  double Coefficient = 0.0;
  int NbrTranslationsX;
