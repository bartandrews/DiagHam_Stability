...
ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian::ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian()
{
}
...
void ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
...
void ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian::ShiftHamiltonian (double shift)
{
...
void ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian::EvaluateInteractionFactors()
{
...
double ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian::EvaluateInteractionCoefficient(int m1, int m2, int m3, int m4)
{
...
double ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian::GetVofQ(double Q2_half)
{
  double Result;
...
double ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian::EvaluateWignerCrystalEnergy ()
{
...
double ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian::MisraFunction (double n, double x)
{
  int Count=0;
...
double ParticleOnTorusCoulombWithMagneticTranslationsRealHamiltonian::PartialMisraFunction (double n, double x, double min, double max, int nbrSubdivision)
{
  double Sum = 0.0;
  x *= -1.0;
  --nbrSubdivision;
