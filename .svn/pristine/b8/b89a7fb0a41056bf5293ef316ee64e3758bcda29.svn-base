...
SpinChainAKLTP3P4HamiltonianWithTranslations::SpinChainAKLTP3P4HamiltonianWithTranslations()
{
}
...
SpinChainAKLTP3P4HamiltonianWithTranslations::SpinChainAKLTP3P4HamiltonianWithTranslations(AbstractSpinChainWithTranslations* chain, int nbrSpin, double p3Factor, double p4Factor)
{
  this->Chain = chain;
...
void SpinChainAKLTP3P4HamiltonianWithTranslations::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
...
SpinChainAKLTP3P4HamiltonianWithTranslations& SpinChainAKLTP3P4HamiltonianWithTranslations::SetChain(AbstractSpinChainWithTranslations* chain)
{  
  delete[] this->SzSzContributions;
  this->Chain = chain;
  this->SzSzContributions = new double [this->Chain->GetHilbertSpaceDimension()];
...
ComplexVector& SpinChainAKLTP3P4HamiltonianWithTranslations::LowLevelAddMultiply(ComplexVector& vSource, ComplexVector& vDestination, 
...
ComplexVector* SpinChainAKLTP3P4HamiltonianWithTranslations::LowLevelMultipleMultiply(ComplexVector* vSources, ComplexVector* vDestinations, int nbrVectors, 
										      int firstComponent, int nbrComponent)
{
  double Coef;
  double Coef3;
...
void SpinChainAKLTP3P4HamiltonianWithTranslations::EvaluateDiagonalMatrixElements()
{
  int dim = this->Chain->GetHilbertSpaceDimension();
  for (int i = 0; i < dim; ++i)
    {
