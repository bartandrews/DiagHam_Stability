...
#ifndef PARTICLEONSPHEREWITHSPINANNIHILATIONOPERATOR_H
#define PARTICLEONSPHEREWITHSPINANNIHILATIONOPERATOR_H
...
class ParticleOnSphereWithSpinAnnihilationOperator : public AbstractOperator
{
 ...
 protected:
  ...
  // index of the annihilation operator that is part of the annihilation operator
  int OperatorIndex;
 ...
 public:
  ...
  ParticleOnSphereWithSpinAnnihilationOperator(ParticleOnSphereWithSpinAnnihilationOperator& oper);

  // destructor
  //
  ~ParticleOnSphereWithSpinAnnihilationOperator();
