...
#ifndef HARDCOREBOSONLONG_H
#define HARDCOREBOSONLONG_H
...
class BosonOnLatticeLong;

class HardCoreBosonLong :  public AbstractQHEParticle
{

  friend class BosonOnLatticeLong;
 ...
 public:
  ...
  HardCoreBosonLong(int nbrBosons, int nbrStates, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // bosons = reference on the hilbert space to copy to copy
  HardCoreBosonLong(const HardCoreBosonLong& bosons);

  // virtual destructor
  //
  virtual ~HardCoreBosonLong ();

  // assignment (without duplicating datas)
  //
  // bosons = reference on the hilbert space to copy to copy
  // return value = reference on current hilbert space
  HardCoreBosonLong& operator = (const HardCoreBosonLong& bosons);
  ...
  virtual void SetTargetSpace(HardCoreBosonLong* targetSpace);
