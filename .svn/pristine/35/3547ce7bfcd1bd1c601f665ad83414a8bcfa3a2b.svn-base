...
{
    OptionManager Manager ("FTI3DChiral" , "0.01");
    ...
    {
        cout << "see man page for option syntax or type FTI3DChiral -h" << endl;
        return -1;
    }
    ...
    sprintf(FilePrefix, "%s_singleband_chiral_p_%d_x_%d_y_%d_z_%d_mus_%g", StatisticPrefix, NbrParticles, NbrSiteX, NbrSiteY, NbrSiteZ,
    ...
    if (Manager.GetBoolean("singleparticle-spectrum") == true)
    {
        ...
        if (Manager.GetBoolean("atomic") == true)
        {
            ...
            TightBindingModel = new TightBindingModelChiralCubicLattice(NbrSiteX, NbrSiteY, NbrSiteZ, Manager.GetDouble("mu-s"), Manager.GetInteger("band-index"),
                    Manager.GetDouble("gamma-x"), Manager.GetDouble("gamma-y"), Manager.GetDouble("gamma-z"), Architecture.GetArchitecture(), ExportOneBody);
