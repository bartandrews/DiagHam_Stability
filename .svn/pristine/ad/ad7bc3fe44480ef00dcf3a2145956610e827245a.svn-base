...
SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator::SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator(Spin1_2ChainWithPseudospinAnd2DTranslation* chain, int xMomentum, int nbrSpinX, int yMomentum, int nbrSpinY, int siteIndex1, int siteIndex2)
{
  this->Chain = chain;
...
SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator::~SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator()
{
}
...
AbstractOperator* SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator::Clone ()
{
  return new SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator(this->Chain, this->XMomentum, this->NbrSpinX, this->YMomentum, this->NbrSpinY, this->SiteIndex1, this->SiteIndex2);
}
...
void SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
...
AbstractHilbertSpace* SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator::GetHilbertSpace ()
{
  return this->Chain;
}
...
int SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator::GetHilbertSpaceDimension ()
{
...
Complex SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator::PartialMatrixElement (ComplexVector& V1, ComplexVector& V2, 
...
ComplexVector& SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator::LowLevelMultiply(ComplexVector& vSource, ComplexVector& vDestination, 
...
void SpinWithPseudospin2DTranslationSpinSpinCorrelationOperator::EvaluateExponentialFactors()
{
