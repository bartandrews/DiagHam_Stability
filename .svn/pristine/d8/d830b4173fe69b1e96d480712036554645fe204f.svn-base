...
SingleDoubleInternalOption::SingleDoubleInternalOption(char optionCode, const char* optionName, const char* optionDescription, double defaultValue, bool external, bool minValueFlag, double minValue, 
