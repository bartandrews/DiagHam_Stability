...
#ifndef SPINCHAINWITHDISORDERHAMILTONIAN_H
#define SPINCHAINWITHDISORDERHAMILTONIAN_H
...
class SpinChainWithDisorderHamiltonian : public AbstractHamiltonian
{
 ...
 protected:
  ...
  // array containing random fields along z-direction
  double* Hz;
 ...
 public:
  ...
  SpinChainWithDisorderHamiltonian(AbstractSpinChain* chain, int nbrSpin, double* j, double* jz, double* hz);

  // destructor
  //
  ~SpinChainWithDisorderHamiltonian();
  ...
  SpinChainWithDisorderHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, SpinChainWithDisorderHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, SpinChainWithDisorderHamiltonian& H);
