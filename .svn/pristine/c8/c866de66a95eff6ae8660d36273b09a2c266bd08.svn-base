...
Spin1_2ChainFullAnd2DTranslation::Spin1_2ChainFullAnd2DTranslation ()
{
...
Spin1_2ChainFullAnd2DTranslation::Spin1_2ChainFullAnd2DTranslation (int xMomentum, int maxXMomentum, int yMomentum, int maxYMomentum, unsigned long memory) 
{
  this->Flag.Initialize();
...
Spin1_2ChainFullAnd2DTranslation::Spin1_2ChainFullAnd2DTranslation (const Spin1_2ChainFullAnd2DTranslation& chain)
{
...
Spin1_2ChainFullAnd2DTranslation& Spin1_2ChainFullAnd2DTranslation::operator = (const Spin1_2ChainFullAnd2DTranslation& chain)
{
...
AbstractHilbertSpace* Spin1_2ChainFullAnd2DTranslation::Clone()
{
  return new Spin1_2ChainFullAnd2DTranslation (*this);
}
...
int Spin1_2ChainFullAnd2DTranslation::Spi (int i, int state, double& coefficient, int& nbrTranslationX, int& nbrTranslationY)
{
...
int Spin1_2ChainFullAnd2DTranslation::Smi (int i, int state, double& coefficient, int& nbrTranslationX, int& nbrTranslationY)
{
  unsigned long State = this->StateDescription[state];
  if ((State & (0x1ul << i)) != 0x0ul)
    {
...
int Spin1_2ChainFullAnd2DTranslation::SmiSpj (int i, int j, int state, double& coefficient, int& nbrTranslationX, int& nbrTranslationY)
{  
  unsigned long State = this->StateDescription[state];
  unsigned long Mask = (0x1ul << i) | (0x1ul << j);
  if (i != j)
    {
      if (((State & (0x1ul << i)) != 0x0ul) || ((State & (0x1ul << j)) == 0x0ul))
	{
	  coefficient = 0.0;
	  return this->HilbertSpaceDimension;
	}
...
int Spin1_2ChainFullAnd2DTranslation::SpiSpj (int i, int j, int state, double& coefficient, int& nbrTranslationX, int& nbrTranslationY)
{  
  unsigned long State = this->StateDescription[state];
  unsigned long Mask = (0x1ul << i) | (0x1ul << j);
  if ((i == j) || ((State & Mask) != Mask))
    {
      coefficient = 0.0;
      return this->HilbertSpaceDimension;
    }
...
int Spin1_2ChainFullAnd2DTranslation::SmiSmj (int i, int j, int state, double& coefficient, int& nbrTranslationX, int& nbrTranslationY)
{  
  unsigned long State = this->StateDescription[state];
  unsigned long Mask = (0x1ul << i) | (0x1ul << j);
  if ((i == j) || ((State & Mask) != 0x0ul))
    {
      coefficient = 0.0;
      return this->HilbertSpaceDimension;
    }
...
int Spin1_2ChainFullAnd2DTranslation::FindStateIndex(unsigned long stateDescription, int maxMomentum)
{
...
long Spin1_2ChainFullAnd2DTranslation::GenerateStates()
{
...
long Spin1_2ChainFullAnd2DTranslation::RawGenerateStates()
{  
  this->LargeHilbertSpaceDimension = 1l << this->NbrSite;
  this->StateDescription = new unsigned long [this->LargeHilbertSpaceDimension];
  for (long i = 0l; i < this->LargeHilbertSpaceDimension; ++i)
    {
      this->StateDescription[i] = (unsigned long) (this->LargeHilbertSpaceDimension - i - 1l);
    }
}
...
void Spin1_2ChainFullAnd2DTranslation::GenerateLookUpTable(unsigned long memory)
{
  ...
  int CurrentMaxMomentum = this->NbrSite;
  while ((this->StateDescription[0] >> CurrentMaxMomentum) == 0x0ul)
    --CurrentMaxMomentum;
...
ComplexVector Spin1_2ChainFullAnd2DTranslation::ConvertToKxKyBasis(ComplexVector& state, AbstractSpinChain* space)
{
...
ComplexVector Spin1_2ChainFullAnd2DTranslation::ConvertFromKxKyBasis(ComplexVector& state, AbstractSpinChain* space)
{
  Spin1_2ChainFull* TmpSpace = (Spin1_2ChainFull*) space;
