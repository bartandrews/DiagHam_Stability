...
#ifndef PARTICLEONCYLINDERONEQUARTERPFAFFIAN_H
#define PARTICLEONCYLINDERONEQUARTERPFAFFIAN_H
...
class ParticleOnCylinderOneQuarterPfaffian : public AbstractQHEOnCylinderThreeBodyHamiltonian
{

 protected:

  // array containing all interaction factors 
  Complex* InteractionFactors2b;
  // number of interaction factors
  int NbrInteractionFactors2b;
 ...
 public:
  ...
  ParticleOnCylinderOneQuarterPfaffian(ParticleOnSphere* particles, int nbrParticles, int maxMomentum, double ratio, AbstractArchitecture* architecture, long memory = -1, char* precalculationFileName = 0);

  // destructor
  //
  ~ParticleOnCylinderOneQuarterPfaffian();
 ...
 protected:
  ...
  Complex EvaluateInteractionCoefficient2b(int m1, int m2, int m3, int m4);
};
