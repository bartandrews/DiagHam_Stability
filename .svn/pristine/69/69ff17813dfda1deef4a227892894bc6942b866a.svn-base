...
#ifndef PARTICLEONSPHEREWITHSPINBASICTHREEBODYHAMILTONIANWITHPAIRING_H
#define PARTICLEONSPHEREWITHSPINBASICTHREEBODYHAMILTONIANWITHPAIRING_H
...
class ParticleOnSphereWithSpinBasicThreeBodyHamiltonianWithPairing : public AbstractQHEOnSphereWithSpinNBodyInteractionHamiltonianWithPairing
{
 ...
 public:
  ...
  // default constructor
  //
  ParticleOnSphereWithSpinBasicThreeBodyHamiltonianWithPairing();
  ...
  // alpha = strength of onsite pairing term
