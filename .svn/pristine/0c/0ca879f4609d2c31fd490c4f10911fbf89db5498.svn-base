...
#ifndef SLBSWAVEFUNCTION2_H
#define SLBSWAVEFUNCTION2_H
...
class SLBSWavefunction2: public Abstract1DComplexFunctionOnSphere
{
 ...
 public:
  ...
  SLBSWavefunction2(int nbrParticles);

  // copy constructor
  //
  // function = reference on the wave function to copy
  SLBSWavefunction2(const SLBSWavefunction2& function);
