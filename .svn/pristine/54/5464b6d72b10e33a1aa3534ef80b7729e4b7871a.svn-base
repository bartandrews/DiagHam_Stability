...
TightBindingModelTimeReversalBHZLattice::TightBindingModelTimeReversalBHZLattice(int nbrSiteX, int nbrSiteY, double a, double b, double c, double d, double m, double delta, 
...
TightBindingModelTimeReversalBHZLattice::~TightBindingModelTimeReversalBHZLattice()
{
}
...
void TightBindingModelTimeReversalBHZLattice::CoreComputeBandStructure(long minStateIndex, long nbrStates)
{
  if (nbrStates == 0l)
	  ...
	  if ((Index >= minStateIndex) && (Index < MaxStateIndex))
	    {
	      ...
	      TmpOneBodyHamiltonian.SetMatrixElement(0, 3, this->Delta);
	      TmpOneBodyHamiltonian.SetMatrixElement(1, 1, (HDiag - Hd3));
	      TmpOneBodyHamiltonian.SetMatrixElement(1, 2, -this->Delta);//*Conj(GaugeFactor));
	      TmpOneBodyHamiltonian.SetMatrixElement(2, 2, HDiag + Hd3);
	      TmpOneBodyHamiltonian.SetMatrixElement(2, 3, HABdown);
	      TmpOneBodyHamiltonian.SetMatrixElement(3, 3, (HDiag - Hd3));
