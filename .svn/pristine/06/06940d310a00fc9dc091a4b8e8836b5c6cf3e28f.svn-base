...
BosonOnT2xS2::BosonOnT2xS2 (int nbrBosons, int nbrFluxQuantumTorus, int nbrFluxQuantumSphere, int totalKy, int totalLz, unsigned long memory)
{  
  this->NbrBosons = nbrBosons;
  this->IncNbrBosons = this->NbrBosons + 1;
  this->TotalLz = totalLz;
  this->NbrFluxQuanta1 = nbrFluxQuantumTorus - 1;
  this->NbrFluxQuanta2 = nbrFluxQuantumSphere;
  this->ShiftedTotalLz = (this->TotalLz + (this->NbrBosons * this->NbrFluxQuanta2)) / 2;
  this->TotalLz1 = totalKy;
  this->TotalLz2 = totalLz;
  this->NbrSiteX =  nbrFluxQuantumTorus;
  this->NbrSiteY =  nbrFluxQuantumSphere + 1;
  this->KxMomentum = totalKy;
...
BosonOnT2xS2::BosonOnT2xS2(const BosonOnT2xS2& bosons)
{
...
BosonOnT2xS2 & BosonOnT2xS2::operator = (const BosonOnT2xS2 & bosons)
{
  if (bosons.TargetSpace != &bosons)
    this->TargetSpace = bosons.TargetSpace;
  else
...
AbstractHilbertSpace* BosonOnT2xS2::Clone()
{
  return new BosonOnT2xS2(*this);
}
...
long BosonOnT2xS2::GenerateStates(unsigned long* stateDescription, int nbrBosons, int currentKx, int currentKy, int currentTotalKx, int currentTotalKy, int currentFermionicPosition, long pos)
{
...
long BosonOnT2xS2::EvaluateHilbertSpaceDimension(int nbrBosons, int currentKx, int currentKy, int currentTotalKx, int currentTotalKy)
{
  if (nbrBosons < 0)
    return 0l;
  if (currentKy < 0)
