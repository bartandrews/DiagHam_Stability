...
#ifndef TRIANGLESPINCHAINHAMILTONIAN_H
#define TRIANGLESPINCHAINHAMILTONIAN_H
...
class TriangleSpinChainHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  TriangleSpinChainHamiltonian(AbstractSpinChain* chain, int nbrTriangle, double j1, double j2, double j3);

  // destructor
  //
  ~TriangleSpinChainHamiltonian();

  // set chain
  // 
  // chain = pointer on Hilbert space of the associated system
  // return value = reference on current Hamiltonian
  TriangleSpinChainHamiltonian& SetChain(AbstractSpinChain* chain);
  ...
  friend ostream& operator << (ostream& Str, TriangleSpinChainHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, TriangleSpinChainHamiltonian& H);
