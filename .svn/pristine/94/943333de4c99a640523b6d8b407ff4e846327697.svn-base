...
#ifndef TIGHTBINDINGMODELPYROCHLORESLABLATTICE_H
#define TIGHTBINDINGMODELPYROCHLORESLABLATTICE_H
...
class TightBindingModelPyrochloreSlabLattice : public Abstract2DTightBindingModel
{
 ...
 public:
  ...
  TightBindingModelPyrochloreSlabLattice(int nbrSiteX, int nbrSiteY, int nbrLayers,
					 double t1, double t2, double lambda1, double lambda2, double tPerp, double mus, 
					 double gammaX, double gammaY, 
					 AbstractArchitecture* architecture, bool storeOneBodyMatrices = true);

  // destructor
  //
  ~TightBindingModelPyrochloreSlabLattice();
