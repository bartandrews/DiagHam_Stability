...
#ifndef PARTICLEONLATTICEREALSPACEWITHSPINAND2DTRANSLATIONS2OPERATOR_H
#define PARTICLEONLATTICEREALSPACEWITHSPINAND2DTRANSLATIONS2OPERATOR_H
...
class ParticleOnLatticeRealSpaceWithSpinAnd2DTranslationS2Operator : public  AbstractOperator
{
 ...
 public:
  ...
  ParticleOnLatticeRealSpaceWithSpinAnd2DTranslationS2Operator(FermionOnLatticeWithSpinRealSpaceAnd2DTranslation* particle, bool fixedSzFlag = true);
  

  // copy constructor
  //
  ParticleOnLatticeRealSpaceWithSpinAnd2DTranslationS2Operator(ParticleOnLatticeRealSpaceWithSpinAnd2DTranslationS2Operator& oper);

  // destructor
  //
  ~ParticleOnLatticeRealSpaceWithSpinAnd2DTranslationS2Operator();
