...
ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian()
{
}
...
bool ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::IsHermitian()
{
...
void ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
...
AbstractHilbertSpace* ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::GetHilbertSpace ()
{
...
int ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::GetHilbertSpaceDimension ()
{
...
void ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::ShiftHamiltonian (double shift)
{
...
ComplexVector* ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::LowLevelMultipleAddMultiply(ComplexVector* vSources, ComplexVector* vDestinations, int nbrVectors, 
											       int firstComponent, int nbrComponent)
{
  int LastComponent = firstComponent + nbrComponent;
  if (this->FastMultiplicationFlag == false)
...
ComplexVector* ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::LowLevelMultipleAddMultiplyPartialFastMultiply(ComplexVector* vSources, ComplexVector* vDestinations, int nbrVectors, 
														    int firstComponent, int nbrComponent)
{
  int LastComponent = firstComponent + nbrComponent;
  ParticleOnSphereWithSU3Spin* TmpParticles = (ParticleOnSphereWithSU3Spin*) this->Particles->Clone();
...
ComplexVector& ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::HermitianLowLevelAddMultiply(ComplexVector& vSource, ComplexVector& vDestination, 
												  int firstComponent, int nbrComponent)
{
  int LastComponent = firstComponent + nbrComponent;
  if (this->FastMultiplicationFlag == false)
...
ComplexVector* ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::HermitianLowLevelMultipleAddMultiply(ComplexVector* vSources, ComplexVector* vDestinations, int nbrVectors, 
													  int firstComponent, int nbrComponent)
{
  int LastComponent = firstComponent + nbrComponent;
  if (this->FastMultiplicationFlag == false)
...
ComplexVector* ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::HermitianLowLevelMultipleAddMultiplyPartialFastMultiply(ComplexVector* vSources, ComplexVector* vDestinations, int nbrVectors, 
																     int firstComponent, int nbrComponent)
{
  int LastComponent = firstComponent + nbrComponent;
  ParticleOnSphereWithSU3Spin* TmpParticles = (ParticleOnSphereWithSU3Spin*) this->Particles->Clone();
...
void ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::EvaluateInteractionFactors()
{
}
...
long ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::FastMultiplicationMemory(long allowedMemory)
{
  long MinIndex;
  long MaxIndex;
  this->Architecture->GetTypicalRange(MinIndex, MaxIndex);
...
long ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::PartialFastMultiplicationMemory(int firstComponent, int lastComponent)
{
  int Index;
...
void ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::EnableFastMultiplication()
{
  long MinIndex;
  long MaxIndex;
  this->Architecture->GetTypicalRange(MinIndex, MaxIndex);
...
void ParticleOnLatticeQuantumSpinHallThreeBandHamiltonian::PartialEnableFastMultiplication(int firstComponent, int nbrComponent)
{  
