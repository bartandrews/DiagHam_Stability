...
//                  generic two body interaction and SU(3) spin               //
//                                                                            //
...
#ifndef PARTICLEONTORUSGENERICWITHSU3SPINHAMILTONIAN_H
#define PARTICLEONTORUSGENERICWITHSU3SPINHAMILTONIAN_H


#include "config.h"
#include "HilbertSpace/ParticleOnSphereWithSU3Spin.h"
#include "Hamiltonian/AbstractHamiltonian.h"
#include "Hamiltonian/AbstractQHEOnTorusWithSU3SpinHamiltonian.h"
...
class ParticleOnTorusWithSU3SpinGenericHamiltonian : public AbstractQHEOnTorusWithSU3SpinHamiltonian
{
 ...
 public:
  ...
  ParticleOnTorusWithSU3SpinGenericHamiltonian(ParticleOnSphereWithSU3Spin* particles, int nbrParticles, int maxMomentum, double ratio, 
  ...
  // destructor
  //
  ~ParticleOnTorusWithSU3SpinGenericHamiltonian();
