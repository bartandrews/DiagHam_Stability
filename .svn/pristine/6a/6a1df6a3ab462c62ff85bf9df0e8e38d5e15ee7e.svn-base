...
SpinChainAKLTRealHamiltonianWithTranslations::SpinChainAKLTRealHamiltonianWithTranslations()
{
}
...
SpinChainAKLTRealHamiltonianWithTranslations::SpinChainAKLTRealHamiltonianWithTranslations(AbstractSpinChainWithTranslations* chain, int nbrSpin, double squareFactor)
{
  this->Chain = chain;
...
SpinChainAKLTRealHamiltonianWithTranslations::SpinChainAKLTRealHamiltonianWithTranslations(AbstractSpinChainWithTranslations* chain, int nbrSpin, double linearFactor, double quadraticFactor)
{
  this->Chain = chain;
  this->NbrSpin = nbrSpin;
  this->J = 1.0;
...
void SpinChainAKLTRealHamiltonianWithTranslations::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
...
AbstractHilbertSpace* SpinChainAKLTRealHamiltonianWithTranslations::GetHilbertSpace ()
{
  return this->Chain;
}
...
SpinChainAKLTRealHamiltonianWithTranslations& SpinChainAKLTRealHamiltonianWithTranslations::SetChain(AbstractSpinChainWithTranslations* chain)
{  
  delete[] this->SzSzContributions;
  this->Chain = chain;
  this->SzSzContributions = new double [this->Chain->GetHilbertSpaceDimension()];
...
int SpinChainAKLTRealHamiltonianWithTranslations::GetHilbertSpaceDimension ()
{
...
void SpinChainAKLTRealHamiltonianWithTranslations::ShiftHamiltonian (double shift)
{
...
bool SpinChainAKLTRealHamiltonianWithTranslations::SavePrecalculation (char* fileName)
{
  return false;
}
...
void SpinChainAKLTRealHamiltonianWithTranslations::EvaluateCosinusTable()
{
  this->CosinusTable = new double [2 * this->NbrSpin];
  this->SinusTable = new double [2 * this->NbrSpin];
  this->ExponentialTable = new double [2 * this->NbrSpin];
...
RealVector& SpinChainAKLTRealHamiltonianWithTranslations::LowLevelAddMultiply(RealVector& vSource, RealVector& vDestination, 
...
RealVector* SpinChainAKLTRealHamiltonianWithTranslations::LowLevelMultipleMultiply(RealVector* vSources, RealVector* vDestinations, int nbrVectors, 
									       int firstComponent, int nbrComponent)
{
  double Coef;
  double Coef3;
...
void SpinChainAKLTRealHamiltonianWithTranslations::EvaluateDiagonalMatrixElements()
{
  int dim = this->Chain->GetHilbertSpaceDimension();
  double Tmp;
