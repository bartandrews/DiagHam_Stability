...
//                                                                            //
//                                                                            //
//                 class of anisotropic spin chain hamiltonian                //
//                                                                            //
//                        last modification : 12/03/2002                      //
//                                                                            //
//                                                                            //
...
AnisotropicSpinChainHamiltonian::AnisotropicSpinChainHamiltonian(AbstractSpinChain* chain, int nbrSpin, double* jxx,
								 double* jyy, double* jzz, double* jxy, double* jxz, double* jyz,
								 double* sxFactor, double* syFactor, double* szFactor)
{
  this->Chain = chain;
  this->NbrSpin = nbrSpin;
  this->Jzz = new double [this->NbrSpin - 1];
  this->Jpm = new double [this->NbrSpin - 1];
  this->JppRe = new double [this->NbrSpin - 1];
  this->JppIm = new double [this->NbrSpin - 1];
  this->JpzRe = new double [this->NbrSpin - 1];
  this->JpzIm = new double [this->NbrSpin - 1];
  this->SpFactorRe = new double [this->NbrSpin - 1];
  this->SpFactorIm = new double [this->NbrSpin - 1];
  this->SzFactor = new double [this->NbrSpin - 1];
...
AnisotropicSpinChainHamiltonian::~AnisotropicSpinChainHamiltonian() 
{
  delete[] this->Jzz;
  delete[] this->Jpm;
  delete[] this->JppRe;
...
void AnisotropicSpinChainHamiltonian::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
  delete[] this->SzSzContributions;
...
AbstractHilbertSpace* AnisotropicSpinChainHamiltonian::GetHilbertSpace ()
{
  return this->Chain;
}
...
AnisotropicSpinChainHamiltonian& AnisotropicSpinChainHamiltonian::SetChain(AbstractSpinChain* chain)
{  
  delete[] this->SzSzContributions;
  this->Chain = chain;
  this->SzSzContributions = new double [this->Chain->GetHilbertSpaceDimension()];
...
int AnisotropicSpinChainHamiltonian::GetHilbertSpaceDimension ()
{
...
void AnisotropicSpinChainHamiltonian::ShiftHamiltonian (double shift)
{
...
Complex AnisotropicSpinChainHamiltonian::MatrixElement (RealVector& V1, RealVector& V2) 
{
  return Complex();
}
...
Complex AnisotropicSpinChainHamiltonian::MatrixElement (ComplexVector& V1, ComplexVector& V2) 
{
  double x = 0.0;
  double y = 0.0;
  double coef;
      ...
      if (this->SpFactorRe[j] != 0.0)
	{
	  ...
	  for (int i = 0; i < dim; ++i)
	    {	 	    
	      ...
	      if (pos != dim)
		{
		  x += coef * (TmpCoef1 * (V1.Re(pos) * V2.Re(i) + V1.Im(pos) * V2.Im(i)) 
		    - TmpCoef2 * (V1.Re(pos) * V2.Im(i) - V1.Im(pos) * V2.Re(i)));
		  y += coef * (TmpCoef2 * (V1.Re(pos) * V2.Im(i) - V1.Im(pos) * V2.Re(i))
		    + TmpCoef1 * (V1.Re(pos) * V2.Re(i) + V1.Im(pos) * V2.Im(i)));
		}
...
RealVector& AnisotropicSpinChainHamiltonian::LowLevelMultiply(RealVector& vSource, RealVector& vDestination) 
{
  return vDestination;
}
...
RealVector& AnisotropicSpinChainHamiltonian::LowLevelAddMultiply(RealVector& vSource, RealVector& vDestination) 
{
  return vDestination;
}
...
ComplexVector& AnisotropicSpinChainHamiltonian::LowLevelMultiply(ComplexVector& vSource, ComplexVector& vDestination) 
{
...
ComplexVector& AnisotropicSpinChainHamiltonian::LowLevelAddMultiply(ComplexVector& vSource, ComplexVector& vDestination) 
{
...
List<Matrix*> AnisotropicSpinChainHamiltonian::LeftInteractionOperators()
{
  List<Matrix*> TmpList;
  int Dim = this->Chain->GetHilbertSpaceDimension();
...
List<Matrix*> AnisotropicSpinChainHamiltonian::RightInteractionOperators()
{
  List<Matrix*> TmpList;
  int Dim = this->Chain->GetHilbertSpaceDimension();
  RealSymmetricMatrix* Sx = new RealSymmetricMatrix (Dim, true);
...
void AnisotropicSpinChainHamiltonian::EvaluateDiagonalMatrixElements()
{
  int dim = this->Chain->GetHilbertSpaceDimension();
  double coefficient;
  // SzSz part
...
ostream& operator << (ostream& Str, AnisotropicSpinChainHamiltonian& H) 
{
...
MathematicaOutput& operator << (MathematicaOutput& Str, AnisotropicSpinChainHamiltonian& H) 
{
  ComplexVector TmpV2 (H.Chain->GetHilbertSpaceDimension(), true);
  ComplexVector* TmpV = new ComplexVector [H.Chain->GetHilbertSpaceDimension()];
  for (int i = 0; i < H.Chain->GetHilbertSpaceDimension(); i++)
