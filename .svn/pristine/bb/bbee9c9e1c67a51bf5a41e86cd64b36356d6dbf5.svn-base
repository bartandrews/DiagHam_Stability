...
class TightBindingModelHopfCubicLattice : public Abstract3DTightBindingModel
{
...
public:
    ...
    TightBindingModelHopfCubicLattice(int nbrSiteX, int nbrSiteY, int nbrSiteZ, double lambda, int bandIndex,
            double gammaX, double gammaY, double gammaZ, AbstractArchitecture* architecture, bool storeOneBodyMatrices = true);

    // destructor
    //
    ~TightBindingModelHopfCubicLattice();
