...
#ifndef SPINWITHTRANSLATIONNONLOCALHEISENBERGOPERATOR_H
#define SPINWITHTRANSLATIONNONLOCALHEISENBERGOPERATOR_H
...
class SpinWithTranslationNonLocalHeisenbergOperator : public AbstractOperator
{
 ...
 public:
  ...
  SpinWithTranslationNonLocalHeisenbergOperator(AbstractSpinChainWithTranslations* chain, int nbrSpin);

  // destructor
  //
  ~SpinWithTranslationNonLocalHeisenbergOperator();
