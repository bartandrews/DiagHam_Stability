...
ParticleOnTorusLaplacianDeltaHamiltonian::ParticleOnTorusLaplacianDeltaHamiltonian(ParticleOnTorus* particles, int nbrParticles, int maxMomentum,
...
ParticleOnTorusLaplacianDeltaHamiltonian::~ParticleOnTorusLaplacianDeltaHamiltonian() 
{
}
...
double ParticleOnTorusLaplacianDeltaHamiltonian::EvaluateInteractionCoefficient(int m1, int m2, int m3, int m4)
{
