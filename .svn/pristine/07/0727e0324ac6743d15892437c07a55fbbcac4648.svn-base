...
#ifndef PARTICLEONSPHEREWITHSU4SPINL2HAMILTONIAN_H
#define PARTICLEONSPHEREWITHSU4SPINL2HAMILTONIAN_H
...
class ParticleOnSphereWithSU4SpinL2Hamiltonian : public AbstractQHEOnSphereWithSU4SpinCasimirHamiltonian
{
 ...
 public:
  ...
  ParticleOnSphereWithSU4SpinL2Hamiltonian(ParticleOnSphereWithSU4Spin* particles, int nbrParticles, int lzmax, int totalLz,
  ...
  // destructor
  //
  ~ParticleOnSphereWithSU4SpinL2Hamiltonian();
