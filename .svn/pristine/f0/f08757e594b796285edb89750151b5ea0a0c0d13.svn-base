...
Spin1_2ChainWithTranslationsAndSzSymmetryLong::Spin1_2ChainWithTranslationsAndSzSymmetryLong () 
{
...
Spin1_2ChainWithTranslationsAndSzSymmetryLong::Spin1_2ChainWithTranslationsAndSzSymmetryLong (int chainLength, int momentum, int translationStep, int szSymmetrySector, int memorySize, int memorySlice) 
{
...
Spin1_2ChainWithTranslationsAndSzSymmetryLong::Spin1_2ChainWithTranslationsAndSzSymmetryLong (int chainLength, int momentum, int translationStep, int szSymmetrySector, int sz, int memorySize, int memorySlice) 
{
  this->Flag.Initialize();
  this->ChainLength = chainLength;
  this->Sz = sz;
...
Spin1_2ChainWithTranslationsAndSzSymmetryLong::Spin1_2ChainWithTranslationsAndSzSymmetryLong (const Spin1_2ChainWithTranslationsAndSzSymmetryLong& chain) 
{
...
Spin1_2ChainWithTranslationsAndSzSymmetryLong& Spin1_2ChainWithTranslationsAndSzSymmetryLong::operator = (const Spin1_2ChainWithTranslationsAndSzSymmetryLong& chain)
{
...
AbstractHilbertSpace* Spin1_2ChainWithTranslationsAndSzSymmetryLong::Clone()
{
  return new Spin1_2ChainWithTranslationsAndSzSymmetryLong (*this);
}

// create precalculation tables
//

void Spin1_2ChainWithTranslationsAndSzSymmetryLong::CreatePrecalculationTable()
{
...
// ComplexMatrix Spin1_2ChainWithTranslationsAndSzSymmetryLong::EvaluatePartialEntanglementMatrix (int nbrSites, int szSector, ComplexVector& groundState, AbstractArchitecture* architecture)
// {
//   if (nbrSites == 0)
//     {
//       if (szSector == 0)
