...
ParticleOnSphereWithSpinCreationOperator::ParticleOnSphereWithSpinCreationOperator(ParticleOnSphereWithSpinCreationOperator& oper)
{
...
ParticleOnSphereWithSpinCreationOperator::~ParticleOnSphereWithSpinCreationOperator()
{
...
AbstractOperator* ParticleOnSphereWithSpinCreationOperator::Clone ()
{
  return new ParticleOnSphereWithSpinCreationOperator(*this);
}
...
void ParticleOnSphereWithSpinCreationOperator::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
...
AbstractHilbertSpace* ParticleOnSphereWithSpinCreationOperator::GetHilbertSpace ()
{
...
int ParticleOnSphereWithSpinCreationOperator::GetHilbertSpaceDimension ()
{
...
Complex ParticleOnSphereWithSpinCreationOperator::PartialMatrixElement (RealVector& V1, RealVector& V2, long firstComponent, long nbrComponent)
{
  double Element = 0.0;
...
Complex ParticleOnSphereWithSpinCreationOperator::PartialMatrixElement (ComplexVector& V1, ComplexVector& V2, long firstComponent, long nbrComponent)
{
  Complex Element = 0.0;
  int Dim = firstComponent + nbrComponent;
  double TmpCoefficient = 0.0;
