...
AbstractQHEOnTorusWithMagneticTranslationsRealHamiltonian::~AbstractQHEOnTorusWithMagneticTranslationsRealHamiltonian()
{
...
void AbstractQHEOnTorusWithMagneticTranslationsRealHamiltonian::EvaluateExponentialFactors()
{
  this->ExponentialFactors = new double[this->MaxMomentum];
  double TmpCoef = (2.0 * M_PI * ((double) this->XMomentum)) / ((double) this->MaxMomentum); 
  for (int i = 0; i < this->MaxMomentum; ++i)
    {
      this->ExponentialFactors[i] = cos(((double) i) * TmpCoef);
    }
}
...
void AbstractQHEOnTorusWithMagneticTranslationsRealHamiltonian::GetIndices()
{
