...
#ifndef REALOBSERVABLE_H
#define REALOBSERVABLE_H
...
class RealObservable{
  public:
  // constructor
  RealObservable(int Maxbins=DEF_MAX_BINS , int minObsPerBin=DEF_OBS_PER_BIN);
  
  void operator<<(const double& x);

  friend ostream& operator << (ostream& str, RealObservable &B);
