...
ParticleOnCylinderxCylinderDeltaTruncatedHamiltonian::ParticleOnCylinderxCylinderDeltaTruncatedHamiltonian()
{
}
...
ParticleOnCylinderxCylinderDeltaTruncatedHamiltonian::ParticleOnCylinderxCylinderDeltaTruncatedHamiltonian(ParticleOnSphere* particles, int nbrParticles, 
...
void ParticleOnCylinderxCylinderDeltaTruncatedHamiltonian::EvaluateInteractionFactors()
{
  long TotalNbrInteractionFactors = 0;
  if (this->Particles->GetParticleStatistic() == ParticleOnSphere::FermionicStatistic)
    {
      cout << "ParticleOnCylinderxCylinderDeltaTruncatedHamiltonian is not implemented for fermions" << endl;
    } 
  else 
    {
	...
	for (int lz2 = 0; lz2 <= this->NbrFluxQuanta1; ++lz2)
	  for (int kz1 = 0; kz1 <= this->NbrFluxQuanta2; ++kz1)
		...
		if (Index1 < Index2)
		  {
		    if ((abs(lz1 - lz2) > 1) || (abs(kz1 - kz2) > 1) || ((abs(lz1 - lz2) == 1) && (abs(kz1 - kz2) == 1)))
