...
SLBSWavefunction2::SLBSWavefunction2()
{
  this->NbrParticles = 0;
}
...
//
SLBSWavefunction2::SLBSWavefunction2(int nbrParticles)
{
...
SLBSWavefunction2::SLBSWavefunction2(const SLBSWavefunction2& function)
{
  // to adapt
...
Abstract1DComplexFunction* SLBSWavefunction2::Clone ()
{
  return new SLBSWavefunction2(*this);
}
...
Complex SLBSWavefunction2::operator ()(RealVector& x)
{
  double c, s;
  ...
  return this->PfaffianValue*Interpolation*this->Chi1*this->Chi1*this->Chi1/this->Determinant;
}
...
Complex SLBSWavefunction2::CalculateFromSpinorVariables(ComplexVector& uv)
{
  for (int i = 0; i < this->NbrParticles; ++i)
    {
...
// x = point where the function has to be evaluated
void SLBSWavefunction2::AdaptNorm(RealVector& x)
{
...
void SLBSWavefunction2::AdaptAverageMCNorm(int thermalize, int average)
{
...
//
void SLBSWavefunction2::EvaluateTables()
{
  int i, j;
  Complex tmp;
