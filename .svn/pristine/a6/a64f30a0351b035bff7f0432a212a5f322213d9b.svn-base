...
#ifndef PAIRHOPPINGGENERICPSPIN1CHAINWITHTRANSLATIONSANDINVERSIONSZSYMMETRYLONG_H
#define PAIRHOPPINGGENERICPSPIN1CHAINWITHTRANSLATIONSANDINVERSIONSZSYMMETRYLONG_H
...
class PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong : public PairHoppingGenericPAsSpin1ChainWithTranslationsLong
{
 ...
 public:
  ...
  // default constructor
  //
  PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong ();
  ...
  PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong (int chainLength, int momentum, int inversionSector, int pValue, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong (const PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong& chain);
  ...
  PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong& operator = (const PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong& chain);
...
inline int PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::SymmetrizeResult(ULONGLONG& state, int nbrStateInOrbit, double& coefficient, 
											     int& nbrTranslations)
{
  double TmpSign;
...
inline ULONGLONG PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::FindCanonicalForm(ULONGLONG stateDescription, int& nbrTranslations, double& szSymmetrySign)
{
...
inline int PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::FindOrbitSize(ULONGLONG stateDescription)
{
  ULONGLONG TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);      
...
inline bool PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::TestMomentumConstraint(ULONGLONG stateDescription)
{
  ULONGLONG TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);   
...
inline void PairHoppingGenericPAsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::ApplyInversionSymmetry(ULONGLONG& stateDescription)
{
