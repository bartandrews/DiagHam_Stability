...
#ifndef PARTICLEONSPHERELPLUSOPERATOR_H
#define PARTICLEONSPHERELPLUSOPERATOR_H
...
class ParticleOnSphereLPlusOperator : public AbstractOperator
{
 ...
 public:
  ...
  ParticleOnSphereLPlusOperator(ParticleOnSphere* particle, int totalLz, int lzMax);

  // copy constructor
  //
  // oper = reference on the operator to copy
  ParticleOnSphereLPlusOperator(const ParticleOnSphereLPlusOperator& oper);

  // destructor
  //
  ~ParticleOnSphereLPlusOperator();
