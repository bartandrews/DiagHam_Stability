...
HermitianMatrix FermionOnLattice::EvaluatePartialDensityMatrixParticlePartition (int nbrParticleSector, ComplexVector& groundState, AbstractArchitecture* architecture)
{
...
long FermionOnLattice::EvaluatePartialDensityMatrixParticlePartitionCore (int minIndex, int nbrIndex, ParticleOnLattice* complementaryHilbertSpace,  ParticleOnLattice* destinationHilbertSpace,
									  ComplexVector& groundState,  HermitianMatrix* densityMatrix)
{
  FermionOnLattice* TmpHilbertSpace =  (FermionOnLattice*) complementaryHilbertSpace;
  FermionOnLattice* TmpDestinationHilbertSpace =  (FermionOnLattice*) destinationHilbertSpace;
  ...
  for (; minIndex < MaxIndex; ++minIndex)    
      ...
      for (int j = 0; j < TmpDestinationHilbertSpace->HilbertSpaceDimension; ++j)
	{
	  ...
	  if ((TmpState & TmpState2) == 0x0ul)
	    {
 	      int TmpLzMax = this->NbrSublattices;
	      ...
	      if (TmpPos != this->HilbertSpaceDimension)
		{
		  ...
		  int Pos2 = TmpDestinationHilbertSpace->NbrSublattices;
