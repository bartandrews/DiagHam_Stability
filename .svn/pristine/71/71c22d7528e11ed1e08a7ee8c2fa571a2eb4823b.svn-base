...
Spin1ChainWithTranslationsAndInversionSymmetry::Spin1ChainWithTranslationsAndInversionSymmetry () 
{
...
Spin1ChainWithTranslationsAndInversionSymmetry::Spin1ChainWithTranslationsAndInversionSymmetry (int chainLength, int momentum, int inversionSector, unsigned long memory) 
{
...
Spin1ChainWithTranslationsAndInversionSymmetry::Spin1ChainWithTranslationsAndInversionSymmetry (int chainLength, int momentum, int inversionSector, int sz, unsigned long memory) 
{
  this->Flag.Initialize();
  this->ChainLength = chainLength;
  this->Sz = sz;
...
Spin1ChainWithTranslationsAndInversionSymmetry::Spin1ChainWithTranslationsAndInversionSymmetry (const Spin1ChainWithTranslationsAndInversionSymmetry& chain) 
{
...
Spin1ChainWithTranslationsAndInversionSymmetry& Spin1ChainWithTranslationsAndInversionSymmetry::operator = (const Spin1ChainWithTranslationsAndInversionSymmetry& chain)
{
...
AbstractHilbertSpace* Spin1ChainWithTranslationsAndInversionSymmetry::Clone()
{
  return new Spin1ChainWithTranslationsAndInversionSymmetry (*this);
}
...
RealMatrix Spin1ChainWithTranslationsAndInversionSymmetry::EvaluatePartialEntanglementMatrix (int nbrSites, int szSector, RealVector& groundState, AbstractArchitecture* architecture)
{
  if (nbrSites == 0)
    {
      if (szSector == 0)
