...
#ifndef PARTICLEONSPHERECOULOMBLAPLACIANDELTAHAMILTONIAN_H
#define PARTICLEONSPHERECOULOMBLAPLACIANDELTAHAMILTONIAN_H
...
class ParticleOnSphereCoulombLaplacianDeltaHamiltonian : public AbstractQHEOnSphereHamiltonian
{
 ...
 private:
  ...
  // ratio between laplacian delta and coulomb interactions (0.0 for pure laplacian delta and 1.0 for coulomb)
  double Ratio;
 ...
 public:
  ...
  ParticleOnSphereCoulombLaplacianDeltaHamiltonian(ParticleOnSphere* particles, int nbrParticles, int lzmax, double ratio, 
						   AbstractArchitecture* architecture, long memory = -1, 
						   char* precalculationFileName = 0);

  // destructor
  //
  ~ParticleOnSphereCoulombLaplacianDeltaHamiltonian();
  ...
  friend ostream& operator << (ostream& Str, ParticleOnSphereCoulombLaplacianDeltaHamiltonian& H);
  ...
  // H = Hamiltonian to print
  // return value = reference on output stream
  friend MathematicaOutput& operator << (MathematicaOutput& Str, ParticleOnSphereCoulombLaplacianDeltaHamiltonian& H);
