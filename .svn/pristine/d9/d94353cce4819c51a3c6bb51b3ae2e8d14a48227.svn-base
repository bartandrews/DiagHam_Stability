...
#ifndef PARTICLEONLATTICENORBITALSQUARELATTICESINGLEBANDHAMILTONIAN_H
#define PARTICLEONLATTICENORBITALSQUARELATTICESINGLEBANDHAMILTONIAN_H
...
class ParticleOnLatticeNOrbitalSquareLatticeSingleBandHamiltonian : public ParticleOnLatticeChernInsulatorSingleBandHamiltonian
{
 ...
 public:
  ...
  // constructor
  //
  ParticleOnLatticeNOrbitalSquareLatticeSingleBandHamiltonian();
  ...
  ParticleOnLatticeNOrbitalSquareLatticeSingleBandHamiltonian(ParticleOnSphere* particles, int nbrParticles, 
