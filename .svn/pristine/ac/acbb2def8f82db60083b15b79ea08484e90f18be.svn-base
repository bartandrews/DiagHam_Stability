...
#ifndef SPINNONLOCALHEISENBERGOPERATOR_H
#define SPINNONLOCALHEISENBERGOPERATOR_H
...
class SpinNonLocalHeisenbergOperator : public AbstractOperator
{
 ...
 public:
  ...
  SpinNonLocalHeisenbergOperator(AbstractSpinChain* chain, int nbrSpin, bool periodicBoundaryConditions = false);

  // destructor
  //
  ~SpinNonLocalHeisenbergOperator();
