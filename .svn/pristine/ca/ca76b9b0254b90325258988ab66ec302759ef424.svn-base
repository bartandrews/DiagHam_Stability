...
#ifndef PARTICLEONTORUSKXOPERATOR_H
#define PARTICLEONTORUSKXOPERATOR_H
...
class ParticleOnTorusKxOperator : public AbstractOperator
{
 ...
 public:
  ...
  ParticleOnTorusKxOperator(ParticleOnTorusKxOperator& oper);

  // destructor
  //
  ~ParticleOnTorusKxOperator();
