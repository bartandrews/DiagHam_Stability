...
#ifndef PARTICLEONSPHERECREATIONOPERATOR_H
#define PARTICLEONSPHERECREATIONOPERATOR_H
...
class ParticleOnSphereCreationOperator : public AbstractOperator
{
 ...
 protected:
  ...
  // index of the annihilation operator that is part of the creation operator
  int OperatorIndex;
 ...
 public:
  ...
  ParticleOnSphereCreationOperator(ParticleOnSphere* particle, int index);

  // copy constructor
  //
  // oper = operator to copy
  ParticleOnSphereCreationOperator(ParticleOnSphereCreationOperator& oper);

  // destructor
  //
  ~ParticleOnSphereCreationOperator();
