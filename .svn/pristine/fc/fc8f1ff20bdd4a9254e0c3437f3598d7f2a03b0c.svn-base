...
#ifndef SIMPLETWOBODYCORRELATORONSPHERE_H
#define SIMPLETWOBODYCORRELATORONSPHERE_H
...
class SimpleTwoBodyCorrelatorOnSphere : public AbstractObservable
{
 protected:
 ...
 public:
  ...
  SimpleTwoBodyCorrelatorOnSphere();
  ...
  SimpleTwoBodyCorrelatorOnSphere(int nbrFlux, int resolution, int highres, int range=0, bool printLength=true);
  
  // destructor
  virtual ~SimpleTwoBodyCorrelatorOnSphere();
