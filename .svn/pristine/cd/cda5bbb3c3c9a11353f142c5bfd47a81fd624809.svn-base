...
#ifndef PAIRHOPPINGP1SPIN1CHAINWITHTRANSLATIONSANDINVERSIONSZSYMMETRYLONG_H
#define PAIRHOPPINGP1SPIN1CHAINWITHTRANSLATIONSANDINVERSIONSZSYMMETRYLONG_H
...
//
static  ULONGLONG PairHoppingAsSpin1ChainWithTranslationsInversionTableLong[] = {
...
//
static  ULONGLONG PairHoppingAsSpin1ChainWithTranslationsSzFlipTableLong[] = {0x3ul, 0x1ul, 0x2ul, 0x0ul};


class PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong : public PairHoppingP1AsSpin1ChainWithTranslationsLong
{
 ...
 public:
  ...
  // default constructor
  //
  PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong ();
  ...
  PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong (int chainLength, int momentum, int inversionSector, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // chain = reference on chain to copy
  PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong (const PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong& chain);
  ...
  PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong& operator = (const PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong& chain);
...
inline int PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::SymmetrizeResult(ULONGLONG& state, int nbrStateInOrbit, double& coefficient, 
											     int& nbrTranslations)
{
  double TmpSign;
...
inline ULONGLONG PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::FindCanonicalForm(ULONGLONG stateDescription, int& nbrTranslations, double& szSymmetrySign)
{
...
inline int PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::FindOrbitSize(ULONGLONG stateDescription)
{
  ULONGLONG TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);      
...
inline bool PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::TestMomentumConstraint(ULONGLONG stateDescription)
{
  ULONGLONG TmpStateDescription = stateDescription;
  int XSize = 1;
  this->ApplySingleXTranslation(TmpStateDescription);   
...
inline void PairHoppingP1AsSpin1ChainWithTranslationsAndInversionSzSymmetryLong::ApplyInversionSymmetry(ULONGLONG& stateDescription)
{
