...
#ifndef BOSONONCUBICLATTICEWITHSU4SPINMOMENTUMSPACELONG_H
#define BOSONONCUBICLATTICEWITHSU4SPINMOMENTUMSPACELONG_H
...
class BosonOnCubicLatticeWithSU4SpinMomentumSpaceLong : public BosonOnSphereWithSU4SpinLong
{
 ...
 public:
  ...
  BosonOnCubicLatticeWithSU4SpinMomentumSpaceLong (int nbrBosons, int nbrSiteX, int nbrSiteY, int nbrSiteZ, int kxMomentum, int kyMomentum, int kzMomentum, unsigned long memory = 10000000);

  // copy constructor (without duplicating datas)
  //
  // bosons = reference on the hilbert space to copy to copy
  BosonOnCubicLatticeWithSU4SpinMomentumSpaceLong(const BosonOnCubicLatticeWithSU4SpinMomentumSpaceLong& bosons);

  // destructor
  //
  ~BosonOnCubicLatticeWithSU4SpinMomentumSpaceLong ();

  // assignement (without duplicating datas)
  //
  // bosons = reference on the hilbert space to copy to copy
  // return value = reference on current hilbert space
  BosonOnCubicLatticeWithSU4SpinMomentumSpaceLong& operator = (const BosonOnCubicLatticeWithSU4SpinMomentumSpaceLong& bosons);
