...
#ifndef PARTICLEONCYLINDERHAFFNIANHAMILTONIAN_H
#define PARTICLEONCYLINDERHAFFNIANHAMILTONIAN_H
...
class ParticleOnCylinderHaffnianHamiltonian : public AbstractQHEOnCylinderThreeBodyHamiltonian
{
 ...
 public:
  ...
  ParticleOnCylinderHaffnianHamiltonian(ParticleOnSphere* particles, int nbrParticles, int maxMomentum, double ratio, double threeBodyCoupling, double confinement, double electricFieldParameter, double bFieldParameter,
					   AbstractArchitecture* architecture, long memory = -1, char* precalculationFileName = 0);

  // destructor
  //
  ~ParticleOnCylinderHaffnianHamiltonian();
