...
#ifndef SPINCHAINAKLTP3P4REALHAMILTONIANWITHTRANSLATIONS_H
#define SPINCHAINAKLTP3P4REALHAMILTONIANWITHTRANSLATIONS_H
...
class SpinChainAKLTP3P4RealHamiltonianWithTranslations : public SpinChainAKLTRealHamiltonianWithTranslations
{
 ...
 public:
  ...
  // default constructor
  //
  SpinChainAKLTP3P4RealHamiltonianWithTranslations();
  ...
  SpinChainAKLTP3P4RealHamiltonianWithTranslations(AbstractSpinChainWithTranslations* chain, int nbrSpin, double p3Factor = 1.0, double p4Factor = 1.0);
  ...
  SpinChainAKLTP3P4RealHamiltonianWithTranslations& SetChain(AbstractSpinChainWithTranslations* chain);
