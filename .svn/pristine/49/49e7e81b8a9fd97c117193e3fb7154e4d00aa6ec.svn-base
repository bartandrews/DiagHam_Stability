...
class SpinWith2DTranslationSpinSpinCorrelationOperator : public AbstractOperator
{

 protected:

  // pointer to the Hilbert space
  Spin1_2ChainNewAnd2DTranslation* Chain;
  // number of spins
  int NbrSpin;
 ...
 public:
  ...
  SpinWith2DTranslationSpinSpinCorrelationOperator(Spin1_2ChainNewAnd2DTranslation* chain, int xMomentum, int nbrSpinX, int yMomentum, int nbrSpinY, int siteIndex1, int siteIndex2);

  // destructor
  //
  ~SpinWith2DTranslationSpinSpinCorrelationOperator();
